...
export class Husky {
  ...
  /**
   * Return a Husky Hook file by name. Returns `undefined` if the hook has not been created.
   * @param hook The name of the GitHub workflow
   * @returns The Husky hook file or undefined
   */
