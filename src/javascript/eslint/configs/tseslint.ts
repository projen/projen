 ...
 */
export class TypeScriptEslintConfigs extends SharedConfig {
  /**
   * Enables each the rules provided as a part of typescript-eslint. Note that many rules are not applicable in all codebases, or are meant to be configured.
   * @see {@link https://typescript-eslint.io/users/configs#all}
   */
  public static ALL = new TypeScriptEslintConfigs("all");
   ...
   */
  public static BASE = new TypeScriptEslintConfigs("base");

  /**
   * A utility ruleset that will disable type-aware linting and all type-aware rules available in our project.
   * @see {@link https://typescript-eslint.io/users/configs#disable-type-checked}
   */
  public static DISABLE_TYPE_CHECKED = new TypeScriptEslintConfigs(
    "disableTypeChecked"
  );
   ...
   */
  public static ESLINT_RECOMMENDED = new TypeScriptEslintConfigs(
    "eslintRecommended"
  );
   ...
   */
  public static RECOMMENDED = new TypeScriptEslintConfigs("recommended");

  /**
   * Contains all of `recommended` along with additional recommended rules that require type information.
   * @see {@link https://typescript-eslint.io/users/configs#recommended-type-checked}
   */
  public static RECOMMENDED_TYPE_CHECKED = new TypeScriptEslintConfigs(
   ...
   */
  public static RECOMMENDED_TYPE_CHECKED_ONLY = new TypeScriptEslintConfigs(
   ...
   */
  public static STRICT = new TypeScriptEslintConfigs("strict");

  /**
   * Contains all of `recommended`, `recommended-type-checked`, and `strict`, along with additional strict rules that require type information.
   * @see {@link https://typescript-eslint.io/users/configs#strict-type-checked}
   */
  public static STRICT_TYPE_CHECKED = new TypeScriptEslintConfigs(
    "strictTypeChecked"
  );
   ...
   */
  public static STRICT_TYPE_CHECKED_ONLY = new TypeScriptEslintConfigs(
   ...
   */
  public static STYLISTIC = new TypeScriptEslintConfigs("stylistic");

  /**
   * Contains all of `stylistic`, along with additional stylistic rules that require type information.
   * @see {@link https://typescript-eslint.io/users/configs#stylistic-type-checked}
   */
  public static STYLISTIC_TYPE_CHECKED = new TypeScriptEslintConfigs(
   ...
   */
  public static STYLISTIC_TYPE_CHECKED_ONLY = new TypeScriptEslintConfigs(
