...
export class TaskRuntime {
  ...
  private verifyManifest(manifest: TasksManifest): void {
    ...
    if (manifest.manifestVersion > TasksManifestSchema.VERSION) {
      logging.warn(
        `${TaskRuntime.MANIFEST_FILE} was generated by a newer version of projen ` +
          `(manifest version ${manifest.manifestVersion}, this projen supports up to ${TasksManifestSchema.VERSION}). ` +
