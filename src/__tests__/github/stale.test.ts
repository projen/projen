import { StaleBehavior } from '../../github';
import { renderBehavior } from '../../github/stale-util';
...
describe('renderBehavior()', () => {
  ...
  test('defaults', () => {
    expect(renderBehavior(undefined, { stale: 10, close: 11, type: 'issue' })).toStrictEqual({
    ...
    expect(renderBehavior(undefined, { stale: 99, close: 65, type: 'xomo' })).toStrictEqual({
