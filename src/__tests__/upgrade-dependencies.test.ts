...
test('upgrades command includes all dependencies', () => {
  ...
  const deps = 'jest jest-junit npm-check-updates npm-check-updates standard-version some-dep';
...
test('upgrades command doesnt include ignored packages', () => {
  ...
  const deps = 'jest jest-junit npm-check-updates npm-check-updates standard-version dep1';
