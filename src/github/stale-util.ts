...
export function renderBehavior(
  ...
  return {
    ...
    staleMessage:
      ...
      `This ${opts.type} is now marked as stale because it hasn\'t seen activity for a while. Add a comment or it will be closed soon.`,
    closeMessage:
      behavior?.closeMessage ??
      `Closing this ${opts.type} as it hasn\'t seen activity for a while. Please add a comment @mentioning a maintainer to reopen.`,
