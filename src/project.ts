...
export class Project {
  ...
  /**
   * This task ejects the project from projen. This includes but is not
   * limited to:
   *
   * - removing "Generated by projen" comments from projen-managed files
   * - changing projen-managed files from readonly to user-writeable
   * - uninstalling projen
   * - removing projen metadata
   */
