...
| <code><a href="#projen.cdk.ConstructLibrary.property.nodeTestRunner">nodeTestRunner</a></code> | <code>projen.javascript.NodeTestRunner</code> | The Node.js native test runner configuration (if enabled). |
...
| <code><a href="#projen.cdk.ConstructLibrary.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner used for executing TypeScript files. |
...
##### `nodeTestRunner`<sup>Optional</sup> <a name="nodeTestRunner" id="projen.cdk.ConstructLibrary.property.nodeTestRunner"></a>
...
##### `runner`<sup>Required</sup> <a name="runner" id="projen.cdk.ConstructLibrary.property.runner"></a>
...
| <code><a href="#projen.cdk.JsiiProject.property.nodeTestRunner">nodeTestRunner</a></code> | <code>projen.javascript.NodeTestRunner</code> | The Node.js native test runner configuration (if enabled). |
...
| <code><a href="#projen.cdk.JsiiProject.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner used for executing TypeScript files. |
...
##### `nodeTestRunner`<sup>Optional</sup> <a name="nodeTestRunner" id="projen.cdk.JsiiProject.property.nodeTestRunner"></a>
...
##### `runner`<sup>Required</sup> <a name="runner" id="projen.cdk.JsiiProject.property.runner"></a>
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.devEngines">devEngines</a></code> | <code>projen.javascript.DevEngines</code> | Configure the `devEngines` field in `package.json`. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.nodeTestRunner">nodeTestRunner</a></code> | <code>boolean</code> | Setup unit tests using Node.js' built-in test runner (`node --test`). |
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.nodeTestRunnerOptions">nodeTestRunnerOptions</a></code> | <code>projen.javascript.NodeTestRunnerOptions</code> | Node test runner options. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner to use for executing TypeScript files. |
...
| <code><a href="#projen.cdk.ConstructLibraryOptions.property.tsconfig">tsconfig</a></code> | <code>projen.javascript.TypescriptConfigOptions</code> | Custom TSConfig. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.cdk.ConstructLibraryOptions.property.projectTree"></a>
...
##### `addPackageManagerToDevEngines`<sup>Optional</sup> <a name="addPackageManagerToDevEngines" id="projen.cdk.ConstructLibraryOptions.property.addPackageManagerToDevEngines"></a>
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="projen.cdk.ConstructLibraryOptions.property.allowScripts"></a>
...
##### `bunVersion`<sup>Optional</sup> <a name="bunVersion" id="projen.cdk.ConstructLibraryOptions.property.bunVersion"></a>
...
##### `deleteOrphanedLockFiles`<sup>Optional</sup> <a name="deleteOrphanedLockFiles" id="projen.cdk.ConstructLibraryOptions.property.deleteOrphanedLockFiles"></a>
...
##### `devEngines`<sup>Optional</sup> <a name="devEngines" id="projen.cdk.ConstructLibraryOptions.property.devEngines"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="projen.cdk.ConstructLibraryOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="projen.cdk.ConstructLibraryOptions.property.bumpPackage"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="projen.cdk.ConstructLibraryOptions.property.nextVersionCommand"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="projen.cdk.ConstructLibraryOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="projen.cdk.ConstructLibraryOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="projen.cdk.ConstructLibraryOptions.property.auditDepsOptions"></a>
...
##### `nodeTestRunner`<sup>Optional</sup> <a name="nodeTestRunner" id="projen.cdk.ConstructLibraryOptions.property.nodeTestRunner"></a>
...
##### `nodeTestRunnerOptions`<sup>Optional</sup> <a name="nodeTestRunnerOptions" id="projen.cdk.ConstructLibraryOptions.property.nodeTestRunnerOptions"></a>
...
##### `runner`<sup>Optional</sup> <a name="runner" id="projen.cdk.ConstructLibraryOptions.property.runner"></a>
...
| <code><a href="#projen.cdk.JsiiBuildOptions.property.tsconfig">tsconfig</a></code> | <code>projen.javascript.TypescriptConfig</code> | The TypescriptConfig that jsii compiles against. |
| <code><a href="#projen.cdk.JsiiBuildOptions.property.validateTsconfig">validateTsconfig</a></code> | <code><a href="#projen.cdk.ValidateTsconfig">ValidateTsconfig</a></code> | Level of tsconfig validation jsii should perform on the user-provided tsconfig. |
...
##### `tsconfig`<sup>Optional</sup> <a name="tsconfig" id="projen.cdk.JsiiBuildOptions.property.tsconfig"></a>
...
##### `validateTsconfig`<sup>Optional</sup> <a name="validateTsconfig" id="projen.cdk.JsiiBuildOptions.property.validateTsconfig"></a>
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.devEngines">devEngines</a></code> | <code>projen.javascript.DevEngines</code> | Configure the `devEngines` field in `package.json`. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.nodeTestRunner">nodeTestRunner</a></code> | <code>boolean</code> | Setup unit tests using Node.js' built-in test runner (`node --test`). |
| <code><a href="#projen.cdk.JsiiProjectOptions.property.nodeTestRunnerOptions">nodeTestRunnerOptions</a></code> | <code>projen.javascript.NodeTestRunnerOptions</code> | Node test runner options. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner to use for executing TypeScript files. |
...
| <code><a href="#projen.cdk.JsiiProjectOptions.property.tsconfig">tsconfig</a></code> | <code>projen.javascript.TypescriptConfigOptions</code> | Custom TSConfig. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.cdk.JsiiProjectOptions.property.projectTree"></a>
...
##### `addPackageManagerToDevEngines`<sup>Optional</sup> <a name="addPackageManagerToDevEngines" id="projen.cdk.JsiiProjectOptions.property.addPackageManagerToDevEngines"></a>
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="projen.cdk.JsiiProjectOptions.property.allowScripts"></a>
...
##### `bunVersion`<sup>Optional</sup> <a name="bunVersion" id="projen.cdk.JsiiProjectOptions.property.bunVersion"></a>
...
##### `deleteOrphanedLockFiles`<sup>Optional</sup> <a name="deleteOrphanedLockFiles" id="projen.cdk.JsiiProjectOptions.property.deleteOrphanedLockFiles"></a>
...
##### `devEngines`<sup>Optional</sup> <a name="devEngines" id="projen.cdk.JsiiProjectOptions.property.devEngines"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="projen.cdk.JsiiProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="projen.cdk.JsiiProjectOptions.property.bumpPackage"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="projen.cdk.JsiiProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="projen.cdk.JsiiProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="projen.cdk.JsiiProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="projen.cdk.JsiiProjectOptions.property.auditDepsOptions"></a>
...
##### `nodeTestRunner`<sup>Optional</sup> <a name="nodeTestRunner" id="projen.cdk.JsiiProjectOptions.property.nodeTestRunner"></a>
...
##### `nodeTestRunnerOptions`<sup>Optional</sup> <a name="nodeTestRunnerOptions" id="projen.cdk.JsiiProjectOptions.property.nodeTestRunnerOptions"></a>
...
##### `runner`<sup>Optional</sup> <a name="runner" id="projen.cdk.JsiiProjectOptions.property.runner"></a>
...
### ValidateTsconfig <a name="ValidateTsconfig" id="projen.cdk.ValidateTsconfig"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#projen.cdk.ValidateTsconfig.STRICT">STRICT</a></code> | Validates against a strict rule set designed for widespread support and backwards-compatibility. |
| <code><a href="#projen.cdk.ValidateTsconfig.GENERATED">GENERATED</a></code> | Enforces a tsconfig as if it were generated by jsii. |
| <code><a href="#projen.cdk.ValidateTsconfig.MINIMAL">MINIMAL</a></code> | Only reject options known to be incompatible with jsii. |
| <code><a href="#projen.cdk.ValidateTsconfig.OFF">OFF</a></code> | Disables all config validation. |

---

##### `STRICT` <a name="STRICT" id="projen.cdk.ValidateTsconfig.STRICT"></a>
...
##### `GENERATED` <a name="GENERATED" id="projen.cdk.ValidateTsconfig.GENERATED"></a>
...
##### `MINIMAL` <a name="MINIMAL" id="projen.cdk.ValidateTsconfig.MINIMAL"></a>
...
##### `OFF` <a name="OFF" id="projen.cdk.ValidateTsconfig.OFF"></a>
