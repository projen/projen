...
| <code><a href="#projen.typescript.TypeScriptLibraryProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/ Uses codecov/codecov-action A secret is required for private repos. Configured with `codeCovTokenSecret`. |
...
| <code><a href="#projen.typescript.TypeScriptProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/ Uses codecov/codecov-action A secret is required for private repos. Configured with `codeCovTokenSecret`. |
