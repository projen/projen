...
javascript.Biome.of(project: NodeProject)
```
...
| <code><a href="#projen.javascript.Biome.property.biomeTask">biomeTask</a></code> | <code>projen.Task</code> | Biome task. |
...
##### `biomeTask`<sup>Required</sup> <a name="biomeTask" id="projen.javascript.Biome.property.biomeTask"></a>
...
| <code><a href="#projen.javascript.BiomeOptions.property.overrides">overrides</a></code> | <code><a href="#projen.javascript.IConfiguration">IConfiguration</a></code> | Full Biome configuration. |
...
##### `overrides`<sup>Optional</sup> <a name="overrides" id="projen.javascript.BiomeOptions.property.overrides"></a>

```typescript
public readonly overrides: IConfiguration;
```

- *Type:* <a href="#projen.javascript.IConfiguration">IConfiguration</a>
...
### IA11y <a name="IA11y" id="projen.javascript.IA11y"></a>

- *Implemented By:* <a href="#projen.javascript.IA11y">IA11y</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IA11y.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.IA11y.property.noAccessKey">noAccessKey</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that the accessKey attribute is not used on any HTML element. |
| <code><a href="#projen.javascript.IA11y.property.noAriaHiddenOnFocusable">noAriaHiddenOnFocusable</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that aria-hidden="true" is not set on focusable elements. |
| <code><a href="#projen.javascript.IA11y.property.noAriaUnsupportedElements">noAriaUnsupportedElements</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that elements that do not support ARIA roles, states, and properties do not have those attributes. |
| <code><a href="#projen.javascript.IA11y.property.noAutofocus">noAutofocus</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that autoFocus prop is not used on elements. |
| <code><a href="#projen.javascript.IA11y.property.noBlankTarget">noBlankTarget</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithAllowDomainOptions">IRuleWithAllowDomainOptions</a></code> | Disallow target="_blank" attribute without rel="noreferrer". |
| <code><a href="#projen.javascript.IA11y.property.noDistractingElements">noDistractingElements</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforces that no distracting elements are used. |
| <code><a href="#projen.javascript.IA11y.property.noHeaderScope">noHeaderScope</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | The scope prop should be used only on \<th> elements. |
| <code><a href="#projen.javascript.IA11y.property.noInteractiveElementToNoninteractiveRole">noInteractiveElementToNoninteractiveRole</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that non-interactive ARIA roles are not assigned to interactive HTML elements. |
| <code><a href="#projen.javascript.IA11y.property.noLabelWithoutControl">noLabelWithoutControl</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoLabelWithoutControlOptions">IRuleWithNoLabelWithoutControlOptions</a></code> | Enforce that a label element or component has a text label and an associated input. |
| <code><a href="#projen.javascript.IA11y.property.noNoninteractiveElementToInteractiveRole">noNoninteractiveElementToInteractiveRole</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that interactive ARIA roles are not assigned to non-interactive HTML elements. |
| <code><a href="#projen.javascript.IA11y.property.noNoninteractiveTabindex">noNoninteractiveTabindex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that tabIndex is not assigned to non-interactive HTML elements. |
| <code><a href="#projen.javascript.IA11y.property.noPositiveTabindex">noPositiveTabindex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prevent the usage of positive integers on tabIndex property. |
| <code><a href="#projen.javascript.IA11y.property.noRedundantAlt">noRedundantAlt</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce img alt prop does not contain the word "image", "picture", or "photo". |
| <code><a href="#projen.javascript.IA11y.property.noRedundantRoles">noRedundantRoles</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce explicit role property is not the same as implicit/default role property on an element. |
| <code><a href="#projen.javascript.IA11y.property.noSvgWithoutTitle">noSvgWithoutTitle</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforces the usage of the title element for the svg element. |
| <code><a href="#projen.javascript.IA11y.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |
| <code><a href="#projen.javascript.IA11y.property.useAltText">useAltText</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that all elements that require alternative text have meaningful information to relay back to the end user. |
| <code><a href="#projen.javascript.IA11y.property.useAnchorContent">useAnchorContent</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that anchors have content and that the content is accessible to screen readers. |
| <code><a href="#projen.javascript.IA11y.property.useAriaActivedescendantWithTabindex">useAriaActivedescendantWithTabindex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce that tabIndex is assigned to non-interactive HTML elements with aria-activedescendant. |
| <code><a href="#projen.javascript.IA11y.property.useAriaPropsForRole">useAriaPropsForRole</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that elements with ARIA roles must have all required ARIA attributes for that role. |
| <code><a href="#projen.javascript.IA11y.property.useButtonType">useButtonType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforces the usage of the attribute type for the element button. |
| <code><a href="#projen.javascript.IA11y.property.useFocusableInteractive">useFocusableInteractive</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Elements with an interactive role and interaction handlers must be focusable. |
| <code><a href="#projen.javascript.IA11y.property.useGenericFontNames">useGenericFontNames</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow a missing generic family keyword within font families. |
| <code><a href="#projen.javascript.IA11y.property.useHeadingContent">useHeadingContent</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that heading elements (h1, h2, etc.) have content and that the content is accessible to screen readers. Accessible means that it is not hidden using the aria-hidden prop. |
| <code><a href="#projen.javascript.IA11y.property.useHtmlLang">useHtmlLang</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that html element has lang attribute. |
| <code><a href="#projen.javascript.IA11y.property.useIframeTitle">useIframeTitle</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforces the usage of the attribute title for the element iframe. |
| <code><a href="#projen.javascript.IA11y.property.useKeyWithClickEvents">useKeyWithClickEvents</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce onClick is accompanied by at least one of the following: onKeyUp, onKeyDown, onKeyPress. |
| <code><a href="#projen.javascript.IA11y.property.useKeyWithMouseEvents">useKeyWithMouseEvents</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce onMouseOver / onMouseOut are accompanied by onFocus / onBlur. |
| <code><a href="#projen.javascript.IA11y.property.useMediaCaption">useMediaCaption</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforces that audio and video elements must have a track for captions. |
| <code><a href="#projen.javascript.IA11y.property.useSemanticElements">useSemanticElements</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | It detects the use of role attributes in JSX elements and suggests using semantic elements instead. |
| <code><a href="#projen.javascript.IA11y.property.useValidAnchor">useValidAnchor</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that all anchors are valid, and they are navigable elements. |
| <code><a href="#projen.javascript.IA11y.property.useValidAriaProps">useValidAriaProps</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Ensures that ARIA properties aria-* are all valid. |
| <code><a href="#projen.javascript.IA11y.property.useValidAriaRole">useValidAriaRole</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithValidAriaRoleOptions">IRuleWithValidAriaRoleOptions</a></code> | Elements with ARIA roles must use a valid, non-abstract ARIA role. |
| <code><a href="#projen.javascript.IA11y.property.useValidAriaValues">useValidAriaValues</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that ARIA state and property values are valid. |
| <code><a href="#projen.javascript.IA11y.property.useValidLang">useValidLang</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Ensure that the attribute passed to the lang attribute is a correct ISO language and/or country. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.IA11y.property.all"></a>
...
##### `noAccessKey`<sup>Optional</sup> <a name="noAccessKey" id="projen.javascript.IA11y.property.noAccessKey"></a>

```typescript
public readonly noAccessKey: string | IRuleWithFixNoOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a>

Enforce that the accessKey attribute is not used on any HTML element.

---

##### `noAriaHiddenOnFocusable`<sup>Optional</sup> <a name="noAriaHiddenOnFocusable" id="projen.javascript.IA11y.property.noAriaHiddenOnFocusable"></a>
...
##### `noAriaUnsupportedElements`<sup>Optional</sup> <a name="noAriaUnsupportedElements" id="projen.javascript.IA11y.property.noAriaUnsupportedElements"></a>
...
##### `noAutofocus`<sup>Optional</sup> <a name="noAutofocus" id="projen.javascript.IA11y.property.noAutofocus"></a>
...
##### `noBlankTarget`<sup>Optional</sup> <a name="noBlankTarget" id="projen.javascript.IA11y.property.noBlankTarget"></a>

```typescript
public readonly noBlankTarget: string | IRuleWithAllowDomainOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithAllowDomainOptions">IRuleWithAllowDomainOptions</a>

Disallow target="_blank" attribute without rel="noreferrer".

---

##### `noDistractingElements`<sup>Optional</sup> <a name="noDistractingElements" id="projen.javascript.IA11y.property.noDistractingElements"></a>
...
##### `noHeaderScope`<sup>Optional</sup> <a name="noHeaderScope" id="projen.javascript.IA11y.property.noHeaderScope"></a>
...
##### `noInteractiveElementToNoninteractiveRole`<sup>Optional</sup> <a name="noInteractiveElementToNoninteractiveRole" id="projen.javascript.IA11y.property.noInteractiveElementToNoninteractiveRole"></a>
...
##### `noLabelWithoutControl`<sup>Optional</sup> <a name="noLabelWithoutControl" id="projen.javascript.IA11y.property.noLabelWithoutControl"></a>

```typescript
public readonly noLabelWithoutControl: string | IRuleWithNoLabelWithoutControlOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithNoLabelWithoutControlOptions">IRuleWithNoLabelWithoutControlOptions</a>

Enforce that a label element or component has a text label and an associated input.

---

##### `noNoninteractiveElementToInteractiveRole`<sup>Optional</sup> <a name="noNoninteractiveElementToInteractiveRole" id="projen.javascript.IA11y.property.noNoninteractiveElementToInteractiveRole"></a>
...
##### `noNoninteractiveTabindex`<sup>Optional</sup> <a name="noNoninteractiveTabindex" id="projen.javascript.IA11y.property.noNoninteractiveTabindex"></a>
...
##### `noPositiveTabindex`<sup>Optional</sup> <a name="noPositiveTabindex" id="projen.javascript.IA11y.property.noPositiveTabindex"></a>
...
##### `noRedundantAlt`<sup>Optional</sup> <a name="noRedundantAlt" id="projen.javascript.IA11y.property.noRedundantAlt"></a>

```typescript
public readonly noRedundantAlt: string | IRuleWithNoOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a>

Enforce img alt prop does not contain the word "image", "picture", or "photo".

---

##### `noRedundantRoles`<sup>Optional</sup> <a name="noRedundantRoles" id="projen.javascript.IA11y.property.noRedundantRoles"></a>
...
##### `noSvgWithoutTitle`<sup>Optional</sup> <a name="noSvgWithoutTitle" id="projen.javascript.IA11y.property.noSvgWithoutTitle"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.IA11y.property.recommended"></a>
...
##### `useAltText`<sup>Optional</sup> <a name="useAltText" id="projen.javascript.IA11y.property.useAltText"></a>
...
##### `useAnchorContent`<sup>Optional</sup> <a name="useAnchorContent" id="projen.javascript.IA11y.property.useAnchorContent"></a>
...
##### `useAriaActivedescendantWithTabindex`<sup>Optional</sup> <a name="useAriaActivedescendantWithTabindex" id="projen.javascript.IA11y.property.useAriaActivedescendantWithTabindex"></a>
...
##### `useAriaPropsForRole`<sup>Optional</sup> <a name="useAriaPropsForRole" id="projen.javascript.IA11y.property.useAriaPropsForRole"></a>
...
##### `useButtonType`<sup>Optional</sup> <a name="useButtonType" id="projen.javascript.IA11y.property.useButtonType"></a>
...
##### `useFocusableInteractive`<sup>Optional</sup> <a name="useFocusableInteractive" id="projen.javascript.IA11y.property.useFocusableInteractive"></a>
...
##### `useGenericFontNames`<sup>Optional</sup> <a name="useGenericFontNames" id="projen.javascript.IA11y.property.useGenericFontNames"></a>
...
##### `useHeadingContent`<sup>Optional</sup> <a name="useHeadingContent" id="projen.javascript.IA11y.property.useHeadingContent"></a>
...
##### `useHtmlLang`<sup>Optional</sup> <a name="useHtmlLang" id="projen.javascript.IA11y.property.useHtmlLang"></a>
...
##### `useIframeTitle`<sup>Optional</sup> <a name="useIframeTitle" id="projen.javascript.IA11y.property.useIframeTitle"></a>
...
##### `useKeyWithClickEvents`<sup>Optional</sup> <a name="useKeyWithClickEvents" id="projen.javascript.IA11y.property.useKeyWithClickEvents"></a>
...
##### `useKeyWithMouseEvents`<sup>Optional</sup> <a name="useKeyWithMouseEvents" id="projen.javascript.IA11y.property.useKeyWithMouseEvents"></a>
...
##### `useMediaCaption`<sup>Optional</sup> <a name="useMediaCaption" id="projen.javascript.IA11y.property.useMediaCaption"></a>
...
##### `useSemanticElements`<sup>Optional</sup> <a name="useSemanticElements" id="projen.javascript.IA11y.property.useSemanticElements"></a>
...
##### `useValidAnchor`<sup>Optional</sup> <a name="useValidAnchor" id="projen.javascript.IA11y.property.useValidAnchor"></a>
...
##### `useValidAriaProps`<sup>Optional</sup> <a name="useValidAriaProps" id="projen.javascript.IA11y.property.useValidAriaProps"></a>
...
##### `useValidAriaRole`<sup>Optional</sup> <a name="useValidAriaRole" id="projen.javascript.IA11y.property.useValidAriaRole"></a>

```typescript
public readonly useValidAriaRole: string | IRuleWithValidAriaRoleOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithValidAriaRoleOptions">IRuleWithValidAriaRoleOptions</a>

Elements with ARIA roles must use a valid, non-abstract ARIA role.

---

##### `useValidAriaValues`<sup>Optional</sup> <a name="useValidAriaValues" id="projen.javascript.IA11y.property.useValidAriaValues"></a>
...
##### `useValidLang`<sup>Optional</sup> <a name="useValidLang" id="projen.javascript.IA11y.property.useValidLang"></a>
...
### IActions <a name="IActions" id="projen.javascript.IActions"></a>

- *Implemented By:* <a href="#projen.javascript.IActions">IActions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IActions.property.source">source</a></code> | <code><a href="#projen.javascript.ISource">ISource</a></code> | *No description.* |

---

##### `source`<sup>Optional</sup> <a name="source" id="projen.javascript.IActions.property.source"></a>

```typescript
public readonly source: ISource;
```

- *Type:* <a href="#projen.javascript.ISource">ISource</a>

---

### IAllowDomainOptions <a name="IAllowDomainOptions" id="projen.javascript.IAllowDomainOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IAllowDomainOptions">IAllowDomainOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IAllowDomainOptions.property.allowDomains">allowDomains</a></code> | <code>string[]</code> | List of domains to allow `target="_blank"` without `rel="noreferrer"`. |

---

##### `allowDomains`<sup>Optional</sup> <a name="allowDomains" id="projen.javascript.IAllowDomainOptions.property.allowDomains"></a>
...
### IAssistsConfiguration <a name="IAssistsConfiguration" id="projen.javascript.IAssistsConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IAssistsConfiguration">IAssistsConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IAssistsConfiguration.property.actions">actions</a></code> | <code><a href="#projen.javascript.IActions">IActions</a></code> | Whether Biome should fail in CLI if the assists were not applied to the code. |
| <code><a href="#projen.javascript.IAssistsConfiguration.property.enabled">enabled</a></code> | <code>boolean</code> | Whether Biome should enable assists via LSP. |
| <code><a href="#projen.javascript.IAssistsConfiguration.property.ignore">ignore</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IAssistsConfiguration.property.include">include</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |

---

##### `actions`<sup>Optional</sup> <a name="actions" id="projen.javascript.IAssistsConfiguration.property.actions"></a>

```typescript
public readonly actions: IActions;
```

- *Type:* <a href="#projen.javascript.IActions">IActions</a>

Whether Biome should fail in CLI if the assists were not applied to the code.

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IAssistsConfiguration.property.enabled"></a>
...
##### `ignore`<sup>Optional</sup> <a name="ignore" id="projen.javascript.IAssistsConfiguration.property.ignore"></a>
...
##### `include`<sup>Optional</sup> <a name="include" id="projen.javascript.IAssistsConfiguration.property.include"></a>
...
### IComplexity <a name="IComplexity" id="projen.javascript.IComplexity"></a>

- *Implemented By:* <a href="#projen.javascript.IComplexity">IComplexity</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IComplexity.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.IComplexity.property.noBannedTypes">noBannedTypes</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow primitive type aliases and misleading types. |
| <code><a href="#projen.javascript.IComplexity.property.noEmptyTypeParameters">noEmptyTypeParameters</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow empty type parameters in type aliases and interfaces. |
| <code><a href="#projen.javascript.IComplexity.property.noExcessiveCognitiveComplexity">noExcessiveCognitiveComplexity</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithComplexityOptions">IRuleWithComplexityOptions</a></code> | Disallow functions that exceed a given Cognitive Complexity score. |
| <code><a href="#projen.javascript.IComplexity.property.noExcessiveNestedTestSuites">noExcessiveNestedTestSuites</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | This rule enforces a maximum depth to nested describe() in test files. |
| <code><a href="#projen.javascript.IComplexity.property.noExtraBooleanCast">noExtraBooleanCast</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary boolean casts. |
| <code><a href="#projen.javascript.IComplexity.property.noForEach">noForEach</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prefer for...of statement instead of Array.forEach. |
| <code><a href="#projen.javascript.IComplexity.property.noMultipleSpacesInRegularExpressionLiterals">noMultipleSpacesInRegularExpressionLiterals</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unclear usage of consecutive space characters in regular expression literals. |
| <code><a href="#projen.javascript.IComplexity.property.noStaticOnlyClass">noStaticOnlyClass</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | This rule reports when a class has no non-static members, such as for a class used exclusively as a static namespace. |
| <code><a href="#projen.javascript.IComplexity.property.noThisInStatic">noThisInStatic</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow this and super in static contexts. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessCatch">noUselessCatch</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary catch clauses. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessConstructor">noUselessConstructor</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary constructors. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessEmptyExport">noUselessEmptyExport</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow empty exports that don't change anything in a module file. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessFragments">noUselessFragments</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary fragments. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessLabel">noUselessLabel</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary labels. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessLoneBlockStatements">noUselessLoneBlockStatements</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary nested block statements. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessRename">noUselessRename</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow renaming import, export, and destructured assignments to the same name. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessStringConcat">noUselessStringConcat</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary concatenation of string or template literals. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessSwitchCase">noUselessSwitchCase</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow useless case in switch statements. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessTernary">noUselessTernary</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow ternary operators when simpler alternatives exist. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessThisAlias">noUselessThisAlias</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow useless this aliasing. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessTypeConstraint">noUselessTypeConstraint</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow using any or unknown as type constraint. |
| <code><a href="#projen.javascript.IComplexity.property.noUselessUndefinedInitialization">noUselessUndefinedInitialization</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow initializing variables to undefined. |
| <code><a href="#projen.javascript.IComplexity.property.noVoid">noVoid</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of void operators, which is not a familiar operator. |
| <code><a href="#projen.javascript.IComplexity.property.noWith">noWith</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow with statements in non-strict contexts. |
| <code><a href="#projen.javascript.IComplexity.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |
| <code><a href="#projen.javascript.IComplexity.property.useArrowFunction">useArrowFunction</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use arrow functions over function expressions. |
| <code><a href="#projen.javascript.IComplexity.property.useDateNow">useDateNow</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use Date.now() to get the number of milliseconds since the Unix Epoch. |
| <code><a href="#projen.javascript.IComplexity.property.useFlatMap">useFlatMap</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Promotes the use of .flatMap() when map().flat() are used together. |
| <code><a href="#projen.javascript.IComplexity.property.useLiteralKeys">useLiteralKeys</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the usage of a literal access to properties over computed property access. |
| <code><a href="#projen.javascript.IComplexity.property.useOptionalChain">useOptionalChain</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce using concise optional chain instead of chained logical expressions. |
| <code><a href="#projen.javascript.IComplexity.property.useRegexLiterals">useRegexLiterals</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the use of the regular expression literals instead of the RegExp constructor if possible. |
| <code><a href="#projen.javascript.IComplexity.property.useSimpleNumberKeys">useSimpleNumberKeys</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow number literal object member names which are not base10 or uses underscore as separator. |
| <code><a href="#projen.javascript.IComplexity.property.useSimplifiedLogicExpression">useSimplifiedLogicExpression</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Discard redundant terms from logical expressions. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.IComplexity.property.all"></a>
...
##### `noBannedTypes`<sup>Optional</sup> <a name="noBannedTypes" id="projen.javascript.IComplexity.property.noBannedTypes"></a>
...
##### `noEmptyTypeParameters`<sup>Optional</sup> <a name="noEmptyTypeParameters" id="projen.javascript.IComplexity.property.noEmptyTypeParameters"></a>
...
##### `noExcessiveCognitiveComplexity`<sup>Optional</sup> <a name="noExcessiveCognitiveComplexity" id="projen.javascript.IComplexity.property.noExcessiveCognitiveComplexity"></a>

```typescript
public readonly noExcessiveCognitiveComplexity: string | IRuleWithComplexityOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithComplexityOptions">IRuleWithComplexityOptions</a>

Disallow functions that exceed a given Cognitive Complexity score.

---

##### `noExcessiveNestedTestSuites`<sup>Optional</sup> <a name="noExcessiveNestedTestSuites" id="projen.javascript.IComplexity.property.noExcessiveNestedTestSuites"></a>
...
##### `noExtraBooleanCast`<sup>Optional</sup> <a name="noExtraBooleanCast" id="projen.javascript.IComplexity.property.noExtraBooleanCast"></a>
...
##### `noForEach`<sup>Optional</sup> <a name="noForEach" id="projen.javascript.IComplexity.property.noForEach"></a>
...
##### `noMultipleSpacesInRegularExpressionLiterals`<sup>Optional</sup> <a name="noMultipleSpacesInRegularExpressionLiterals" id="projen.javascript.IComplexity.property.noMultipleSpacesInRegularExpressionLiterals"></a>
...
##### `noStaticOnlyClass`<sup>Optional</sup> <a name="noStaticOnlyClass" id="projen.javascript.IComplexity.property.noStaticOnlyClass"></a>
...
##### `noThisInStatic`<sup>Optional</sup> <a name="noThisInStatic" id="projen.javascript.IComplexity.property.noThisInStatic"></a>
...
##### `noUselessCatch`<sup>Optional</sup> <a name="noUselessCatch" id="projen.javascript.IComplexity.property.noUselessCatch"></a>
...
##### `noUselessConstructor`<sup>Optional</sup> <a name="noUselessConstructor" id="projen.javascript.IComplexity.property.noUselessConstructor"></a>
...
##### `noUselessEmptyExport`<sup>Optional</sup> <a name="noUselessEmptyExport" id="projen.javascript.IComplexity.property.noUselessEmptyExport"></a>
...
##### `noUselessFragments`<sup>Optional</sup> <a name="noUselessFragments" id="projen.javascript.IComplexity.property.noUselessFragments"></a>
...
##### `noUselessLabel`<sup>Optional</sup> <a name="noUselessLabel" id="projen.javascript.IComplexity.property.noUselessLabel"></a>
...
##### `noUselessLoneBlockStatements`<sup>Optional</sup> <a name="noUselessLoneBlockStatements" id="projen.javascript.IComplexity.property.noUselessLoneBlockStatements"></a>
...
##### `noUselessRename`<sup>Optional</sup> <a name="noUselessRename" id="projen.javascript.IComplexity.property.noUselessRename"></a>
...
##### `noUselessStringConcat`<sup>Optional</sup> <a name="noUselessStringConcat" id="projen.javascript.IComplexity.property.noUselessStringConcat"></a>
...
##### `noUselessSwitchCase`<sup>Optional</sup> <a name="noUselessSwitchCase" id="projen.javascript.IComplexity.property.noUselessSwitchCase"></a>
...
##### `noUselessTernary`<sup>Optional</sup> <a name="noUselessTernary" id="projen.javascript.IComplexity.property.noUselessTernary"></a>
...
##### `noUselessThisAlias`<sup>Optional</sup> <a name="noUselessThisAlias" id="projen.javascript.IComplexity.property.noUselessThisAlias"></a>
...
##### `noUselessTypeConstraint`<sup>Optional</sup> <a name="noUselessTypeConstraint" id="projen.javascript.IComplexity.property.noUselessTypeConstraint"></a>
...
##### `noUselessUndefinedInitialization`<sup>Optional</sup> <a name="noUselessUndefinedInitialization" id="projen.javascript.IComplexity.property.noUselessUndefinedInitialization"></a>
...
##### `noVoid`<sup>Optional</sup> <a name="noVoid" id="projen.javascript.IComplexity.property.noVoid"></a>
...
##### `noWith`<sup>Optional</sup> <a name="noWith" id="projen.javascript.IComplexity.property.noWith"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.IComplexity.property.recommended"></a>
...
##### `useArrowFunction`<sup>Optional</sup> <a name="useArrowFunction" id="projen.javascript.IComplexity.property.useArrowFunction"></a>
...
##### `useDateNow`<sup>Optional</sup> <a name="useDateNow" id="projen.javascript.IComplexity.property.useDateNow"></a>
...
##### `useFlatMap`<sup>Optional</sup> <a name="useFlatMap" id="projen.javascript.IComplexity.property.useFlatMap"></a>
...
##### `useLiteralKeys`<sup>Optional</sup> <a name="useLiteralKeys" id="projen.javascript.IComplexity.property.useLiteralKeys"></a>
...
##### `useOptionalChain`<sup>Optional</sup> <a name="useOptionalChain" id="projen.javascript.IComplexity.property.useOptionalChain"></a>
...
##### `useRegexLiterals`<sup>Optional</sup> <a name="useRegexLiterals" id="projen.javascript.IComplexity.property.useRegexLiterals"></a>
...
##### `useSimpleNumberKeys`<sup>Optional</sup> <a name="useSimpleNumberKeys" id="projen.javascript.IComplexity.property.useSimpleNumberKeys"></a>
...
##### `useSimplifiedLogicExpression`<sup>Optional</sup> <a name="useSimplifiedLogicExpression" id="projen.javascript.IComplexity.property.useSimplifiedLogicExpression"></a>
...
### IComplexityOptions <a name="IComplexityOptions" id="projen.javascript.IComplexityOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IComplexityOptions">IComplexityOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IComplexityOptions.property.maxAllowedComplexity">maxAllowedComplexity</a></code> | <code>number</code> | The maximum complexity score that we allow. |

---

##### `maxAllowedComplexity`<sup>Optional</sup> <a name="maxAllowedComplexity" id="projen.javascript.IComplexityOptions.property.maxAllowedComplexity"></a>
...
### IConfiguration <a name="IConfiguration" id="projen.javascript.IConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IConfiguration">IConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IConfiguration.property.assists">assists</a></code> | <code><a href="#projen.javascript.IAssistsConfiguration">IAssistsConfiguration</a></code> | Specific configuration for assists. |
| <code><a href="#projen.javascript.IConfiguration.property.css">css</a></code> | <code><a href="#projen.javascript.ICssConfiguration">ICssConfiguration</a></code> | Specific configuration for the Css language. |
| <code><a href="#projen.javascript.IConfiguration.property.extends">extends</a></code> | <code>string[]</code> | A list of paths to other JSON files, used to extends the current configuration. |
| <code><a href="#projen.javascript.IConfiguration.property.files">files</a></code> | <code><a href="#projen.javascript.IFilesConfiguration">IFilesConfiguration</a></code> | The configuration of the filesystem. |
| <code><a href="#projen.javascript.IConfiguration.property.formatter">formatter</a></code> | <code><a href="#projen.javascript.IFormatterConfiguration">IFormatterConfiguration</a></code> | The configuration of the formatter. |
| <code><a href="#projen.javascript.IConfiguration.property.graphql">graphql</a></code> | <code><a href="#projen.javascript.IGraphqlConfiguration">IGraphqlConfiguration</a></code> | Specific configuration for the GraphQL language. |
| <code><a href="#projen.javascript.IConfiguration.property.javascript">javascript</a></code> | <code><a href="#projen.javascript.IJavascriptConfiguration">IJavascriptConfiguration</a></code> | Specific configuration for the JavaScript language. |
| <code><a href="#projen.javascript.IConfiguration.property.json">json</a></code> | <code><a href="#projen.javascript.IJsonConfiguration">IJsonConfiguration</a></code> | Specific configuration for the Json language. |
| <code><a href="#projen.javascript.IConfiguration.property.linter">linter</a></code> | <code><a href="#projen.javascript.ILinterConfiguration">ILinterConfiguration</a></code> | The configuration for the linter. |
| <code><a href="#projen.javascript.IConfiguration.property.organizeImports">organizeImports</a></code> | <code><a href="#projen.javascript.IOrganizeImports">IOrganizeImports</a></code> | The configuration of the import sorting. |
| <code><a href="#projen.javascript.IConfiguration.property.overrides">overrides</a></code> | <code><a href="#projen.javascript.IOverridePattern">IOverridePattern</a>[]</code> | A list of granular patterns that should be applied only to a sub set of files. |
| <code><a href="#projen.javascript.IConfiguration.property.vcs">vcs</a></code> | <code><a href="#projen.javascript.IVcsConfiguration">IVcsConfiguration</a></code> | The configuration of the VCS integration. |

---

##### `assists`<sup>Optional</sup> <a name="assists" id="projen.javascript.IConfiguration.property.assists"></a>

```typescript
public readonly assists: IAssistsConfiguration;
```

- *Type:* <a href="#projen.javascript.IAssistsConfiguration">IAssistsConfiguration</a>

Specific configuration for assists.

---

##### `css`<sup>Optional</sup> <a name="css" id="projen.javascript.IConfiguration.property.css"></a>

```typescript
public readonly css: ICssConfiguration;
```

- *Type:* <a href="#projen.javascript.ICssConfiguration">ICssConfiguration</a>

Specific configuration for the Css language.

---

##### `extends`<sup>Optional</sup> <a name="extends" id="projen.javascript.IConfiguration.property.extends"></a>
...
##### `files`<sup>Optional</sup> <a name="files" id="projen.javascript.IConfiguration.property.files"></a>

```typescript
public readonly files: IFilesConfiguration;
```

- *Type:* <a href="#projen.javascript.IFilesConfiguration">IFilesConfiguration</a>

The configuration of the filesystem.

---

##### `formatter`<sup>Optional</sup> <a name="formatter" id="projen.javascript.IConfiguration.property.formatter"></a>

```typescript
public readonly formatter: IFormatterConfiguration;
```

- *Type:* <a href="#projen.javascript.IFormatterConfiguration">IFormatterConfiguration</a>

The configuration of the formatter.

---

##### `graphql`<sup>Optional</sup> <a name="graphql" id="projen.javascript.IConfiguration.property.graphql"></a>

```typescript
public readonly graphql: IGraphqlConfiguration;
```

- *Type:* <a href="#projen.javascript.IGraphqlConfiguration">IGraphqlConfiguration</a>

Specific configuration for the GraphQL language.

---

##### `javascript`<sup>Optional</sup> <a name="javascript" id="projen.javascript.IConfiguration.property.javascript"></a>

```typescript
public readonly javascript: IJavascriptConfiguration;
```

- *Type:* <a href="#projen.javascript.IJavascriptConfiguration">IJavascriptConfiguration</a>

Specific configuration for the JavaScript language.

---

##### `json`<sup>Optional</sup> <a name="json" id="projen.javascript.IConfiguration.property.json"></a>

```typescript
public readonly json: IJsonConfiguration;
```

- *Type:* <a href="#projen.javascript.IJsonConfiguration">IJsonConfiguration</a>

Specific configuration for the Json language.

---

##### `linter`<sup>Optional</sup> <a name="linter" id="projen.javascript.IConfiguration.property.linter"></a>

```typescript
public readonly linter: ILinterConfiguration;
```

- *Type:* <a href="#projen.javascript.ILinterConfiguration">ILinterConfiguration</a>

The configuration for the linter.

---

##### `organizeImports`<sup>Optional</sup> <a name="organizeImports" id="projen.javascript.IConfiguration.property.organizeImports"></a>

```typescript
public readonly organizeImports: IOrganizeImports;
```

- *Type:* <a href="#projen.javascript.IOrganizeImports">IOrganizeImports</a>

The configuration of the import sorting.

---

##### `overrides`<sup>Optional</sup> <a name="overrides" id="projen.javascript.IConfiguration.property.overrides"></a>

```typescript
public readonly overrides: IOverridePattern[];
```

- *Type:* <a href="#projen.javascript.IOverridePattern">IOverridePattern</a>[]

A list of granular patterns that should be applied only to a sub set of files.

---

##### `vcs`<sup>Optional</sup> <a name="vcs" id="projen.javascript.IConfiguration.property.vcs"></a>

```typescript
public readonly vcs: IVcsConfiguration;
```

- *Type:* <a href="#projen.javascript.IVcsConfiguration">IVcsConfiguration</a>

The configuration of the VCS integration.

---

### IConsistentArrayTypeOptions <a name="IConsistentArrayTypeOptions" id="projen.javascript.IConsistentArrayTypeOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IConsistentArrayTypeOptions">IConsistentArrayTypeOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IConsistentArrayTypeOptions.property.syntax">syntax</a></code> | <code>string</code> | *No description.* |

---

##### `syntax`<sup>Optional</sup> <a name="syntax" id="projen.javascript.IConsistentArrayTypeOptions.property.syntax"></a>
...
### IConsistentMemberAccessibilityOptions <a name="IConsistentMemberAccessibilityOptions" id="projen.javascript.IConsistentMemberAccessibilityOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IConsistentMemberAccessibilityOptions">IConsistentMemberAccessibilityOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IConsistentMemberAccessibilityOptions.property.accessibility">accessibility</a></code> | <code>string</code> | *No description.* |

---

##### `accessibility`<sup>Optional</sup> <a name="accessibility" id="projen.javascript.IConsistentMemberAccessibilityOptions.property.accessibility"></a>
...
### IConvention <a name="IConvention" id="projen.javascript.IConvention"></a>

- *Implemented By:* <a href="#projen.javascript.IConvention">IConvention</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IConvention.property.formats">formats</a></code> | <code>string[]</code> | String cases to enforce. |
| <code><a href="#projen.javascript.IConvention.property.match">match</a></code> | <code>string</code> | Regular expression to enforce. |
| <code><a href="#projen.javascript.IConvention.property.selector">selector</a></code> | <code><a href="#projen.javascript.ISelector">ISelector</a></code> | Declarations concerned by this convention. |

---

##### `formats`<sup>Optional</sup> <a name="formats" id="projen.javascript.IConvention.property.formats"></a>
...
##### `match`<sup>Optional</sup> <a name="match" id="projen.javascript.IConvention.property.match"></a>
...
##### `selector`<sup>Optional</sup> <a name="selector" id="projen.javascript.IConvention.property.selector"></a>

```typescript
public readonly selector: ISelector;
```

- *Type:* <a href="#projen.javascript.ISelector">ISelector</a>

Declarations concerned by this convention.

---

### ICorrectness <a name="ICorrectness" id="projen.javascript.ICorrectness"></a>

- *Implemented By:* <a href="#projen.javascript.ICorrectness">ICorrectness</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ICorrectness.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.ICorrectness.property.noChildrenProp">noChildrenProp</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevent passing of children as props. |
| <code><a href="#projen.javascript.ICorrectness.property.noConstantCondition">noConstantCondition</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow constant expressions in conditions. |
| <code><a href="#projen.javascript.ICorrectness.property.noConstantMathMinMaxClamp">noConstantMathMinMaxClamp</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of Math.min and Math.max to clamp a value where the result itself is constant. |
| <code><a href="#projen.javascript.ICorrectness.property.noConstAssign">noConstAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prevents from having const variables being re-assigned. |
| <code><a href="#projen.javascript.ICorrectness.property.noConstructorReturn">noConstructorReturn</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow returning a value from a constructor. |
| <code><a href="#projen.javascript.ICorrectness.property.noEmptyCharacterClassInRegex">noEmptyCharacterClassInRegex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow empty character classes in regular expression literals. |
| <code><a href="#projen.javascript.ICorrectness.property.noEmptyPattern">noEmptyPattern</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallows empty destructuring patterns. |
| <code><a href="#projen.javascript.ICorrectness.property.noFlatMapIdentity">noFlatMapIdentity</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow to use unnecessary callback on flatMap. |
| <code><a href="#projen.javascript.ICorrectness.property.noGlobalObjectCalls">noGlobalObjectCalls</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow calling global object properties as functions. |
| <code><a href="#projen.javascript.ICorrectness.property.noInnerDeclarations">noInnerDeclarations</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow function and var declarations that are accessible outside their block. |
| <code><a href="#projen.javascript.ICorrectness.property.noInvalidBuiltinInstantiation">noInvalidBuiltinInstantiation</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Ensure that builtins are correctly instantiated. |
| <code><a href="#projen.javascript.ICorrectness.property.noInvalidConstructorSuper">noInvalidConstructorSuper</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevents the incorrect use of super() inside classes. |
| <code><a href="#projen.javascript.ICorrectness.property.noInvalidDirectionInLinearGradient">noInvalidDirectionInLinearGradient</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow non-standard direction values for linear gradient functions. |
| <code><a href="#projen.javascript.ICorrectness.property.noInvalidGridAreas">noInvalidGridAreas</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallows invalid named grid areas in CSS Grid Layouts. |
| <code><a href="#projen.javascript.ICorrectness.property.noInvalidNewBuiltin">noInvalidNewBuiltin</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow new operators with global non-constructor functions. |
| <code><a href="#projen.javascript.ICorrectness.property.noInvalidPositionAtImportRule">noInvalidPositionAtImportRule</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of. |
| <code><a href="#projen.javascript.ICorrectness.property.noInvalidUseBeforeDeclaration">noInvalidUseBeforeDeclaration</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of variables and function parameters before their declaration. |
| <code><a href="#projen.javascript.ICorrectness.property.noNewSymbol">noNewSymbol</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow new operators with the Symbol object. |
| <code><a href="#projen.javascript.ICorrectness.property.noNodejsModules">noNodejsModules</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Forbid the use of Node.js builtin modules. |
| <code><a href="#projen.javascript.ICorrectness.property.noNonoctalDecimalEscape">noNonoctalDecimalEscape</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow \8 and \9 escape sequences in string literals. |
| <code><a href="#projen.javascript.ICorrectness.property.noPrecisionLoss">noPrecisionLoss</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow literal numbers that lose precision. |
| <code><a href="#projen.javascript.ICorrectness.property.noRenderReturnValue">noRenderReturnValue</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevent the usage of the return value of React.render. |
| <code><a href="#projen.javascript.ICorrectness.property.noSelfAssign">noSelfAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow assignments where both sides are exactly the same. |
| <code><a href="#projen.javascript.ICorrectness.property.noSetterReturn">noSetterReturn</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow returning a value from a setter. |
| <code><a href="#projen.javascript.ICorrectness.property.noStringCaseMismatch">noStringCaseMismatch</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow comparison of expressions modifying the string case with non-compliant value. |
| <code><a href="#projen.javascript.ICorrectness.property.noSwitchDeclarations">noSwitchDeclarations</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow lexical declarations in switch clauses. |
| <code><a href="#projen.javascript.ICorrectness.property.noUndeclaredDependencies">noUndeclaredDependencies</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of dependencies that aren't specified in the package.json. |
| <code><a href="#projen.javascript.ICorrectness.property.noUndeclaredVariables">noUndeclaredVariables</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevents the usage of variables that haven't been declared inside the document. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnknownFunction">noUnknownFunction</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unknown CSS value functions. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnknownMediaFeatureName">noUnknownMediaFeatureName</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unknown media feature names. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnknownProperty">noUnknownProperty</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unknown properties. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnknownUnit">noUnknownUnit</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unknown CSS units. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnmatchableAnbSelector">noUnmatchableAnbSelector</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unmatchable An+B selectors. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnnecessaryContinue">noUnnecessaryContinue</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Avoid using unnecessary continue. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnreachable">noUnreachable</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unreachable code. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnreachableSuper">noUnreachableSuper</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Ensures the super() constructor is called exactly once on every code  path in a class constructor before this is accessed if the class has a superclass. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnsafeFinally">noUnsafeFinally</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow control flow statements in finally blocks. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnsafeOptionalChaining">noUnsafeOptionalChaining</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of optional chaining in contexts where the undefined value is not allowed. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnusedFunctionParameters">noUnusedFunctionParameters</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unused function parameters. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnusedImports">noUnusedImports</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unused imports. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnusedLabels">noUnusedLabels</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unused labels. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnusedPrivateClassMembers">noUnusedPrivateClassMembers</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unused private class members. |
| <code><a href="#projen.javascript.ICorrectness.property.noUnusedVariables">noUnusedVariables</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unused variables. |
| <code><a href="#projen.javascript.ICorrectness.property.noVoidElementsWithChildren">noVoidElementsWithChildren</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | This rules prevents void elements (AKA self-closing elements) from having children. |
| <code><a href="#projen.javascript.ICorrectness.property.noVoidTypeReturn">noVoidTypeReturn</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow returning a value from a function with the return type 'void'. |
| <code><a href="#projen.javascript.ICorrectness.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |
| <code><a href="#projen.javascript.ICorrectness.property.useArrayLiterals">useArrayLiterals</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow Array constructors. |
| <code><a href="#projen.javascript.ICorrectness.property.useExhaustiveDependencies">useExhaustiveDependencies</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithUseExhaustiveDependenciesOptions">IRuleWithUseExhaustiveDependenciesOptions</a></code> | Enforce all dependencies are correctly specified in a React hook. |
| <code><a href="#projen.javascript.ICorrectness.property.useHookAtTopLevel">useHookAtTopLevel</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithDeprecatedHooksOptions">IRuleWithDeprecatedHooksOptions</a></code> | Enforce that all React hooks are being called from the Top Level component functions. |
| <code><a href="#projen.javascript.ICorrectness.property.useImportExtensions">useImportExtensions</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithUseImportExtensionsOptions">IRuleWithUseImportExtensionsOptions</a></code> | Enforce file extensions for relative imports. |
| <code><a href="#projen.javascript.ICorrectness.property.useIsNan">useIsNan</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Require calls to isNaN() when checking for NaN. |
| <code><a href="#projen.javascript.ICorrectness.property.useJsxKeyInIterable">useJsxKeyInIterable</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow missing key props in iterators/collection literals. |
| <code><a href="#projen.javascript.ICorrectness.property.useValidForDirection">useValidForDirection</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce "for" loop update clause moving the counter in the right direction. |
| <code><a href="#projen.javascript.ICorrectness.property.useYield">useYield</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Require generator functions to contain yield. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.ICorrectness.property.all"></a>
...
##### `noChildrenProp`<sup>Optional</sup> <a name="noChildrenProp" id="projen.javascript.ICorrectness.property.noChildrenProp"></a>
...
##### `noConstantCondition`<sup>Optional</sup> <a name="noConstantCondition" id="projen.javascript.ICorrectness.property.noConstantCondition"></a>
...
##### `noConstantMathMinMaxClamp`<sup>Optional</sup> <a name="noConstantMathMinMaxClamp" id="projen.javascript.ICorrectness.property.noConstantMathMinMaxClamp"></a>
...
##### `noConstAssign`<sup>Optional</sup> <a name="noConstAssign" id="projen.javascript.ICorrectness.property.noConstAssign"></a>
...
##### `noConstructorReturn`<sup>Optional</sup> <a name="noConstructorReturn" id="projen.javascript.ICorrectness.property.noConstructorReturn"></a>
...
##### `noEmptyCharacterClassInRegex`<sup>Optional</sup> <a name="noEmptyCharacterClassInRegex" id="projen.javascript.ICorrectness.property.noEmptyCharacterClassInRegex"></a>
...
##### `noEmptyPattern`<sup>Optional</sup> <a name="noEmptyPattern" id="projen.javascript.ICorrectness.property.noEmptyPattern"></a>
...
##### `noFlatMapIdentity`<sup>Optional</sup> <a name="noFlatMapIdentity" id="projen.javascript.ICorrectness.property.noFlatMapIdentity"></a>
...
##### `noGlobalObjectCalls`<sup>Optional</sup> <a name="noGlobalObjectCalls" id="projen.javascript.ICorrectness.property.noGlobalObjectCalls"></a>
...
##### `noInnerDeclarations`<sup>Optional</sup> <a name="noInnerDeclarations" id="projen.javascript.ICorrectness.property.noInnerDeclarations"></a>
...
##### `noInvalidBuiltinInstantiation`<sup>Optional</sup> <a name="noInvalidBuiltinInstantiation" id="projen.javascript.ICorrectness.property.noInvalidBuiltinInstantiation"></a>
...
##### `noInvalidConstructorSuper`<sup>Optional</sup> <a name="noInvalidConstructorSuper" id="projen.javascript.ICorrectness.property.noInvalidConstructorSuper"></a>
...
##### `noInvalidDirectionInLinearGradient`<sup>Optional</sup> <a name="noInvalidDirectionInLinearGradient" id="projen.javascript.ICorrectness.property.noInvalidDirectionInLinearGradient"></a>
...
##### `noInvalidGridAreas`<sup>Optional</sup> <a name="noInvalidGridAreas" id="projen.javascript.ICorrectness.property.noInvalidGridAreas"></a>
...
##### `noInvalidNewBuiltin`<sup>Optional</sup> <a name="noInvalidNewBuiltin" id="projen.javascript.ICorrectness.property.noInvalidNewBuiltin"></a>
...
##### `noInvalidPositionAtImportRule`<sup>Optional</sup> <a name="noInvalidPositionAtImportRule" id="projen.javascript.ICorrectness.property.noInvalidPositionAtImportRule"></a>
...
##### `noInvalidUseBeforeDeclaration`<sup>Optional</sup> <a name="noInvalidUseBeforeDeclaration" id="projen.javascript.ICorrectness.property.noInvalidUseBeforeDeclaration"></a>
...
##### `noNewSymbol`<sup>Optional</sup> <a name="noNewSymbol" id="projen.javascript.ICorrectness.property.noNewSymbol"></a>
...
##### `noNodejsModules`<sup>Optional</sup> <a name="noNodejsModules" id="projen.javascript.ICorrectness.property.noNodejsModules"></a>
...
##### `noNonoctalDecimalEscape`<sup>Optional</sup> <a name="noNonoctalDecimalEscape" id="projen.javascript.ICorrectness.property.noNonoctalDecimalEscape"></a>
...
##### `noPrecisionLoss`<sup>Optional</sup> <a name="noPrecisionLoss" id="projen.javascript.ICorrectness.property.noPrecisionLoss"></a>
...
##### `noRenderReturnValue`<sup>Optional</sup> <a name="noRenderReturnValue" id="projen.javascript.ICorrectness.property.noRenderReturnValue"></a>
...
##### `noSelfAssign`<sup>Optional</sup> <a name="noSelfAssign" id="projen.javascript.ICorrectness.property.noSelfAssign"></a>
...
##### `noSetterReturn`<sup>Optional</sup> <a name="noSetterReturn" id="projen.javascript.ICorrectness.property.noSetterReturn"></a>
...
##### `noStringCaseMismatch`<sup>Optional</sup> <a name="noStringCaseMismatch" id="projen.javascript.ICorrectness.property.noStringCaseMismatch"></a>
...
##### `noSwitchDeclarations`<sup>Optional</sup> <a name="noSwitchDeclarations" id="projen.javascript.ICorrectness.property.noSwitchDeclarations"></a>
...
##### `noUndeclaredDependencies`<sup>Optional</sup> <a name="noUndeclaredDependencies" id="projen.javascript.ICorrectness.property.noUndeclaredDependencies"></a>
...
##### `noUndeclaredVariables`<sup>Optional</sup> <a name="noUndeclaredVariables" id="projen.javascript.ICorrectness.property.noUndeclaredVariables"></a>
...
##### `noUnknownFunction`<sup>Optional</sup> <a name="noUnknownFunction" id="projen.javascript.ICorrectness.property.noUnknownFunction"></a>
...
##### `noUnknownMediaFeatureName`<sup>Optional</sup> <a name="noUnknownMediaFeatureName" id="projen.javascript.ICorrectness.property.noUnknownMediaFeatureName"></a>
...
##### `noUnknownProperty`<sup>Optional</sup> <a name="noUnknownProperty" id="projen.javascript.ICorrectness.property.noUnknownProperty"></a>
...
##### `noUnknownUnit`<sup>Optional</sup> <a name="noUnknownUnit" id="projen.javascript.ICorrectness.property.noUnknownUnit"></a>
...
##### `noUnmatchableAnbSelector`<sup>Optional</sup> <a name="noUnmatchableAnbSelector" id="projen.javascript.ICorrectness.property.noUnmatchableAnbSelector"></a>
...
##### `noUnnecessaryContinue`<sup>Optional</sup> <a name="noUnnecessaryContinue" id="projen.javascript.ICorrectness.property.noUnnecessaryContinue"></a>
...
##### `noUnreachable`<sup>Optional</sup> <a name="noUnreachable" id="projen.javascript.ICorrectness.property.noUnreachable"></a>
...
##### `noUnreachableSuper`<sup>Optional</sup> <a name="noUnreachableSuper" id="projen.javascript.ICorrectness.property.noUnreachableSuper"></a>
...
##### `noUnsafeFinally`<sup>Optional</sup> <a name="noUnsafeFinally" id="projen.javascript.ICorrectness.property.noUnsafeFinally"></a>
...
##### `noUnsafeOptionalChaining`<sup>Optional</sup> <a name="noUnsafeOptionalChaining" id="projen.javascript.ICorrectness.property.noUnsafeOptionalChaining"></a>
...
##### `noUnusedFunctionParameters`<sup>Optional</sup> <a name="noUnusedFunctionParameters" id="projen.javascript.ICorrectness.property.noUnusedFunctionParameters"></a>
...
##### `noUnusedImports`<sup>Optional</sup> <a name="noUnusedImports" id="projen.javascript.ICorrectness.property.noUnusedImports"></a>
...
##### `noUnusedLabels`<sup>Optional</sup> <a name="noUnusedLabels" id="projen.javascript.ICorrectness.property.noUnusedLabels"></a>
...
##### `noUnusedPrivateClassMembers`<sup>Optional</sup> <a name="noUnusedPrivateClassMembers" id="projen.javascript.ICorrectness.property.noUnusedPrivateClassMembers"></a>
...
##### `noUnusedVariables`<sup>Optional</sup> <a name="noUnusedVariables" id="projen.javascript.ICorrectness.property.noUnusedVariables"></a>
...
##### `noVoidElementsWithChildren`<sup>Optional</sup> <a name="noVoidElementsWithChildren" id="projen.javascript.ICorrectness.property.noVoidElementsWithChildren"></a>
...
##### `noVoidTypeReturn`<sup>Optional</sup> <a name="noVoidTypeReturn" id="projen.javascript.ICorrectness.property.noVoidTypeReturn"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.ICorrectness.property.recommended"></a>
...
##### `useArrayLiterals`<sup>Optional</sup> <a name="useArrayLiterals" id="projen.javascript.ICorrectness.property.useArrayLiterals"></a>
...
##### `useExhaustiveDependencies`<sup>Optional</sup> <a name="useExhaustiveDependencies" id="projen.javascript.ICorrectness.property.useExhaustiveDependencies"></a>

```typescript
public readonly useExhaustiveDependencies: string | IRuleWithUseExhaustiveDependenciesOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithUseExhaustiveDependenciesOptions">IRuleWithUseExhaustiveDependenciesOptions</a>

Enforce all dependencies are correctly specified in a React hook.

---

##### `useHookAtTopLevel`<sup>Optional</sup> <a name="useHookAtTopLevel" id="projen.javascript.ICorrectness.property.useHookAtTopLevel"></a>

```typescript
public readonly useHookAtTopLevel: string | IRuleWithDeprecatedHooksOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithDeprecatedHooksOptions">IRuleWithDeprecatedHooksOptions</a>

Enforce that all React hooks are being called from the Top Level component functions.

---

##### `useImportExtensions`<sup>Optional</sup> <a name="useImportExtensions" id="projen.javascript.ICorrectness.property.useImportExtensions"></a>

```typescript
public readonly useImportExtensions: string | IRuleWithUseImportExtensionsOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithUseImportExtensionsOptions">IRuleWithUseImportExtensionsOptions</a>

Enforce file extensions for relative imports.

---

##### `useIsNan`<sup>Optional</sup> <a name="useIsNan" id="projen.javascript.ICorrectness.property.useIsNan"></a>
...
##### `useJsxKeyInIterable`<sup>Optional</sup> <a name="useJsxKeyInIterable" id="projen.javascript.ICorrectness.property.useJsxKeyInIterable"></a>
...
##### `useValidForDirection`<sup>Optional</sup> <a name="useValidForDirection" id="projen.javascript.ICorrectness.property.useValidForDirection"></a>
...
##### `useYield`<sup>Optional</sup> <a name="useYield" id="projen.javascript.ICorrectness.property.useYield"></a>
...
### ICssAssists <a name="ICssAssists" id="projen.javascript.ICssAssists"></a>

- *Implemented By:* <a href="#projen.javascript.ICssAssists">ICssAssists</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ICssAssists.property.enabled">enabled</a></code> | <code>boolean</code> | Control the assists for CSS files. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.ICssAssists.property.enabled"></a>
...
### ICssConfiguration <a name="ICssConfiguration" id="projen.javascript.ICssConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.ICssConfiguration">ICssConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ICssConfiguration.property.assists">assists</a></code> | <code><a href="#projen.javascript.ICssAssists">ICssAssists</a></code> | CSS assists options. |
| <code><a href="#projen.javascript.ICssConfiguration.property.formatter">formatter</a></code> | <code><a href="#projen.javascript.ICssFormatter">ICssFormatter</a></code> | CSS formatter options. |
| <code><a href="#projen.javascript.ICssConfiguration.property.linter">linter</a></code> | <code><a href="#projen.javascript.ICssLinter">ICssLinter</a></code> | CSS linter options. |
| <code><a href="#projen.javascript.ICssConfiguration.property.parser">parser</a></code> | <code><a href="#projen.javascript.ICssParser">ICssParser</a></code> | CSS parsing options. |

---

##### `assists`<sup>Optional</sup> <a name="assists" id="projen.javascript.ICssConfiguration.property.assists"></a>

```typescript
public readonly assists: ICssAssists;
```

- *Type:* <a href="#projen.javascript.ICssAssists">ICssAssists</a>

CSS assists options.

---

##### `formatter`<sup>Optional</sup> <a name="formatter" id="projen.javascript.ICssConfiguration.property.formatter"></a>

```typescript
public readonly formatter: ICssFormatter;
```

- *Type:* <a href="#projen.javascript.ICssFormatter">ICssFormatter</a>

CSS formatter options.

---

##### `linter`<sup>Optional</sup> <a name="linter" id="projen.javascript.ICssConfiguration.property.linter"></a>

```typescript
public readonly linter: ICssLinter;
```

- *Type:* <a href="#projen.javascript.ICssLinter">ICssLinter</a>

CSS linter options.

---

##### `parser`<sup>Optional</sup> <a name="parser" id="projen.javascript.ICssConfiguration.property.parser"></a>

```typescript
public readonly parser: ICssParser;
```

- *Type:* <a href="#projen.javascript.ICssParser">ICssParser</a>

CSS parsing options.

---

### ICssFormatter <a name="ICssFormatter" id="projen.javascript.ICssFormatter"></a>

- *Implemented By:* <a href="#projen.javascript.ICssFormatter">ICssFormatter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ICssFormatter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the formatter for CSS (and its super languages) files. |
| <code><a href="#projen.javascript.ICssFormatter.property.indentStyle">indentStyle</a></code> | <code>string</code> | The indent style applied to CSS (and its super languages) files. |
| <code><a href="#projen.javascript.ICssFormatter.property.indentWidth">indentWidth</a></code> | <code>number</code> | The size of the indentation applied to CSS (and its super languages) files. |
| <code><a href="#projen.javascript.ICssFormatter.property.lineEnding">lineEnding</a></code> | <code>string</code> | The type of line ending applied to CSS (and its super languages) files. |
| <code><a href="#projen.javascript.ICssFormatter.property.lineWidth">lineWidth</a></code> | <code>number</code> | What's the max width of a line applied to CSS (and its super languages) files. |
| <code><a href="#projen.javascript.ICssFormatter.property.quoteStyle">quoteStyle</a></code> | <code>string</code> | The type of quotes used in CSS code. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.ICssFormatter.property.enabled"></a>
...
##### `indentStyle`<sup>Optional</sup> <a name="indentStyle" id="projen.javascript.ICssFormatter.property.indentStyle"></a>
...
##### `indentWidth`<sup>Optional</sup> <a name="indentWidth" id="projen.javascript.ICssFormatter.property.indentWidth"></a>
...
##### `lineEnding`<sup>Optional</sup> <a name="lineEnding" id="projen.javascript.ICssFormatter.property.lineEnding"></a>
...
##### `lineWidth`<sup>Optional</sup> <a name="lineWidth" id="projen.javascript.ICssFormatter.property.lineWidth"></a>
...
##### `quoteStyle`<sup>Optional</sup> <a name="quoteStyle" id="projen.javascript.ICssFormatter.property.quoteStyle"></a>
...
### ICssLinter <a name="ICssLinter" id="projen.javascript.ICssLinter"></a>

- *Implemented By:* <a href="#projen.javascript.ICssLinter">ICssLinter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ICssLinter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the linter for CSS files. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.ICssLinter.property.enabled"></a>
...
### ICssParser <a name="ICssParser" id="projen.javascript.ICssParser"></a>

- *Implemented By:* <a href="#projen.javascript.ICssParser">ICssParser</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ICssParser.property.allowWrongLineComments">allowWrongLineComments</a></code> | <code>boolean</code> | Allow comments to appear on incorrect lines in `.css` files. |
| <code><a href="#projen.javascript.ICssParser.property.cssModules">cssModules</a></code> | <code>boolean</code> | Enables parsing of CSS Modules specific features. |

---

##### `allowWrongLineComments`<sup>Optional</sup> <a name="allowWrongLineComments" id="projen.javascript.ICssParser.property.allowWrongLineComments"></a>
...
##### `cssModules`<sup>Optional</sup> <a name="cssModules" id="projen.javascript.ICssParser.property.cssModules"></a>
...
### ICustomRestrictedTypeOptions <a name="ICustomRestrictedTypeOptions" id="projen.javascript.ICustomRestrictedTypeOptions"></a>

- *Implemented By:* <a href="#projen.javascript.ICustomRestrictedTypeOptions">ICustomRestrictedTypeOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ICustomRestrictedTypeOptions.property.message">message</a></code> | <code>string</code> | *No description.* |
| <code><a href="#projen.javascript.ICustomRestrictedTypeOptions.property.use">use</a></code> | <code>string</code> | *No description.* |

---

##### `message`<sup>Optional</sup> <a name="message" id="projen.javascript.ICustomRestrictedTypeOptions.property.message"></a>
...
##### `use`<sup>Optional</sup> <a name="use" id="projen.javascript.ICustomRestrictedTypeOptions.property.use"></a>
...
### IDeprecatedHooksOptions <a name="IDeprecatedHooksOptions" id="projen.javascript.IDeprecatedHooksOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IDeprecatedHooksOptions">IDeprecatedHooksOptions</a>

Options for the `useHookAtTopLevel` rule have been deprecated, since we now use the React hook naming convention to determine whether a function is a hook.



### IFilenamingConventionOptions <a name="IFilenamingConventionOptions" id="projen.javascript.IFilenamingConventionOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IFilenamingConventionOptions">IFilenamingConventionOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IFilenamingConventionOptions.property.filenameCases">filenameCases</a></code> | <code>string[]</code> | Allowed cases for file names. |
| <code><a href="#projen.javascript.IFilenamingConventionOptions.property.requireAscii">requireAscii</a></code> | <code>boolean</code> | If `false`, then non-ASCII characters are allowed. |
| <code><a href="#projen.javascript.IFilenamingConventionOptions.property.strictCase">strictCase</a></code> | <code>boolean</code> | If `false`, then consecutive uppercase are allowed in _camel_ and _pascal_ cases. |

---

##### `filenameCases`<sup>Optional</sup> <a name="filenameCases" id="projen.javascript.IFilenamingConventionOptions.property.filenameCases"></a>
...
##### `requireAscii`<sup>Optional</sup> <a name="requireAscii" id="projen.javascript.IFilenamingConventionOptions.property.requireAscii"></a>
...
##### `strictCase`<sup>Optional</sup> <a name="strictCase" id="projen.javascript.IFilenamingConventionOptions.property.strictCase"></a>
...
### IFilesConfiguration <a name="IFilesConfiguration" id="projen.javascript.IFilesConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IFilesConfiguration">IFilesConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IFilesConfiguration.property.ignore">ignore</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IFilesConfiguration.property.ignoreUnknown">ignoreUnknown</a></code> | <code>boolean</code> | Tells Biome to not emit diagnostics when handling files that doesn't know. |
| <code><a href="#projen.javascript.IFilesConfiguration.property.include">include</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IFilesConfiguration.property.maxSize">maxSize</a></code> | <code>number</code> | The maximum allowed size for source code files in bytes. |

---

##### `ignore`<sup>Optional</sup> <a name="ignore" id="projen.javascript.IFilesConfiguration.property.ignore"></a>
...
##### `ignoreUnknown`<sup>Optional</sup> <a name="ignoreUnknown" id="projen.javascript.IFilesConfiguration.property.ignoreUnknown"></a>
...
##### `include`<sup>Optional</sup> <a name="include" id="projen.javascript.IFilesConfiguration.property.include"></a>
...
##### `maxSize`<sup>Optional</sup> <a name="maxSize" id="projen.javascript.IFilesConfiguration.property.maxSize"></a>
...
### IFormatterConfiguration <a name="IFormatterConfiguration" id="projen.javascript.IFormatterConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IFormatterConfiguration">IFormatterConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.attributePosition">attributePosition</a></code> | <code>string</code> | The attribute position style in HTMLish languages. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.bracketSpacing">bracketSpacing</a></code> | <code>boolean</code> | Whether to insert spaces around brackets in object literals. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.enabled">enabled</a></code> | <code>boolean</code> | *No description.* |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.formatWithErrors">formatWithErrors</a></code> | <code>boolean</code> | Stores whether formatting should be allowed to proceed if a given file has syntax errors. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.ignore">ignore</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.include">include</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.indentSize">indentSize</a></code> | <code>number</code> | The size of the indentation, 2 by default (deprecated, use `indent-width`). |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.indentStyle">indentStyle</a></code> | <code>string</code> | The indent style. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.indentWidth">indentWidth</a></code> | <code>number</code> | The size of the indentation, 2 by default. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.lineEnding">lineEnding</a></code> | <code>string</code> | The type of line ending. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.lineWidth">lineWidth</a></code> | <code>number</code> | What's the max width of a line. |
| <code><a href="#projen.javascript.IFormatterConfiguration.property.useEditorconfig">useEditorconfig</a></code> | <code>boolean</code> | Use any `.editorconfig` files to configure the formatter. Configuration in `biome.json` will override `.editorconfig` configuration. Default: false. |

---

##### `attributePosition`<sup>Optional</sup> <a name="attributePosition" id="projen.javascript.IFormatterConfiguration.property.attributePosition"></a>
...
##### `bracketSpacing`<sup>Optional</sup> <a name="bracketSpacing" id="projen.javascript.IFormatterConfiguration.property.bracketSpacing"></a>
...
##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IFormatterConfiguration.property.enabled"></a>
...
##### `formatWithErrors`<sup>Optional</sup> <a name="formatWithErrors" id="projen.javascript.IFormatterConfiguration.property.formatWithErrors"></a>
...
##### `ignore`<sup>Optional</sup> <a name="ignore" id="projen.javascript.IFormatterConfiguration.property.ignore"></a>
...
##### `include`<sup>Optional</sup> <a name="include" id="projen.javascript.IFormatterConfiguration.property.include"></a>
...
##### `indentSize`<sup>Optional</sup> <a name="indentSize" id="projen.javascript.IFormatterConfiguration.property.indentSize"></a>
...
##### `indentStyle`<sup>Optional</sup> <a name="indentStyle" id="projen.javascript.IFormatterConfiguration.property.indentStyle"></a>
...
##### `indentWidth`<sup>Optional</sup> <a name="indentWidth" id="projen.javascript.IFormatterConfiguration.property.indentWidth"></a>
...
##### `lineEnding`<sup>Optional</sup> <a name="lineEnding" id="projen.javascript.IFormatterConfiguration.property.lineEnding"></a>
...
##### `lineWidth`<sup>Optional</sup> <a name="lineWidth" id="projen.javascript.IFormatterConfiguration.property.lineWidth"></a>
...
##### `useEditorconfig`<sup>Optional</sup> <a name="useEditorconfig" id="projen.javascript.IFormatterConfiguration.property.useEditorconfig"></a>
...
### IGraphqlConfiguration <a name="IGraphqlConfiguration" id="projen.javascript.IGraphqlConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IGraphqlConfiguration">IGraphqlConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IGraphqlConfiguration.property.formatter">formatter</a></code> | <code><a href="#projen.javascript.IGraphqlFormatter">IGraphqlFormatter</a></code> | GraphQL formatter options. |
| <code><a href="#projen.javascript.IGraphqlConfiguration.property.linter">linter</a></code> | <code><a href="#projen.javascript.IGraphqlLinter">IGraphqlLinter</a></code> | *No description.* |

---

##### `formatter`<sup>Optional</sup> <a name="formatter" id="projen.javascript.IGraphqlConfiguration.property.formatter"></a>

```typescript
public readonly formatter: IGraphqlFormatter;
```

- *Type:* <a href="#projen.javascript.IGraphqlFormatter">IGraphqlFormatter</a>

GraphQL formatter options.

---

##### `linter`<sup>Optional</sup> <a name="linter" id="projen.javascript.IGraphqlConfiguration.property.linter"></a>

```typescript
public readonly linter: IGraphqlLinter;
```

- *Type:* <a href="#projen.javascript.IGraphqlLinter">IGraphqlLinter</a>

---

### IGraphqlFormatter <a name="IGraphqlFormatter" id="projen.javascript.IGraphqlFormatter"></a>

- *Implemented By:* <a href="#projen.javascript.IGraphqlFormatter">IGraphqlFormatter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IGraphqlFormatter.property.bracketSpacing">bracketSpacing</a></code> | <code>boolean</code> | Whether to insert spaces around brackets in object literals. |
| <code><a href="#projen.javascript.IGraphqlFormatter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the formatter for GraphQL files. |
| <code><a href="#projen.javascript.IGraphqlFormatter.property.indentStyle">indentStyle</a></code> | <code>string</code> | The indent style applied to GraphQL files. |
| <code><a href="#projen.javascript.IGraphqlFormatter.property.indentWidth">indentWidth</a></code> | <code>number</code> | The size of the indentation applied to GraphQL files. |
| <code><a href="#projen.javascript.IGraphqlFormatter.property.lineEnding">lineEnding</a></code> | <code>string</code> | The type of line ending applied to GraphQL files. |
| <code><a href="#projen.javascript.IGraphqlFormatter.property.lineWidth">lineWidth</a></code> | <code>number</code> | What's the max width of a line applied to GraphQL files. |
| <code><a href="#projen.javascript.IGraphqlFormatter.property.quoteStyle">quoteStyle</a></code> | <code>string</code> | The type of quotes used in GraphQL code. |

---

##### `bracketSpacing`<sup>Optional</sup> <a name="bracketSpacing" id="projen.javascript.IGraphqlFormatter.property.bracketSpacing"></a>
...
##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IGraphqlFormatter.property.enabled"></a>
...
##### `indentStyle`<sup>Optional</sup> <a name="indentStyle" id="projen.javascript.IGraphqlFormatter.property.indentStyle"></a>
...
##### `indentWidth`<sup>Optional</sup> <a name="indentWidth" id="projen.javascript.IGraphqlFormatter.property.indentWidth"></a>
...
##### `lineEnding`<sup>Optional</sup> <a name="lineEnding" id="projen.javascript.IGraphqlFormatter.property.lineEnding"></a>
...
##### `lineWidth`<sup>Optional</sup> <a name="lineWidth" id="projen.javascript.IGraphqlFormatter.property.lineWidth"></a>
...
##### `quoteStyle`<sup>Optional</sup> <a name="quoteStyle" id="projen.javascript.IGraphqlFormatter.property.quoteStyle"></a>
...
### IGraphqlLinter <a name="IGraphqlLinter" id="projen.javascript.IGraphqlLinter"></a>

- *Implemented By:* <a href="#projen.javascript.IGraphqlLinter">IGraphqlLinter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IGraphqlLinter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the formatter for GraphQL files. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IGraphqlLinter.property.enabled"></a>
...
### IHook <a name="IHook" id="projen.javascript.IHook"></a>

- *Implemented By:* <a href="#projen.javascript.IHook">IHook</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IHook.property.closureIndex">closureIndex</a></code> | <code>number</code> | The "position" of the closure function, starting from zero. |
| <code><a href="#projen.javascript.IHook.property.dependenciesIndex">dependenciesIndex</a></code> | <code>number</code> | The "position" of the array of dependencies, starting from zero. |
| <code><a href="#projen.javascript.IHook.property.name">name</a></code> | <code>string</code> | The name of the hook. |
| <code><a href="#projen.javascript.IHook.property.stableResult">stableResult</a></code> | <code>boolean \| number[]</code> | Whether the result of the hook is stable. |

---

##### `closureIndex`<sup>Optional</sup> <a name="closureIndex" id="projen.javascript.IHook.property.closureIndex"></a>
...
##### `dependenciesIndex`<sup>Optional</sup> <a name="dependenciesIndex" id="projen.javascript.IHook.property.dependenciesIndex"></a>
...
##### `name`<sup>Optional</sup> <a name="name" id="projen.javascript.IHook.property.name"></a>
...
##### `stableResult`<sup>Optional</sup> <a name="stableResult" id="projen.javascript.IHook.property.stableResult"></a>
...
### IJavascriptAssists <a name="IJavascriptAssists" id="projen.javascript.IJavascriptAssists"></a>

- *Implemented By:* <a href="#projen.javascript.IJavascriptAssists">IJavascriptAssists</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJavascriptAssists.property.enabled">enabled</a></code> | <code>boolean</code> | Control the linter for JavaScript (and its super languages) files. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IJavascriptAssists.property.enabled"></a>
...
### IJavascriptConfiguration <a name="IJavascriptConfiguration" id="projen.javascript.IJavascriptConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IJavascriptConfiguration">IJavascriptConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJavascriptConfiguration.property.assists">assists</a></code> | <code><a href="#projen.javascript.IJavascriptAssists">IJavascriptAssists</a></code> | Assists options. |
| <code><a href="#projen.javascript.IJavascriptConfiguration.property.formatter">formatter</a></code> | <code><a href="#projen.javascript.IJavascriptFormatter">IJavascriptFormatter</a></code> | Formatting options. |
| <code><a href="#projen.javascript.IJavascriptConfiguration.property.globals">globals</a></code> | <code>string[]</code> | A list of global bindings that should be ignored by the analyzers. |
| <code><a href="#projen.javascript.IJavascriptConfiguration.property.jsxRuntime">jsxRuntime</a></code> | <code>string</code> | Indicates the type of runtime or transformation used for interpreting JSX. |
| <code><a href="#projen.javascript.IJavascriptConfiguration.property.linter">linter</a></code> | <code><a href="#projen.javascript.IJavascriptLinter">IJavascriptLinter</a></code> | Linter options. |
| <code><a href="#projen.javascript.IJavascriptConfiguration.property.organizeImports">organizeImports</a></code> | <code><a href="#projen.javascript.IJavascriptOrganizeImports">IJavascriptOrganizeImports</a></code> | *No description.* |
| <code><a href="#projen.javascript.IJavascriptConfiguration.property.parser">parser</a></code> | <code><a href="#projen.javascript.IJavascriptParser">IJavascriptParser</a></code> | Parsing options. |

---

##### `assists`<sup>Optional</sup> <a name="assists" id="projen.javascript.IJavascriptConfiguration.property.assists"></a>

```typescript
public readonly assists: IJavascriptAssists;
```

- *Type:* <a href="#projen.javascript.IJavascriptAssists">IJavascriptAssists</a>

Assists options.

---

##### `formatter`<sup>Optional</sup> <a name="formatter" id="projen.javascript.IJavascriptConfiguration.property.formatter"></a>

```typescript
public readonly formatter: IJavascriptFormatter;
```

- *Type:* <a href="#projen.javascript.IJavascriptFormatter">IJavascriptFormatter</a>

Formatting options.

---

##### `globals`<sup>Optional</sup> <a name="globals" id="projen.javascript.IJavascriptConfiguration.property.globals"></a>
...
##### `jsxRuntime`<sup>Optional</sup> <a name="jsxRuntime" id="projen.javascript.IJavascriptConfiguration.property.jsxRuntime"></a>
...
##### `linter`<sup>Optional</sup> <a name="linter" id="projen.javascript.IJavascriptConfiguration.property.linter"></a>

```typescript
public readonly linter: IJavascriptLinter;
```

- *Type:* <a href="#projen.javascript.IJavascriptLinter">IJavascriptLinter</a>

Linter options.

---

##### `organizeImports`<sup>Optional</sup> <a name="organizeImports" id="projen.javascript.IJavascriptConfiguration.property.organizeImports"></a>

```typescript
public readonly organizeImports: IJavascriptOrganizeImports;
```

- *Type:* <a href="#projen.javascript.IJavascriptOrganizeImports">IJavascriptOrganizeImports</a>

---

##### `parser`<sup>Optional</sup> <a name="parser" id="projen.javascript.IJavascriptConfiguration.property.parser"></a>

```typescript
public readonly parser: IJavascriptParser;
```

- *Type:* <a href="#projen.javascript.IJavascriptParser">IJavascriptParser</a>

Parsing options.

---

### IJavascriptFormatter <a name="IJavascriptFormatter" id="projen.javascript.IJavascriptFormatter"></a>

- *Implemented By:* <a href="#projen.javascript.IJavascriptFormatter">IJavascriptFormatter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.arrowParentheses">arrowParentheses</a></code> | <code>string</code> | Whether to add non-necessary parentheses to arrow functions. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.attributePosition">attributePosition</a></code> | <code>string</code> | The attribute position style in jsx elements. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.bracketSameLine">bracketSameLine</a></code> | <code>boolean</code> | Whether to hug the closing bracket of multiline HTML/JSX tags to the end of the last line, rather than being alone on the following line. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.bracketSpacing">bracketSpacing</a></code> | <code>boolean</code> | Whether to insert spaces around brackets in object literals. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the formatter for JavaScript (and its super languages) files. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.indentSize">indentSize</a></code> | <code>number</code> | The size of the indentation applied to JavaScript (and its super languages) files. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.indentStyle">indentStyle</a></code> | <code>string</code> | The indent style applied to JavaScript (and its super languages) files. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.indentWidth">indentWidth</a></code> | <code>number</code> | The size of the indentation applied to JavaScript (and its super languages) files. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.jsxQuoteStyle">jsxQuoteStyle</a></code> | <code>string</code> | The type of quotes used in JSX. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.lineEnding">lineEnding</a></code> | <code>string</code> | The type of line ending applied to JavaScript (and its super languages) files. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.lineWidth">lineWidth</a></code> | <code>number</code> | What's the max width of a line applied to JavaScript (and its super languages) files. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.quoteProperties">quoteProperties</a></code> | <code>string</code> | When properties in objects are quoted. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.quoteStyle">quoteStyle</a></code> | <code>string</code> | The type of quotes used in JavaScript code. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.semicolons">semicolons</a></code> | <code>string</code> | Whether the formatter prints semicolons for all statements or only in for statements where it is necessary because of ASI. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.trailingComma">trailingComma</a></code> | <code>string</code> | Print trailing commas wherever possible in multi-line comma-separated syntactic structures. |
| <code><a href="#projen.javascript.IJavascriptFormatter.property.trailingCommas">trailingCommas</a></code> | <code>string</code> | Print trailing commas wherever possible in multi-line comma-separated syntactic structures. |

---

##### `arrowParentheses`<sup>Optional</sup> <a name="arrowParentheses" id="projen.javascript.IJavascriptFormatter.property.arrowParentheses"></a>
...
##### `attributePosition`<sup>Optional</sup> <a name="attributePosition" id="projen.javascript.IJavascriptFormatter.property.attributePosition"></a>
...
##### `bracketSameLine`<sup>Optional</sup> <a name="bracketSameLine" id="projen.javascript.IJavascriptFormatter.property.bracketSameLine"></a>
...
##### `bracketSpacing`<sup>Optional</sup> <a name="bracketSpacing" id="projen.javascript.IJavascriptFormatter.property.bracketSpacing"></a>
...
##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IJavascriptFormatter.property.enabled"></a>
...
##### `indentSize`<sup>Optional</sup> <a name="indentSize" id="projen.javascript.IJavascriptFormatter.property.indentSize"></a>
...
##### `indentStyle`<sup>Optional</sup> <a name="indentStyle" id="projen.javascript.IJavascriptFormatter.property.indentStyle"></a>
...
##### `indentWidth`<sup>Optional</sup> <a name="indentWidth" id="projen.javascript.IJavascriptFormatter.property.indentWidth"></a>
...
##### `jsxQuoteStyle`<sup>Optional</sup> <a name="jsxQuoteStyle" id="projen.javascript.IJavascriptFormatter.property.jsxQuoteStyle"></a>
...
##### `lineEnding`<sup>Optional</sup> <a name="lineEnding" id="projen.javascript.IJavascriptFormatter.property.lineEnding"></a>
...
##### `lineWidth`<sup>Optional</sup> <a name="lineWidth" id="projen.javascript.IJavascriptFormatter.property.lineWidth"></a>
...
##### `quoteProperties`<sup>Optional</sup> <a name="quoteProperties" id="projen.javascript.IJavascriptFormatter.property.quoteProperties"></a>
...
##### `quoteStyle`<sup>Optional</sup> <a name="quoteStyle" id="projen.javascript.IJavascriptFormatter.property.quoteStyle"></a>
...
##### `semicolons`<sup>Optional</sup> <a name="semicolons" id="projen.javascript.IJavascriptFormatter.property.semicolons"></a>
...
##### `trailingComma`<sup>Optional</sup> <a name="trailingComma" id="projen.javascript.IJavascriptFormatter.property.trailingComma"></a>
...
##### `trailingCommas`<sup>Optional</sup> <a name="trailingCommas" id="projen.javascript.IJavascriptFormatter.property.trailingCommas"></a>
...
### IJavascriptLinter <a name="IJavascriptLinter" id="projen.javascript.IJavascriptLinter"></a>

- *Implemented By:* <a href="#projen.javascript.IJavascriptLinter">IJavascriptLinter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJavascriptLinter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the linter for JavaScript (and its super languages) files. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IJavascriptLinter.property.enabled"></a>
...
### IJavascriptOrganizeImports <a name="IJavascriptOrganizeImports" id="projen.javascript.IJavascriptOrganizeImports"></a>

- *Implemented By:* <a href="#projen.javascript.IJavascriptOrganizeImports">IJavascriptOrganizeImports</a>



### IJavascriptParser <a name="IJavascriptParser" id="projen.javascript.IJavascriptParser"></a>

- *Implemented By:* <a href="#projen.javascript.IJavascriptParser">IJavascriptParser</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJavascriptParser.property.unsafeParameterDecoratorsEnabled">unsafeParameterDecoratorsEnabled</a></code> | <code>boolean</code> | It enables the experimental and unsafe parsing of parameter decorators. |

---

##### `unsafeParameterDecoratorsEnabled`<sup>Optional</sup> <a name="unsafeParameterDecoratorsEnabled" id="projen.javascript.IJavascriptParser.property.unsafeParameterDecoratorsEnabled"></a>
...
### IJsonAssists <a name="IJsonAssists" id="projen.javascript.IJsonAssists"></a>

- *Implemented By:* <a href="#projen.javascript.IJsonAssists">IJsonAssists</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJsonAssists.property.enabled">enabled</a></code> | <code>boolean</code> | Control the linter for JSON (and its super languages) files. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IJsonAssists.property.enabled"></a>
...
### IJsonConfiguration <a name="IJsonConfiguration" id="projen.javascript.IJsonConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IJsonConfiguration">IJsonConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJsonConfiguration.property.assists">assists</a></code> | <code><a href="#projen.javascript.IJsonAssists">IJsonAssists</a></code> | Assists options. |
| <code><a href="#projen.javascript.IJsonConfiguration.property.formatter">formatter</a></code> | <code><a href="#projen.javascript.IJsonFormatter">IJsonFormatter</a></code> | Formatting options. |
| <code><a href="#projen.javascript.IJsonConfiguration.property.linter">linter</a></code> | <code><a href="#projen.javascript.IJsonLinter">IJsonLinter</a></code> | Linting options. |
| <code><a href="#projen.javascript.IJsonConfiguration.property.parser">parser</a></code> | <code><a href="#projen.javascript.IJsonParser">IJsonParser</a></code> | Parsing options. |

---

##### `assists`<sup>Optional</sup> <a name="assists" id="projen.javascript.IJsonConfiguration.property.assists"></a>

```typescript
public readonly assists: IJsonAssists;
```

- *Type:* <a href="#projen.javascript.IJsonAssists">IJsonAssists</a>

Assists options.

---

##### `formatter`<sup>Optional</sup> <a name="formatter" id="projen.javascript.IJsonConfiguration.property.formatter"></a>

```typescript
public readonly formatter: IJsonFormatter;
```

- *Type:* <a href="#projen.javascript.IJsonFormatter">IJsonFormatter</a>

Formatting options.

---

##### `linter`<sup>Optional</sup> <a name="linter" id="projen.javascript.IJsonConfiguration.property.linter"></a>

```typescript
public readonly linter: IJsonLinter;
```

- *Type:* <a href="#projen.javascript.IJsonLinter">IJsonLinter</a>

Linting options.

---

##### `parser`<sup>Optional</sup> <a name="parser" id="projen.javascript.IJsonConfiguration.property.parser"></a>

```typescript
public readonly parser: IJsonParser;
```

- *Type:* <a href="#projen.javascript.IJsonParser">IJsonParser</a>

Parsing options.

---

### IJsonFormatter <a name="IJsonFormatter" id="projen.javascript.IJsonFormatter"></a>

- *Implemented By:* <a href="#projen.javascript.IJsonFormatter">IJsonFormatter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJsonFormatter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the formatter for JSON (and its super languages) files. |
| <code><a href="#projen.javascript.IJsonFormatter.property.indentSize">indentSize</a></code> | <code>number</code> | The size of the indentation applied to JSON (and its super languages) files. |
| <code><a href="#projen.javascript.IJsonFormatter.property.indentStyle">indentStyle</a></code> | <code>string</code> | The indent style applied to JSON (and its super languages) files. |
| <code><a href="#projen.javascript.IJsonFormatter.property.indentWidth">indentWidth</a></code> | <code>number</code> | The size of the indentation applied to JSON (and its super languages) files. |
| <code><a href="#projen.javascript.IJsonFormatter.property.lineEnding">lineEnding</a></code> | <code>string</code> | The type of line ending applied to JSON (and its super languages) files. |
| <code><a href="#projen.javascript.IJsonFormatter.property.lineWidth">lineWidth</a></code> | <code>number</code> | What's the max width of a line applied to JSON (and its super languages) files. |
| <code><a href="#projen.javascript.IJsonFormatter.property.trailingCommas">trailingCommas</a></code> | <code>string</code> | Print trailing commas wherever possible in multi-line comma-separated syntactic structures. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IJsonFormatter.property.enabled"></a>
...
##### `indentSize`<sup>Optional</sup> <a name="indentSize" id="projen.javascript.IJsonFormatter.property.indentSize"></a>
...
##### `indentStyle`<sup>Optional</sup> <a name="indentStyle" id="projen.javascript.IJsonFormatter.property.indentStyle"></a>
...
##### `indentWidth`<sup>Optional</sup> <a name="indentWidth" id="projen.javascript.IJsonFormatter.property.indentWidth"></a>
...
##### `lineEnding`<sup>Optional</sup> <a name="lineEnding" id="projen.javascript.IJsonFormatter.property.lineEnding"></a>
...
##### `lineWidth`<sup>Optional</sup> <a name="lineWidth" id="projen.javascript.IJsonFormatter.property.lineWidth"></a>
...
##### `trailingCommas`<sup>Optional</sup> <a name="trailingCommas" id="projen.javascript.IJsonFormatter.property.trailingCommas"></a>
...
### IJsonLinter <a name="IJsonLinter" id="projen.javascript.IJsonLinter"></a>

- *Implemented By:* <a href="#projen.javascript.IJsonLinter">IJsonLinter</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJsonLinter.property.enabled">enabled</a></code> | <code>boolean</code> | Control the linter for JSON (and its super languages) files. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IJsonLinter.property.enabled"></a>
...
### IJsonParser <a name="IJsonParser" id="projen.javascript.IJsonParser"></a>

- *Implemented By:* <a href="#projen.javascript.IJsonParser">IJsonParser</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IJsonParser.property.allowComments">allowComments</a></code> | <code>boolean</code> | Allow parsing comments in `.json` files. |
| <code><a href="#projen.javascript.IJsonParser.property.allowTrailingCommas">allowTrailingCommas</a></code> | <code>boolean</code> | Allow parsing trailing commas in `.json` files. |

---

##### `allowComments`<sup>Optional</sup> <a name="allowComments" id="projen.javascript.IJsonParser.property.allowComments"></a>
...
##### `allowTrailingCommas`<sup>Optional</sup> <a name="allowTrailingCommas" id="projen.javascript.IJsonParser.property.allowTrailingCommas"></a>
...
### ILinterConfiguration <a name="ILinterConfiguration" id="projen.javascript.ILinterConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.ILinterConfiguration">ILinterConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ILinterConfiguration.property.enabled">enabled</a></code> | <code>boolean</code> | if `false`, it disables the feature and the linter won't be executed. |
| <code><a href="#projen.javascript.ILinterConfiguration.property.ignore">ignore</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.ILinterConfiguration.property.include">include</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.ILinterConfiguration.property.rules">rules</a></code> | <code><a href="#projen.javascript.IRules">IRules</a></code> | List of rules. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.ILinterConfiguration.property.enabled"></a>
...
##### `ignore`<sup>Optional</sup> <a name="ignore" id="projen.javascript.ILinterConfiguration.property.ignore"></a>
...
##### `include`<sup>Optional</sup> <a name="include" id="projen.javascript.ILinterConfiguration.property.include"></a>
...
##### `rules`<sup>Optional</sup> <a name="rules" id="projen.javascript.ILinterConfiguration.property.rules"></a>

```typescript
public readonly rules: IRules;
```

- *Type:* <a href="#projen.javascript.IRules">IRules</a>

List of rules.

---

### INamingConventionOptions <a name="INamingConventionOptions" id="projen.javascript.INamingConventionOptions"></a>

- *Implemented By:* <a href="#projen.javascript.INamingConventionOptions">INamingConventionOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.INamingConventionOptions.property.conventions">conventions</a></code> | <code><a href="#projen.javascript.IConvention">IConvention</a>[]</code> | Custom conventions. |
| <code><a href="#projen.javascript.INamingConventionOptions.property.enumMemberCase">enumMemberCase</a></code> | <code>string</code> | Allowed cases for _TypeScript_ `enum` member names. |
| <code><a href="#projen.javascript.INamingConventionOptions.property.requireAscii">requireAscii</a></code> | <code>boolean</code> | If `false`, then non-ASCII characters are allowed. |
| <code><a href="#projen.javascript.INamingConventionOptions.property.strictCase">strictCase</a></code> | <code>boolean</code> | If `false`, then consecutive uppercase are allowed in _camel_ and _pascal_ cases. |

---

##### `conventions`<sup>Optional</sup> <a name="conventions" id="projen.javascript.INamingConventionOptions.property.conventions"></a>

```typescript
public readonly conventions: IConvention[];
```

- *Type:* <a href="#projen.javascript.IConvention">IConvention</a>[]

Custom conventions.

---

##### `enumMemberCase`<sup>Optional</sup> <a name="enumMemberCase" id="projen.javascript.INamingConventionOptions.property.enumMemberCase"></a>
...
##### `requireAscii`<sup>Optional</sup> <a name="requireAscii" id="projen.javascript.INamingConventionOptions.property.requireAscii"></a>
...
##### `strictCase`<sup>Optional</sup> <a name="strictCase" id="projen.javascript.INamingConventionOptions.property.strictCase"></a>
...
### INoConsoleOptions <a name="INoConsoleOptions" id="projen.javascript.INoConsoleOptions"></a>

- *Implemented By:* <a href="#projen.javascript.INoConsoleOptions">INoConsoleOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.INoConsoleOptions.property.allow">allow</a></code> | <code>string[]</code> | Allowed calls on the console object. |

---

##### `allow`<sup>Required</sup> <a name="allow" id="projen.javascript.INoConsoleOptions.property.allow"></a>
...
### INoDoubleEqualsOptions <a name="INoDoubleEqualsOptions" id="projen.javascript.INoDoubleEqualsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.INoDoubleEqualsOptions">INoDoubleEqualsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.INoDoubleEqualsOptions.property.ignoreNull">ignoreNull</a></code> | <code>boolean</code> | If `true`, an exception is made when comparing with `null`, as it's often relied on to check both for `null` or `undefined`. |

---

##### `ignoreNull`<sup>Optional</sup> <a name="ignoreNull" id="projen.javascript.INoDoubleEqualsOptions.property.ignoreNull"></a>
...
### INoLabelWithoutControlOptions <a name="INoLabelWithoutControlOptions" id="projen.javascript.INoLabelWithoutControlOptions"></a>

- *Implemented By:* <a href="#projen.javascript.INoLabelWithoutControlOptions">INoLabelWithoutControlOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.INoLabelWithoutControlOptions.property.inputComponents">inputComponents</a></code> | <code>string[]</code> | Array of component names that should be considered the same as an `input` element. |
| <code><a href="#projen.javascript.INoLabelWithoutControlOptions.property.labelAttributes">labelAttributes</a></code> | <code>string[]</code> | Array of attributes that should be treated as the `label` accessible text content. |
| <code><a href="#projen.javascript.INoLabelWithoutControlOptions.property.labelComponents">labelComponents</a></code> | <code>string[]</code> | Array of component names that should be considered the same as a `label` element. |

---

##### `inputComponents`<sup>Optional</sup> <a name="inputComponents" id="projen.javascript.INoLabelWithoutControlOptions.property.inputComponents"></a>
...
##### `labelAttributes`<sup>Optional</sup> <a name="labelAttributes" id="projen.javascript.INoLabelWithoutControlOptions.property.labelAttributes"></a>
...
##### `labelComponents`<sup>Optional</sup> <a name="labelComponents" id="projen.javascript.INoLabelWithoutControlOptions.property.labelComponents"></a>
...
### INoRestrictedTypesOptions <a name="INoRestrictedTypesOptions" id="projen.javascript.INoRestrictedTypesOptions"></a>

- *Implemented By:* <a href="#projen.javascript.INoRestrictedTypesOptions">INoRestrictedTypesOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.INoRestrictedTypesOptions.property.types">types</a></code> | <code>{[ key: string ]: string \| <a href="#projen.javascript.ICustomRestrictedTypeOptions">ICustomRestrictedTypeOptions</a>}</code> | *No description.* |

---

##### `types`<sup>Optional</sup> <a name="types" id="projen.javascript.INoRestrictedTypesOptions.property.types"></a>

```typescript
public readonly types: {[ key: string ]: string | ICustomRestrictedTypeOptions};
```

- *Type:* {[ key: string ]: string | <a href="#projen.javascript.ICustomRestrictedTypeOptions">ICustomRestrictedTypeOptions</a>}

---

### INoSecretsOptions <a name="INoSecretsOptions" id="projen.javascript.INoSecretsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.INoSecretsOptions">INoSecretsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.INoSecretsOptions.property.entropyThreshold">entropyThreshold</a></code> | <code>number</code> | Set entropy threshold (default is 41). |

---

##### `entropyThreshold`<sup>Optional</sup> <a name="entropyThreshold" id="projen.javascript.INoSecretsOptions.property.entropyThreshold"></a>
...
### INursery <a name="INursery" id="projen.javascript.INursery"></a>

- *Implemented By:* <a href="#projen.javascript.INursery">INursery</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.INursery.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.INursery.property.noCommonJs">noCommonJs</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow use of CommonJs module system in favor of ESM style imports. |
| <code><a href="#projen.javascript.INursery.property.noDescendingSpecificity">noDescendingSpecificity</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow a lower specificity selector from coming after a higher specificity selector. |
| <code><a href="#projen.javascript.INursery.property.noDocumentCookie">noDocumentCookie</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow direct assignments to document.cookie. |
| <code><a href="#projen.javascript.INursery.property.noDocumentImportInPage">noDocumentImportInPage</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevents importing next/document outside of pages/_document.jsx in Next.js projects. |
| <code><a href="#projen.javascript.INursery.property.noDuplicateCustomProperties">noDuplicateCustomProperties</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate custom properties within declaration blocks. |
| <code><a href="#projen.javascript.INursery.property.noDuplicatedFields">noDuplicatedFields</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | No duplicated fields in GraphQL operations. |
| <code><a href="#projen.javascript.INursery.property.noDuplicateElseIf">noDuplicateElseIf</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate conditions in if-else-if chains. |
| <code><a href="#projen.javascript.INursery.property.noDuplicateProperties">noDuplicateProperties</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate properties within declaration blocks. |
| <code><a href="#projen.javascript.INursery.property.noDynamicNamespaceImportAccess">noDynamicNamespaceImportAccess</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow accessing namespace imports dynamically. |
| <code><a href="#projen.javascript.INursery.property.noEnum">noEnum</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow TypeScript enum. |
| <code><a href="#projen.javascript.INursery.property.noExportedImports">noExportedImports</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow exporting an imported variable. |
| <code><a href="#projen.javascript.INursery.property.noHeadElement">noHeadElement</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevent usage of \<head> element in a Next.js project. |
| <code><a href="#projen.javascript.INursery.property.noHeadImportInDocument">noHeadImportInDocument</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevent using the next/head module in pages/_document.js on Next.js projects. |
| <code><a href="#projen.javascript.INursery.property.noImgElement">noImgElement</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevent usage of \<img> element in a Next.js project. |
| <code><a href="#projen.javascript.INursery.property.noIrregularWhitespace">noIrregularWhitespace</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallows the use of irregular whitespace characters. |
| <code><a href="#projen.javascript.INursery.property.noMissingVarFunction">noMissingVarFunction</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow missing var function for css variables. |
| <code><a href="#projen.javascript.INursery.property.noNestedTernary">noNestedTernary</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow nested ternary expressions. |
| <code><a href="#projen.javascript.INursery.property.noOctalEscape">noOctalEscape</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow octal escape sequences in string literals. |
| <code><a href="#projen.javascript.INursery.property.noProcessEnv">noProcessEnv</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of process.env. |
| <code><a href="#projen.javascript.INursery.property.noRestrictedImports">noRestrictedImports</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithRestrictedImportsOptions">IRuleWithRestrictedImportsOptions</a></code> | Disallow specified modules when loaded by import or require. |
| <code><a href="#projen.javascript.INursery.property.noRestrictedTypes">noRestrictedTypes</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoRestrictedTypesOptions">IRuleWithNoRestrictedTypesOptions</a></code> | Disallow user defined types. |
| <code><a href="#projen.javascript.INursery.property.noSecrets">noSecrets</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoSecretsOptions">IRuleWithNoSecretsOptions</a></code> | Disallow usage of sensitive data such as API keys and tokens. |
| <code><a href="#projen.javascript.INursery.property.noStaticElementInteractions">noStaticElementInteractions</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that static, visible elements (such as \<div>) that have click handlers use the valid role attribute. |
| <code><a href="#projen.javascript.INursery.property.noSubstr">noSubstr</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the use of String.slice() over String.substr() and String.substring(). |
| <code><a href="#projen.javascript.INursery.property.noTemplateCurlyInString">noTemplateCurlyInString</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow template literal placeholder syntax in regular strings. |
| <code><a href="#projen.javascript.INursery.property.noUnknownPseudoClass">noUnknownPseudoClass</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unknown pseudo-class selectors. |
| <code><a href="#projen.javascript.INursery.property.noUnknownPseudoElement">noUnknownPseudoElement</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unknown pseudo-element selectors. |
| <code><a href="#projen.javascript.INursery.property.noUnknownTypeSelector">noUnknownTypeSelector</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unknown type selectors. |
| <code><a href="#projen.javascript.INursery.property.noUselessEscapeInRegex">noUselessEscapeInRegex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow unnecessary escape sequence in regular expression literals. |
| <code><a href="#projen.javascript.INursery.property.noUselessStringRaw">noUselessStringRaw</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unnecessary String.raw function in template string literals without any escape sequence. |
| <code><a href="#projen.javascript.INursery.property.noValueAtRule">noValueAtRule</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow use of. |
| <code><a href="#projen.javascript.INursery.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |
| <code><a href="#projen.javascript.INursery.property.useAdjacentOverloadSignatures">useAdjacentOverloadSignatures</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of overload signatures that are not next to each other. |
| <code><a href="#projen.javascript.INursery.property.useAriaPropsSupportedByRole">useAriaPropsSupportedByRole</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce that ARIA properties are valid for the roles that are supported by the element. |
| <code><a href="#projen.javascript.INursery.property.useAtIndex">useAtIndex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use at() instead of integer index access. |
| <code><a href="#projen.javascript.INursery.property.useCollapsedIf">useCollapsedIf</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce using single if instead of nested if clauses. |
| <code><a href="#projen.javascript.INursery.property.useComponentExportOnlyModules">useComponentExportOnlyModules</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions">IRuleWithUseComponentExportOnlyModulesOptions</a></code> | Enforce declaring components only within modules that export React Components exclusively. |
| <code><a href="#projen.javascript.INursery.property.useConsistentCurlyBraces">useConsistentCurlyBraces</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | This rule enforces consistent use of curly braces inside JSX attributes and JSX children. |
| <code><a href="#projen.javascript.INursery.property.useConsistentMemberAccessibility">useConsistentMemberAccessibility</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithConsistentMemberAccessibilityOptions">IRuleWithConsistentMemberAccessibilityOptions</a></code> | Require consistent accessibility modifiers on class properties and methods. |
| <code><a href="#projen.javascript.INursery.property.useDeprecatedReason">useDeprecatedReason</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Require specifying the reason argument when using. |
| <code><a href="#projen.javascript.INursery.property.useExplicitType">useExplicitType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Require explicit return types on functions and class methods. |
| <code><a href="#projen.javascript.INursery.property.useGoogleFontDisplay">useGoogleFontDisplay</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforces the use of a recommended display strategy with Google Fonts. |
| <code><a href="#projen.javascript.INursery.property.useGuardForIn">useGuardForIn</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Require for-in loops to include an if statement. |
| <code><a href="#projen.javascript.INursery.property.useImportRestrictions">useImportRestrictions</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallows package private imports. |
| <code><a href="#projen.javascript.INursery.property.useSortedClasses">useSortedClasses</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithUtilityClassSortingOptions">IRuleWithUtilityClassSortingOptions</a></code> | Enforce the sorting of CSS utility classes. |
| <code><a href="#projen.javascript.INursery.property.useStrictMode">useStrictMode</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the use of the directive "use strict" in script files. |
| <code><a href="#projen.javascript.INursery.property.useTrimStartEnd">useTrimStartEnd</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the use of String.trimStart() and String.trimEnd() over String.trimLeft() and String.trimRight(). |
| <code><a href="#projen.javascript.INursery.property.useValidAutocomplete">useValidAutocomplete</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithUseValidAutocompleteOptions">IRuleWithUseValidAutocompleteOptions</a></code> | Use valid values for the autocomplete attribute on input elements. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.INursery.property.all"></a>
...
##### `noCommonJs`<sup>Optional</sup> <a name="noCommonJs" id="projen.javascript.INursery.property.noCommonJs"></a>
...
##### `noDescendingSpecificity`<sup>Optional</sup> <a name="noDescendingSpecificity" id="projen.javascript.INursery.property.noDescendingSpecificity"></a>
...
##### `noDocumentCookie`<sup>Optional</sup> <a name="noDocumentCookie" id="projen.javascript.INursery.property.noDocumentCookie"></a>
...
##### `noDocumentImportInPage`<sup>Optional</sup> <a name="noDocumentImportInPage" id="projen.javascript.INursery.property.noDocumentImportInPage"></a>
...
##### `noDuplicateCustomProperties`<sup>Optional</sup> <a name="noDuplicateCustomProperties" id="projen.javascript.INursery.property.noDuplicateCustomProperties"></a>
...
##### `noDuplicatedFields`<sup>Optional</sup> <a name="noDuplicatedFields" id="projen.javascript.INursery.property.noDuplicatedFields"></a>
...
##### `noDuplicateElseIf`<sup>Optional</sup> <a name="noDuplicateElseIf" id="projen.javascript.INursery.property.noDuplicateElseIf"></a>
...
##### `noDuplicateProperties`<sup>Optional</sup> <a name="noDuplicateProperties" id="projen.javascript.INursery.property.noDuplicateProperties"></a>
...
##### `noDynamicNamespaceImportAccess`<sup>Optional</sup> <a name="noDynamicNamespaceImportAccess" id="projen.javascript.INursery.property.noDynamicNamespaceImportAccess"></a>
...
##### `noEnum`<sup>Optional</sup> <a name="noEnum" id="projen.javascript.INursery.property.noEnum"></a>
...
##### `noExportedImports`<sup>Optional</sup> <a name="noExportedImports" id="projen.javascript.INursery.property.noExportedImports"></a>
...
##### `noHeadElement`<sup>Optional</sup> <a name="noHeadElement" id="projen.javascript.INursery.property.noHeadElement"></a>
...
##### `noHeadImportInDocument`<sup>Optional</sup> <a name="noHeadImportInDocument" id="projen.javascript.INursery.property.noHeadImportInDocument"></a>
...
##### `noImgElement`<sup>Optional</sup> <a name="noImgElement" id="projen.javascript.INursery.property.noImgElement"></a>
...
##### `noIrregularWhitespace`<sup>Optional</sup> <a name="noIrregularWhitespace" id="projen.javascript.INursery.property.noIrregularWhitespace"></a>
...
##### `noMissingVarFunction`<sup>Optional</sup> <a name="noMissingVarFunction" id="projen.javascript.INursery.property.noMissingVarFunction"></a>
...
##### `noNestedTernary`<sup>Optional</sup> <a name="noNestedTernary" id="projen.javascript.INursery.property.noNestedTernary"></a>
...
##### `noOctalEscape`<sup>Optional</sup> <a name="noOctalEscape" id="projen.javascript.INursery.property.noOctalEscape"></a>
...
##### `noProcessEnv`<sup>Optional</sup> <a name="noProcessEnv" id="projen.javascript.INursery.property.noProcessEnv"></a>
...
##### `noRestrictedImports`<sup>Optional</sup> <a name="noRestrictedImports" id="projen.javascript.INursery.property.noRestrictedImports"></a>

```typescript
public readonly noRestrictedImports: string | IRuleWithRestrictedImportsOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithRestrictedImportsOptions">IRuleWithRestrictedImportsOptions</a>

Disallow specified modules when loaded by import or require.

---

##### `noRestrictedTypes`<sup>Optional</sup> <a name="noRestrictedTypes" id="projen.javascript.INursery.property.noRestrictedTypes"></a>

```typescript
public readonly noRestrictedTypes: string | IRuleWithNoRestrictedTypesOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithNoRestrictedTypesOptions">IRuleWithNoRestrictedTypesOptions</a>

Disallow user defined types.

---

##### `noSecrets`<sup>Optional</sup> <a name="noSecrets" id="projen.javascript.INursery.property.noSecrets"></a>

```typescript
public readonly noSecrets: string | IRuleWithNoSecretsOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithNoSecretsOptions">IRuleWithNoSecretsOptions</a>

Disallow usage of sensitive data such as API keys and tokens.

---

##### `noStaticElementInteractions`<sup>Optional</sup> <a name="noStaticElementInteractions" id="projen.javascript.INursery.property.noStaticElementInteractions"></a>
...
##### `noSubstr`<sup>Optional</sup> <a name="noSubstr" id="projen.javascript.INursery.property.noSubstr"></a>
...
##### `noTemplateCurlyInString`<sup>Optional</sup> <a name="noTemplateCurlyInString" id="projen.javascript.INursery.property.noTemplateCurlyInString"></a>
...
##### `noUnknownPseudoClass`<sup>Optional</sup> <a name="noUnknownPseudoClass" id="projen.javascript.INursery.property.noUnknownPseudoClass"></a>
...
##### `noUnknownPseudoElement`<sup>Optional</sup> <a name="noUnknownPseudoElement" id="projen.javascript.INursery.property.noUnknownPseudoElement"></a>
...
##### `noUnknownTypeSelector`<sup>Optional</sup> <a name="noUnknownTypeSelector" id="projen.javascript.INursery.property.noUnknownTypeSelector"></a>
...
##### `noUselessEscapeInRegex`<sup>Optional</sup> <a name="noUselessEscapeInRegex" id="projen.javascript.INursery.property.noUselessEscapeInRegex"></a>
...
##### `noUselessStringRaw`<sup>Optional</sup> <a name="noUselessStringRaw" id="projen.javascript.INursery.property.noUselessStringRaw"></a>
...
##### `noValueAtRule`<sup>Optional</sup> <a name="noValueAtRule" id="projen.javascript.INursery.property.noValueAtRule"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.INursery.property.recommended"></a>
...
##### `useAdjacentOverloadSignatures`<sup>Optional</sup> <a name="useAdjacentOverloadSignatures" id="projen.javascript.INursery.property.useAdjacentOverloadSignatures"></a>
...
##### `useAriaPropsSupportedByRole`<sup>Optional</sup> <a name="useAriaPropsSupportedByRole" id="projen.javascript.INursery.property.useAriaPropsSupportedByRole"></a>
...
##### `useAtIndex`<sup>Optional</sup> <a name="useAtIndex" id="projen.javascript.INursery.property.useAtIndex"></a>
...
##### `useCollapsedIf`<sup>Optional</sup> <a name="useCollapsedIf" id="projen.javascript.INursery.property.useCollapsedIf"></a>
...
##### `useComponentExportOnlyModules`<sup>Optional</sup> <a name="useComponentExportOnlyModules" id="projen.javascript.INursery.property.useComponentExportOnlyModules"></a>

```typescript
public readonly useComponentExportOnlyModules: string | IRuleWithUseComponentExportOnlyModulesOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions">IRuleWithUseComponentExportOnlyModulesOptions</a>

Enforce declaring components only within modules that export React Components exclusively.

---

##### `useConsistentCurlyBraces`<sup>Optional</sup> <a name="useConsistentCurlyBraces" id="projen.javascript.INursery.property.useConsistentCurlyBraces"></a>
...
##### `useConsistentMemberAccessibility`<sup>Optional</sup> <a name="useConsistentMemberAccessibility" id="projen.javascript.INursery.property.useConsistentMemberAccessibility"></a>

```typescript
public readonly useConsistentMemberAccessibility: string | IRuleWithConsistentMemberAccessibilityOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithConsistentMemberAccessibilityOptions">IRuleWithConsistentMemberAccessibilityOptions</a>

Require consistent accessibility modifiers on class properties and methods.

---

##### ~~`useDeprecatedReason`~~<sup>Optional</sup> <a name="useDeprecatedReason" id="projen.javascript.INursery.property.useDeprecatedReason"></a>
...
##### `useExplicitType`<sup>Optional</sup> <a name="useExplicitType" id="projen.javascript.INursery.property.useExplicitType"></a>
...
##### `useGoogleFontDisplay`<sup>Optional</sup> <a name="useGoogleFontDisplay" id="projen.javascript.INursery.property.useGoogleFontDisplay"></a>
...
##### `useGuardForIn`<sup>Optional</sup> <a name="useGuardForIn" id="projen.javascript.INursery.property.useGuardForIn"></a>
...
##### `useImportRestrictions`<sup>Optional</sup> <a name="useImportRestrictions" id="projen.javascript.INursery.property.useImportRestrictions"></a>
...
##### `useSortedClasses`<sup>Optional</sup> <a name="useSortedClasses" id="projen.javascript.INursery.property.useSortedClasses"></a>

```typescript
public readonly useSortedClasses: string | IRuleWithUtilityClassSortingOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithUtilityClassSortingOptions">IRuleWithUtilityClassSortingOptions</a>

Enforce the sorting of CSS utility classes.

---

##### `useStrictMode`<sup>Optional</sup> <a name="useStrictMode" id="projen.javascript.INursery.property.useStrictMode"></a>
...
##### `useTrimStartEnd`<sup>Optional</sup> <a name="useTrimStartEnd" id="projen.javascript.INursery.property.useTrimStartEnd"></a>
...
##### `useValidAutocomplete`<sup>Optional</sup> <a name="useValidAutocomplete" id="projen.javascript.INursery.property.useValidAutocomplete"></a>

```typescript
public readonly useValidAutocomplete: string | IRuleWithUseValidAutocompleteOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithUseValidAutocompleteOptions">IRuleWithUseValidAutocompleteOptions</a>

Use valid values for the autocomplete attribute on input elements.

---

### IOrganizeImports <a name="IOrganizeImports" id="projen.javascript.IOrganizeImports"></a>

- *Implemented By:* <a href="#projen.javascript.IOrganizeImports">IOrganizeImports</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IOrganizeImports.property.enabled">enabled</a></code> | <code>boolean</code> | Enables the organization of imports. |
| <code><a href="#projen.javascript.IOrganizeImports.property.ignore">ignore</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IOrganizeImports.property.include">include</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IOrganizeImports.property.enabled"></a>
...
##### `ignore`<sup>Optional</sup> <a name="ignore" id="projen.javascript.IOrganizeImports.property.ignore"></a>
...
##### `include`<sup>Optional</sup> <a name="include" id="projen.javascript.IOrganizeImports.property.include"></a>
...
### IOverrideFormatterConfiguration <a name="IOverrideFormatterConfiguration" id="projen.javascript.IOverrideFormatterConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IOverrideFormatterConfiguration">IOverrideFormatterConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.attributePosition">attributePosition</a></code> | <code>string</code> | The attribute position style. |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.bracketSpacing">bracketSpacing</a></code> | <code>boolean</code> | Whether to insert spaces around brackets in object literals. |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.enabled">enabled</a></code> | <code>boolean</code> | *No description.* |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.formatWithErrors">formatWithErrors</a></code> | <code>boolean</code> | Stores whether formatting should be allowed to proceed if a given file has syntax errors. |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.indentSize">indentSize</a></code> | <code>number</code> | The size of the indentation, 2 by default (deprecated, use `indent-width`). |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.indentStyle">indentStyle</a></code> | <code>string</code> | The indent style. |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.indentWidth">indentWidth</a></code> | <code>number</code> | The size of the indentation, 2 by default. |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.lineEnding">lineEnding</a></code> | <code>string</code> | The type of line ending. |
| <code><a href="#projen.javascript.IOverrideFormatterConfiguration.property.lineWidth">lineWidth</a></code> | <code>number</code> | What's the max width of a line. |

---

##### `attributePosition`<sup>Optional</sup> <a name="attributePosition" id="projen.javascript.IOverrideFormatterConfiguration.property.attributePosition"></a>
...
##### `bracketSpacing`<sup>Optional</sup> <a name="bracketSpacing" id="projen.javascript.IOverrideFormatterConfiguration.property.bracketSpacing"></a>
...
##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IOverrideFormatterConfiguration.property.enabled"></a>
...
##### `formatWithErrors`<sup>Optional</sup> <a name="formatWithErrors" id="projen.javascript.IOverrideFormatterConfiguration.property.formatWithErrors"></a>
...
##### `indentSize`<sup>Optional</sup> <a name="indentSize" id="projen.javascript.IOverrideFormatterConfiguration.property.indentSize"></a>
...
##### `indentStyle`<sup>Optional</sup> <a name="indentStyle" id="projen.javascript.IOverrideFormatterConfiguration.property.indentStyle"></a>
...
##### `indentWidth`<sup>Optional</sup> <a name="indentWidth" id="projen.javascript.IOverrideFormatterConfiguration.property.indentWidth"></a>
...
##### `lineEnding`<sup>Optional</sup> <a name="lineEnding" id="projen.javascript.IOverrideFormatterConfiguration.property.lineEnding"></a>
...
##### `lineWidth`<sup>Optional</sup> <a name="lineWidth" id="projen.javascript.IOverrideFormatterConfiguration.property.lineWidth"></a>
...
### IOverrideLinterConfiguration <a name="IOverrideLinterConfiguration" id="projen.javascript.IOverrideLinterConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IOverrideLinterConfiguration">IOverrideLinterConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IOverrideLinterConfiguration.property.enabled">enabled</a></code> | <code>boolean</code> | if `false`, it disables the feature and the linter won't be executed. |
| <code><a href="#projen.javascript.IOverrideLinterConfiguration.property.rules">rules</a></code> | <code><a href="#projen.javascript.IRules">IRules</a></code> | List of rules. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IOverrideLinterConfiguration.property.enabled"></a>
...
##### `rules`<sup>Optional</sup> <a name="rules" id="projen.javascript.IOverrideLinterConfiguration.property.rules"></a>
...
### IOverrideOrganizeImportsConfiguration <a name="IOverrideOrganizeImportsConfiguration" id="projen.javascript.IOverrideOrganizeImportsConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IOverrideOrganizeImportsConfiguration">IOverrideOrganizeImportsConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IOverrideOrganizeImportsConfiguration.property.enabled">enabled</a></code> | <code>boolean</code> | if `false`, it disables the feature and the linter won't be executed. |

---

##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IOverrideOrganizeImportsConfiguration.property.enabled"></a>
...
### IOverridePattern <a name="IOverridePattern" id="projen.javascript.IOverridePattern"></a>

- *Implemented By:* <a href="#projen.javascript.IOverridePattern">IOverridePattern</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IOverridePattern.property.css">css</a></code> | <code><a href="#projen.javascript.ICssConfiguration">ICssConfiguration</a></code> | Specific configuration for the Css language. |
| <code><a href="#projen.javascript.IOverridePattern.property.formatter">formatter</a></code> | <code><a href="#projen.javascript.IOverrideFormatterConfiguration">IOverrideFormatterConfiguration</a></code> | Specific configuration for the Json language. |
| <code><a href="#projen.javascript.IOverridePattern.property.graphql">graphql</a></code> | <code><a href="#projen.javascript.IGraphqlConfiguration">IGraphqlConfiguration</a></code> | Specific configuration for the Graphql language. |
| <code><a href="#projen.javascript.IOverridePattern.property.ignore">ignore</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IOverridePattern.property.include">include</a></code> | <code>string[]</code> | A list of Unix shell style patterns. |
| <code><a href="#projen.javascript.IOverridePattern.property.javascript">javascript</a></code> | <code><a href="#projen.javascript.IJavascriptConfiguration">IJavascriptConfiguration</a></code> | Specific configuration for the JavaScript language. |
| <code><a href="#projen.javascript.IOverridePattern.property.json">json</a></code> | <code><a href="#projen.javascript.IJsonConfiguration">IJsonConfiguration</a></code> | Specific configuration for the Json language. |
| <code><a href="#projen.javascript.IOverridePattern.property.linter">linter</a></code> | <code><a href="#projen.javascript.IOverrideLinterConfiguration">IOverrideLinterConfiguration</a></code> | Specific configuration for the Json language. |
| <code><a href="#projen.javascript.IOverridePattern.property.organizeImports">organizeImports</a></code> | <code><a href="#projen.javascript.IOverrideOrganizeImportsConfiguration">IOverrideOrganizeImportsConfiguration</a></code> | Specific configuration for the Json language. |

---

##### `css`<sup>Optional</sup> <a name="css" id="projen.javascript.IOverridePattern.property.css"></a>
...
##### `formatter`<sup>Optional</sup> <a name="formatter" id="projen.javascript.IOverridePattern.property.formatter"></a>

```typescript
public readonly formatter: IOverrideFormatterConfiguration;
```

- *Type:* <a href="#projen.javascript.IOverrideFormatterConfiguration">IOverrideFormatterConfiguration</a>

Specific configuration for the Json language.

---

##### `graphql`<sup>Optional</sup> <a name="graphql" id="projen.javascript.IOverridePattern.property.graphql"></a>
...
##### `ignore`<sup>Optional</sup> <a name="ignore" id="projen.javascript.IOverridePattern.property.ignore"></a>
...
##### `include`<sup>Optional</sup> <a name="include" id="projen.javascript.IOverridePattern.property.include"></a>
...
##### `javascript`<sup>Optional</sup> <a name="javascript" id="projen.javascript.IOverridePattern.property.javascript"></a>
...
##### `json`<sup>Optional</sup> <a name="json" id="projen.javascript.IOverridePattern.property.json"></a>
...
##### `linter`<sup>Optional</sup> <a name="linter" id="projen.javascript.IOverridePattern.property.linter"></a>

```typescript
public readonly linter: IOverrideLinterConfiguration;
```

- *Type:* <a href="#projen.javascript.IOverrideLinterConfiguration">IOverrideLinterConfiguration</a>

Specific configuration for the Json language.

---

##### `organizeImports`<sup>Optional</sup> <a name="organizeImports" id="projen.javascript.IOverridePattern.property.organizeImports"></a>

```typescript
public readonly organizeImports: IOverrideOrganizeImportsConfiguration;
```

- *Type:* <a href="#projen.javascript.IOverrideOrganizeImportsConfiguration">IOverrideOrganizeImportsConfiguration</a>

Specific configuration for the Json language.

---

### IPerformance <a name="IPerformance" id="projen.javascript.IPerformance"></a>

- *Implemented By:* <a href="#projen.javascript.IPerformance">IPerformance</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IPerformance.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.IPerformance.property.noAccumulatingSpread">noAccumulatingSpread</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of spread (...) syntax on accumulators. |
| <code><a href="#projen.javascript.IPerformance.property.noBarrelFile">noBarrelFile</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of barrel file. |
| <code><a href="#projen.javascript.IPerformance.property.noDelete">noDelete</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of the delete operator. |
| <code><a href="#projen.javascript.IPerformance.property.noReExportAll">noReExportAll</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Avoid re-export all. |
| <code><a href="#projen.javascript.IPerformance.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |
| <code><a href="#projen.javascript.IPerformance.property.useTopLevelRegex">useTopLevelRegex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Require regex literals to be declared at the top level. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.IPerformance.property.all"></a>
...
##### `noAccumulatingSpread`<sup>Optional</sup> <a name="noAccumulatingSpread" id="projen.javascript.IPerformance.property.noAccumulatingSpread"></a>
...
##### `noBarrelFile`<sup>Optional</sup> <a name="noBarrelFile" id="projen.javascript.IPerformance.property.noBarrelFile"></a>
...
##### `noDelete`<sup>Optional</sup> <a name="noDelete" id="projen.javascript.IPerformance.property.noDelete"></a>
...
##### `noReExportAll`<sup>Optional</sup> <a name="noReExportAll" id="projen.javascript.IPerformance.property.noReExportAll"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.IPerformance.property.recommended"></a>
...
##### `useTopLevelRegex`<sup>Optional</sup> <a name="useTopLevelRegex" id="projen.javascript.IPerformance.property.useTopLevelRegex"></a>
...
### IRestrictedGlobalsOptions <a name="IRestrictedGlobalsOptions" id="projen.javascript.IRestrictedGlobalsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRestrictedGlobalsOptions">IRestrictedGlobalsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRestrictedGlobalsOptions.property.deniedGlobals">deniedGlobals</a></code> | <code>string[]</code> | A list of names that should trigger the rule. |

---

##### `deniedGlobals`<sup>Optional</sup> <a name="deniedGlobals" id="projen.javascript.IRestrictedGlobalsOptions.property.deniedGlobals"></a>
...
### IRestrictedImportsOptions <a name="IRestrictedImportsOptions" id="projen.javascript.IRestrictedImportsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRestrictedImportsOptions">IRestrictedImportsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRestrictedImportsOptions.property.paths">paths</a></code> | <code>{[ key: string ]: string}</code> | A list of names that should trigger the rule. |

---

##### `paths`<sup>Optional</sup> <a name="paths" id="projen.javascript.IRestrictedImportsOptions.property.paths"></a>
...
### IRules <a name="IRules" id="projen.javascript.IRules"></a>

- *Implemented By:* <a href="#projen.javascript.IRules">IRules</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRules.property.a11y">a11y</a></code> | <code><a href="#projen.javascript.IA11y">IA11y</a></code> | *No description.* |
| <code><a href="#projen.javascript.IRules.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules. |
| <code><a href="#projen.javascript.IRules.property.complexity">complexity</a></code> | <code><a href="#projen.javascript.IComplexity">IComplexity</a></code> | *No description.* |
| <code><a href="#projen.javascript.IRules.property.correctness">correctness</a></code> | <code><a href="#projen.javascript.ICorrectness">ICorrectness</a></code> | *No description.* |
| <code><a href="#projen.javascript.IRules.property.nursery">nursery</a></code> | <code><a href="#projen.javascript.INursery">INursery</a></code> | *No description.* |
| <code><a href="#projen.javascript.IRules.property.performance">performance</a></code> | <code><a href="#projen.javascript.IPerformance">IPerformance</a></code> | *No description.* |
| <code><a href="#projen.javascript.IRules.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the lint rules recommended by Biome. |
| <code><a href="#projen.javascript.IRules.property.security">security</a></code> | <code><a href="#projen.javascript.ISecurity">ISecurity</a></code> | *No description.* |
| <code><a href="#projen.javascript.IRules.property.style">style</a></code> | <code><a href="#projen.javascript.IStyle">IStyle</a></code> | *No description.* |
| <code><a href="#projen.javascript.IRules.property.suspicious">suspicious</a></code> | <code><a href="#projen.javascript.ISuspicious">ISuspicious</a></code> | *No description.* |

---

##### `a11y`<sup>Optional</sup> <a name="a11y" id="projen.javascript.IRules.property.a11y"></a>

```typescript
public readonly a11y: IA11y;
```

- *Type:* <a href="#projen.javascript.IA11y">IA11y</a>

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.IRules.property.all"></a>
...
##### `complexity`<sup>Optional</sup> <a name="complexity" id="projen.javascript.IRules.property.complexity"></a>

```typescript
public readonly complexity: IComplexity;
```

- *Type:* <a href="#projen.javascript.IComplexity">IComplexity</a>

---

##### `correctness`<sup>Optional</sup> <a name="correctness" id="projen.javascript.IRules.property.correctness"></a>

```typescript
public readonly correctness: ICorrectness;
```

- *Type:* <a href="#projen.javascript.ICorrectness">ICorrectness</a>

---

##### `nursery`<sup>Optional</sup> <a name="nursery" id="projen.javascript.IRules.property.nursery"></a>

```typescript
public readonly nursery: INursery;
```

- *Type:* <a href="#projen.javascript.INursery">INursery</a>

---

##### `performance`<sup>Optional</sup> <a name="performance" id="projen.javascript.IRules.property.performance"></a>

```typescript
public readonly performance: IPerformance;
```

- *Type:* <a href="#projen.javascript.IPerformance">IPerformance</a>

---

##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.IRules.property.recommended"></a>
...
##### `security`<sup>Optional</sup> <a name="security" id="projen.javascript.IRules.property.security"></a>

```typescript
public readonly security: ISecurity;
```

- *Type:* <a href="#projen.javascript.ISecurity">ISecurity</a>

---

##### `style`<sup>Optional</sup> <a name="style" id="projen.javascript.IRules.property.style"></a>

```typescript
public readonly style: IStyle;
```

- *Type:* <a href="#projen.javascript.IStyle">IStyle</a>

---

##### `suspicious`<sup>Optional</sup> <a name="suspicious" id="projen.javascript.IRules.property.suspicious"></a>

```typescript
public readonly suspicious: ISuspicious;
```

- *Type:* <a href="#projen.javascript.ISuspicious">ISuspicious</a>

---

### IRuleWithAllowDomainOptions <a name="IRuleWithAllowDomainOptions" id="projen.javascript.IRuleWithAllowDomainOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithAllowDomainOptions">IRuleWithAllowDomainOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithAllowDomainOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithAllowDomainOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithAllowDomainOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IAllowDomainOptions">IAllowDomainOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithAllowDomainOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithAllowDomainOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithAllowDomainOptions.property.options"></a>

```typescript
public readonly options: IAllowDomainOptions;
```

- *Type:* <a href="#projen.javascript.IAllowDomainOptions">IAllowDomainOptions</a>

Rule's options.

---

### IRuleWithComplexityOptions <a name="IRuleWithComplexityOptions" id="projen.javascript.IRuleWithComplexityOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithComplexityOptions">IRuleWithComplexityOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithComplexityOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithComplexityOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IComplexityOptions">IComplexityOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithComplexityOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithComplexityOptions.property.options"></a>

```typescript
public readonly options: IComplexityOptions;
```

- *Type:* <a href="#projen.javascript.IComplexityOptions">IComplexityOptions</a>

Rule's options.

---

### IRuleWithConsistentArrayTypeOptions <a name="IRuleWithConsistentArrayTypeOptions" id="projen.javascript.IRuleWithConsistentArrayTypeOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithConsistentArrayTypeOptions">IRuleWithConsistentArrayTypeOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithConsistentArrayTypeOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithConsistentArrayTypeOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithConsistentArrayTypeOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IConsistentArrayTypeOptions">IConsistentArrayTypeOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithConsistentArrayTypeOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithConsistentArrayTypeOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithConsistentArrayTypeOptions.property.options"></a>

```typescript
public readonly options: IConsistentArrayTypeOptions;
```

- *Type:* <a href="#projen.javascript.IConsistentArrayTypeOptions">IConsistentArrayTypeOptions</a>

Rule's options.

---

### IRuleWithConsistentMemberAccessibilityOptions <a name="IRuleWithConsistentMemberAccessibilityOptions" id="projen.javascript.IRuleWithConsistentMemberAccessibilityOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithConsistentMemberAccessibilityOptions">IRuleWithConsistentMemberAccessibilityOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithConsistentMemberAccessibilityOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithConsistentMemberAccessibilityOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IConsistentMemberAccessibilityOptions">IConsistentMemberAccessibilityOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithConsistentMemberAccessibilityOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithConsistentMemberAccessibilityOptions.property.options"></a>

```typescript
public readonly options: IConsistentMemberAccessibilityOptions;
```

- *Type:* <a href="#projen.javascript.IConsistentMemberAccessibilityOptions">IConsistentMemberAccessibilityOptions</a>

Rule's options.

---

### IRuleWithDeprecatedHooksOptions <a name="IRuleWithDeprecatedHooksOptions" id="projen.javascript.IRuleWithDeprecatedHooksOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithDeprecatedHooksOptions">IRuleWithDeprecatedHooksOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithDeprecatedHooksOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithDeprecatedHooksOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IDeprecatedHooksOptions">IDeprecatedHooksOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithDeprecatedHooksOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithDeprecatedHooksOptions.property.options"></a>

```typescript
public readonly options: IDeprecatedHooksOptions;
```

- *Type:* <a href="#projen.javascript.IDeprecatedHooksOptions">IDeprecatedHooksOptions</a>

Rule's options.

---

### IRuleWithFilenamingConventionOptions <a name="IRuleWithFilenamingConventionOptions" id="projen.javascript.IRuleWithFilenamingConventionOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithFilenamingConventionOptions">IRuleWithFilenamingConventionOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithFilenamingConventionOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithFilenamingConventionOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IFilenamingConventionOptions">IFilenamingConventionOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithFilenamingConventionOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithFilenamingConventionOptions.property.options"></a>

```typescript
public readonly options: IFilenamingConventionOptions;
```

- *Type:* <a href="#projen.javascript.IFilenamingConventionOptions">IFilenamingConventionOptions</a>

Rule's options.

---

### IRuleWithFixNoOptions <a name="IRuleWithFixNoOptions" id="projen.javascript.IRuleWithFixNoOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithFixNoOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithFixNoOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithFixNoOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithFixNoOptions.property.fix"></a>
...
### IRuleWithNamingConventionOptions <a name="IRuleWithNamingConventionOptions" id="projen.javascript.IRuleWithNamingConventionOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithNamingConventionOptions">IRuleWithNamingConventionOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithNamingConventionOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithNamingConventionOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithNamingConventionOptions.property.options">options</a></code> | <code><a href="#projen.javascript.INamingConventionOptions">INamingConventionOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithNamingConventionOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithNamingConventionOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithNamingConventionOptions.property.options"></a>

```typescript
public readonly options: INamingConventionOptions;
```

- *Type:* <a href="#projen.javascript.INamingConventionOptions">INamingConventionOptions</a>

Rule's options.

---

### IRuleWithNoConsoleOptions <a name="IRuleWithNoConsoleOptions" id="projen.javascript.IRuleWithNoConsoleOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithNoConsoleOptions">IRuleWithNoConsoleOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithNoConsoleOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoConsoleOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoConsoleOptions.property.options">options</a></code> | <code><a href="#projen.javascript.INoConsoleOptions">INoConsoleOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithNoConsoleOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithNoConsoleOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithNoConsoleOptions.property.options"></a>

```typescript
public readonly options: INoConsoleOptions;
```

- *Type:* <a href="#projen.javascript.INoConsoleOptions">INoConsoleOptions</a>

Rule's options.

---

### IRuleWithNoDoubleEqualsOptions <a name="IRuleWithNoDoubleEqualsOptions" id="projen.javascript.IRuleWithNoDoubleEqualsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithNoDoubleEqualsOptions">IRuleWithNoDoubleEqualsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithNoDoubleEqualsOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoDoubleEqualsOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoDoubleEqualsOptions.property.options">options</a></code> | <code><a href="#projen.javascript.INoDoubleEqualsOptions">INoDoubleEqualsOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithNoDoubleEqualsOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithNoDoubleEqualsOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithNoDoubleEqualsOptions.property.options"></a>

```typescript
public readonly options: INoDoubleEqualsOptions;
```

- *Type:* <a href="#projen.javascript.INoDoubleEqualsOptions">INoDoubleEqualsOptions</a>

Rule's options.

---

### IRuleWithNoLabelWithoutControlOptions <a name="IRuleWithNoLabelWithoutControlOptions" id="projen.javascript.IRuleWithNoLabelWithoutControlOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithNoLabelWithoutControlOptions">IRuleWithNoLabelWithoutControlOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithNoLabelWithoutControlOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoLabelWithoutControlOptions.property.options">options</a></code> | <code><a href="#projen.javascript.INoLabelWithoutControlOptions">INoLabelWithoutControlOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithNoLabelWithoutControlOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithNoLabelWithoutControlOptions.property.options"></a>

```typescript
public readonly options: INoLabelWithoutControlOptions;
```

- *Type:* <a href="#projen.javascript.INoLabelWithoutControlOptions">INoLabelWithoutControlOptions</a>

Rule's options.

---

### IRuleWithNoOptions <a name="IRuleWithNoOptions" id="projen.javascript.IRuleWithNoOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithNoOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithNoOptions.property.level"></a>
...
### IRuleWithNoRestrictedTypesOptions <a name="IRuleWithNoRestrictedTypesOptions" id="projen.javascript.IRuleWithNoRestrictedTypesOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithNoRestrictedTypesOptions">IRuleWithNoRestrictedTypesOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithNoRestrictedTypesOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoRestrictedTypesOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoRestrictedTypesOptions.property.options">options</a></code> | <code><a href="#projen.javascript.INoRestrictedTypesOptions">INoRestrictedTypesOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithNoRestrictedTypesOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithNoRestrictedTypesOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithNoRestrictedTypesOptions.property.options"></a>

```typescript
public readonly options: INoRestrictedTypesOptions;
```

- *Type:* <a href="#projen.javascript.INoRestrictedTypesOptions">INoRestrictedTypesOptions</a>

Rule's options.

---

### IRuleWithNoSecretsOptions <a name="IRuleWithNoSecretsOptions" id="projen.javascript.IRuleWithNoSecretsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithNoSecretsOptions">IRuleWithNoSecretsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithNoSecretsOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithNoSecretsOptions.property.options">options</a></code> | <code><a href="#projen.javascript.INoSecretsOptions">INoSecretsOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithNoSecretsOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithNoSecretsOptions.property.options"></a>

```typescript
public readonly options: INoSecretsOptions;
```

- *Type:* <a href="#projen.javascript.INoSecretsOptions">INoSecretsOptions</a>

Rule's options.

---

### IRuleWithRestrictedGlobalsOptions <a name="IRuleWithRestrictedGlobalsOptions" id="projen.javascript.IRuleWithRestrictedGlobalsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithRestrictedGlobalsOptions">IRuleWithRestrictedGlobalsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithRestrictedGlobalsOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithRestrictedGlobalsOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IRestrictedGlobalsOptions">IRestrictedGlobalsOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithRestrictedGlobalsOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithRestrictedGlobalsOptions.property.options"></a>

```typescript
public readonly options: IRestrictedGlobalsOptions;
```

- *Type:* <a href="#projen.javascript.IRestrictedGlobalsOptions">IRestrictedGlobalsOptions</a>

Rule's options.

---

### IRuleWithRestrictedImportsOptions <a name="IRuleWithRestrictedImportsOptions" id="projen.javascript.IRuleWithRestrictedImportsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithRestrictedImportsOptions">IRuleWithRestrictedImportsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithRestrictedImportsOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithRestrictedImportsOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IRestrictedImportsOptions">IRestrictedImportsOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithRestrictedImportsOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithRestrictedImportsOptions.property.options"></a>

```typescript
public readonly options: IRestrictedImportsOptions;
```

- *Type:* <a href="#projen.javascript.IRestrictedImportsOptions">IRestrictedImportsOptions</a>

Rule's options.

---

### IRuleWithUseComponentExportOnlyModulesOptions <a name="IRuleWithUseComponentExportOnlyModulesOptions" id="projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions">IRuleWithUseComponentExportOnlyModulesOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IUseComponentExportOnlyModulesOptions">IUseComponentExportOnlyModulesOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithUseComponentExportOnlyModulesOptions.property.options"></a>

```typescript
public readonly options: IUseComponentExportOnlyModulesOptions;
```

- *Type:* <a href="#projen.javascript.IUseComponentExportOnlyModulesOptions">IUseComponentExportOnlyModulesOptions</a>

Rule's options.

---

### IRuleWithUseExhaustiveDependenciesOptions <a name="IRuleWithUseExhaustiveDependenciesOptions" id="projen.javascript.IRuleWithUseExhaustiveDependenciesOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithUseExhaustiveDependenciesOptions">IRuleWithUseExhaustiveDependenciesOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithUseExhaustiveDependenciesOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithUseExhaustiveDependenciesOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IUseExhaustiveDependenciesOptions">IUseExhaustiveDependenciesOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithUseExhaustiveDependenciesOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithUseExhaustiveDependenciesOptions.property.options"></a>

```typescript
public readonly options: IUseExhaustiveDependenciesOptions;
```

- *Type:* <a href="#projen.javascript.IUseExhaustiveDependenciesOptions">IUseExhaustiveDependenciesOptions</a>

Rule's options.

---

### IRuleWithUseImportExtensionsOptions <a name="IRuleWithUseImportExtensionsOptions" id="projen.javascript.IRuleWithUseImportExtensionsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithUseImportExtensionsOptions">IRuleWithUseImportExtensionsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithUseImportExtensionsOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithUseImportExtensionsOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithUseImportExtensionsOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IUseImportExtensionsOptions">IUseImportExtensionsOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithUseImportExtensionsOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithUseImportExtensionsOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithUseImportExtensionsOptions.property.options"></a>

```typescript
public readonly options: IUseImportExtensionsOptions;
```

- *Type:* <a href="#projen.javascript.IUseImportExtensionsOptions">IUseImportExtensionsOptions</a>

Rule's options.

---

### IRuleWithUseValidAutocompleteOptions <a name="IRuleWithUseValidAutocompleteOptions" id="projen.javascript.IRuleWithUseValidAutocompleteOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithUseValidAutocompleteOptions">IRuleWithUseValidAutocompleteOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithUseValidAutocompleteOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithUseValidAutocompleteOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IUseValidAutocompleteOptions">IUseValidAutocompleteOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithUseValidAutocompleteOptions.property.level"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithUseValidAutocompleteOptions.property.options"></a>

```typescript
public readonly options: IUseValidAutocompleteOptions;
```

- *Type:* <a href="#projen.javascript.IUseValidAutocompleteOptions">IUseValidAutocompleteOptions</a>

Rule's options.

---

### IRuleWithUtilityClassSortingOptions <a name="IRuleWithUtilityClassSortingOptions" id="projen.javascript.IRuleWithUtilityClassSortingOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithUtilityClassSortingOptions">IRuleWithUtilityClassSortingOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithUtilityClassSortingOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithUtilityClassSortingOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithUtilityClassSortingOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IUtilityClassSortingOptions">IUtilityClassSortingOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithUtilityClassSortingOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithUtilityClassSortingOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithUtilityClassSortingOptions.property.options"></a>

```typescript
public readonly options: IUtilityClassSortingOptions;
```

- *Type:* <a href="#projen.javascript.IUtilityClassSortingOptions">IUtilityClassSortingOptions</a>

Rule's options.

---

### IRuleWithValidAriaRoleOptions <a name="IRuleWithValidAriaRoleOptions" id="projen.javascript.IRuleWithValidAriaRoleOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IRuleWithValidAriaRoleOptions">IRuleWithValidAriaRoleOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IRuleWithValidAriaRoleOptions.property.level">level</a></code> | <code>string</code> | The severity of the emitted diagnostics by the rule. |
| <code><a href="#projen.javascript.IRuleWithValidAriaRoleOptions.property.fix">fix</a></code> | <code>string</code> | The kind of the code actions emitted by the rule. |
| <code><a href="#projen.javascript.IRuleWithValidAriaRoleOptions.property.options">options</a></code> | <code><a href="#projen.javascript.IValidAriaRoleOptions">IValidAriaRoleOptions</a></code> | Rule's options. |

---

##### `level`<sup>Required</sup> <a name="level" id="projen.javascript.IRuleWithValidAriaRoleOptions.property.level"></a>
...
##### `fix`<sup>Optional</sup> <a name="fix" id="projen.javascript.IRuleWithValidAriaRoleOptions.property.fix"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="projen.javascript.IRuleWithValidAriaRoleOptions.property.options"></a>

```typescript
public readonly options: IValidAriaRoleOptions;
```

- *Type:* <a href="#projen.javascript.IValidAriaRoleOptions">IValidAriaRoleOptions</a>

Rule's options.

---

### ISecurity <a name="ISecurity" id="projen.javascript.ISecurity"></a>

- *Implemented By:* <a href="#projen.javascript.ISecurity">ISecurity</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ISecurity.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.ISecurity.property.noDangerouslySetInnerHtml">noDangerouslySetInnerHtml</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevent the usage of dangerous JSX props. |
| <code><a href="#projen.javascript.ISecurity.property.noDangerouslySetInnerHtmlWithChildren">noDangerouslySetInnerHtmlWithChildren</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Report when a DOM element or a component uses both children and dangerouslySetInnerHTML prop. |
| <code><a href="#projen.javascript.ISecurity.property.noGlobalEval">noGlobalEval</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of global eval(). |
| <code><a href="#projen.javascript.ISecurity.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.ISecurity.property.all"></a>
...
##### `noDangerouslySetInnerHtml`<sup>Optional</sup> <a name="noDangerouslySetInnerHtml" id="projen.javascript.ISecurity.property.noDangerouslySetInnerHtml"></a>
...
##### `noDangerouslySetInnerHtmlWithChildren`<sup>Optional</sup> <a name="noDangerouslySetInnerHtmlWithChildren" id="projen.javascript.ISecurity.property.noDangerouslySetInnerHtmlWithChildren"></a>
...
##### `noGlobalEval`<sup>Optional</sup> <a name="noGlobalEval" id="projen.javascript.ISecurity.property.noGlobalEval"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.ISecurity.property.recommended"></a>
...
### ISelector <a name="ISelector" id="projen.javascript.ISelector"></a>

- *Implemented By:* <a href="#projen.javascript.ISelector">ISelector</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ISelector.property.kind">kind</a></code> | <code>string</code> | Declaration kind. |
| <code><a href="#projen.javascript.ISelector.property.modifiers">modifiers</a></code> | <code>string[]</code> | Modifiers used on the declaration. |
| <code><a href="#projen.javascript.ISelector.property.scope">scope</a></code> | <code>string</code> | Scope of the declaration. |

---

##### `kind`<sup>Optional</sup> <a name="kind" id="projen.javascript.ISelector.property.kind"></a>
...
##### `modifiers`<sup>Optional</sup> <a name="modifiers" id="projen.javascript.ISelector.property.modifiers"></a>
...
##### `scope`<sup>Optional</sup> <a name="scope" id="projen.javascript.ISelector.property.scope"></a>
...
### ISource <a name="ISource" id="projen.javascript.ISource"></a>

- *Implemented By:* <a href="#projen.javascript.ISource">ISource</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ISource.property.sortJsxProps">sortJsxProps</a></code> | <code>string</code> | Enforce props sorting in JSX elements. |
| <code><a href="#projen.javascript.ISource.property.useSortedKeys">useSortedKeys</a></code> | <code>string</code> | Sorts the keys of a JSON object in natural order. |

---

##### `sortJsxProps`<sup>Optional</sup> <a name="sortJsxProps" id="projen.javascript.ISource.property.sortJsxProps"></a>
...
##### `useSortedKeys`<sup>Optional</sup> <a name="useSortedKeys" id="projen.javascript.ISource.property.useSortedKeys"></a>
...
### IStyle <a name="IStyle" id="projen.javascript.IStyle"></a>

- *Implemented By:* <a href="#projen.javascript.IStyle">IStyle</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IStyle.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.IStyle.property.noArguments">noArguments</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of arguments. |
| <code><a href="#projen.javascript.IStyle.property.noCommaOperator">noCommaOperator</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow comma operator. |
| <code><a href="#projen.javascript.IStyle.property.noDefaultExport">noDefaultExport</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow default exports. |
| <code><a href="#projen.javascript.IStyle.property.noDoneCallback">noDoneCallback</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow using a callback in asynchronous tests and hooks. |
| <code><a href="#projen.javascript.IStyle.property.noImplicitBoolean">noImplicitBoolean</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow implicit true values on JSX boolean attributes. |
| <code><a href="#projen.javascript.IStyle.property.noInferrableTypes">noInferrableTypes</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow type annotations for variables, parameters, and class properties initialized with a literal expression. |
| <code><a href="#projen.javascript.IStyle.property.noNamespace">noNamespace</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of TypeScript's namespaces. |
| <code><a href="#projen.javascript.IStyle.property.noNamespaceImport">noNamespaceImport</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of namespace imports. |
| <code><a href="#projen.javascript.IStyle.property.noNegationElse">noNegationElse</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow negation in the condition of an if statement if it has an else clause. |
| <code><a href="#projen.javascript.IStyle.property.noNonNullAssertion">noNonNullAssertion</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow non-null assertions using the ! |
| <code><a href="#projen.javascript.IStyle.property.noParameterAssign">noParameterAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow reassigning function parameters. |
| <code><a href="#projen.javascript.IStyle.property.noParameterProperties">noParameterProperties</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the use of parameter properties in class constructors. |
| <code><a href="#projen.javascript.IStyle.property.noRestrictedGlobals">noRestrictedGlobals</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithRestrictedGlobalsOptions">IRuleWithRestrictedGlobalsOptions</a></code> | This rule allows you to specify global variable names that you don’t want to use in your application. |
| <code><a href="#projen.javascript.IStyle.property.noShoutyConstants">noShoutyConstants</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of constants which its value is the upper-case version of its name. |
| <code><a href="#projen.javascript.IStyle.property.noUnusedTemplateLiteral">noUnusedTemplateLiteral</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow template literals if interpolation and special-character handling are not needed. |
| <code><a href="#projen.javascript.IStyle.property.noUselessElse">noUselessElse</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow else block when the if block breaks early. |
| <code><a href="#projen.javascript.IStyle.property.noVar">noVar</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of var. |
| <code><a href="#projen.javascript.IStyle.property.noYodaExpression">noYodaExpression</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of yoda expressions. |
| <code><a href="#projen.javascript.IStyle.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |
| <code><a href="#projen.javascript.IStyle.property.useAsConstAssertion">useAsConstAssertion</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the use of as const over literal type and type annotation. |
| <code><a href="#projen.javascript.IStyle.property.useBlockStatements">useBlockStatements</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Requires following curly brace conventions. |
| <code><a href="#projen.javascript.IStyle.property.useCollapsedElseIf">useCollapsedElseIf</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce using else if instead of nested if in else clauses. |
| <code><a href="#projen.javascript.IStyle.property.useConsistentArrayType">useConsistentArrayType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithConsistentArrayTypeOptions">IRuleWithConsistentArrayTypeOptions</a></code> | Require consistently using either T\[] or Array\<T>. |
| <code><a href="#projen.javascript.IStyle.property.useConsistentBuiltinInstantiation">useConsistentBuiltinInstantiation</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the use of new for all builtins, except String, Number and Boolean. |
| <code><a href="#projen.javascript.IStyle.property.useConst">useConst</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Require const declarations for variables that are only assigned once. |
| <code><a href="#projen.javascript.IStyle.property.useDefaultParameterLast">useDefaultParameterLast</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce default function parameters and optional function parameters to be last. |
| <code><a href="#projen.javascript.IStyle.property.useDefaultSwitchClause">useDefaultSwitchClause</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Require the default clause in switch statements. |
| <code><a href="#projen.javascript.IStyle.property.useEnumInitializers">useEnumInitializers</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Require that each enum member value be explicitly initialized. |
| <code><a href="#projen.javascript.IStyle.property.useExplicitLengthCheck">useExplicitLengthCheck</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce explicitly comparing the length, size, byteLength or byteOffset property of a value. |
| <code><a href="#projen.javascript.IStyle.property.useExponentiationOperator">useExponentiationOperator</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of Math.pow in favor of the ** operator. |
| <code><a href="#projen.javascript.IStyle.property.useExportType">useExportType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Promotes the use of export type for types. |
| <code><a href="#projen.javascript.IStyle.property.useFilenamingConvention">useFilenamingConvention</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFilenamingConventionOptions">IRuleWithFilenamingConventionOptions</a></code> | Enforce naming conventions for JavaScript and TypeScript filenames. |
| <code><a href="#projen.javascript.IStyle.property.useForOf">useForOf</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | This rule recommends a for-of loop when in a for loop, the index used to extract an item from the iterated array. |
| <code><a href="#projen.javascript.IStyle.property.useFragmentSyntax">useFragmentSyntax</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | This rule enforces the use of \<>...\</> over \<Fragment>...\</Fragment>. |
| <code><a href="#projen.javascript.IStyle.property.useImportType">useImportType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Promotes the use of import type for types. |
| <code><a href="#projen.javascript.IStyle.property.useLiteralEnumMembers">useLiteralEnumMembers</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Require all enum members to be literal values. |
| <code><a href="#projen.javascript.IStyle.property.useNamingConvention">useNamingConvention</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNamingConventionOptions">IRuleWithNamingConventionOptions</a></code> | Enforce naming conventions for everything across a codebase. |
| <code><a href="#projen.javascript.IStyle.property.useNodeAssertStrict">useNodeAssertStrict</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Promotes the usage of node:assert/strict over node:assert. |
| <code><a href="#projen.javascript.IStyle.property.useNodejsImportProtocol">useNodejsImportProtocol</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforces using the node: protocol for Node.js builtin modules. |
| <code><a href="#projen.javascript.IStyle.property.useNumberNamespace">useNumberNamespace</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use the Number properties instead of global ones. |
| <code><a href="#projen.javascript.IStyle.property.useNumericLiterals">useNumericLiterals</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow parseInt() and Number.parseInt() in favor of binary, octal, and hexadecimal literals. |
| <code><a href="#projen.javascript.IStyle.property.useSelfClosingElements">useSelfClosingElements</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prevent extra closing tags for components without children. |
| <code><a href="#projen.javascript.IStyle.property.useShorthandArrayType">useShorthandArrayType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | When expressing array types, this rule promotes the usage of T\[] shorthand instead of Array\<T>. |
| <code><a href="#projen.javascript.IStyle.property.useShorthandAssign">useShorthandAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Require assignment operator shorthand where possible. |
| <code><a href="#projen.javascript.IStyle.property.useShorthandFunctionType">useShorthandFunctionType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce using function types instead of object type with call signatures. |
| <code><a href="#projen.javascript.IStyle.property.useSingleCaseStatement">useSingleCaseStatement</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforces switch clauses have a single statement, emits a quick fix wrapping the statements in a block. |
| <code><a href="#projen.javascript.IStyle.property.useSingleVarDeclarator">useSingleVarDeclarator</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow multiple variable declarations in the same variable statement. |
| <code><a href="#projen.javascript.IStyle.property.useTemplate">useTemplate</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prefer template literals over string concatenation. |
| <code><a href="#projen.javascript.IStyle.property.useThrowNewError">useThrowNewError</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Require new when throwing an error. |
| <code><a href="#projen.javascript.IStyle.property.useThrowOnlyError">useThrowOnlyError</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow throwing non-Error values. |
| <code><a href="#projen.javascript.IStyle.property.useWhile">useWhile</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce the use of while loops instead of for loops when the initializer and update expressions are not needed. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.IStyle.property.all"></a>
...
##### `noArguments`<sup>Optional</sup> <a name="noArguments" id="projen.javascript.IStyle.property.noArguments"></a>
...
##### `noCommaOperator`<sup>Optional</sup> <a name="noCommaOperator" id="projen.javascript.IStyle.property.noCommaOperator"></a>
...
##### `noDefaultExport`<sup>Optional</sup> <a name="noDefaultExport" id="projen.javascript.IStyle.property.noDefaultExport"></a>
...
##### `noDoneCallback`<sup>Optional</sup> <a name="noDoneCallback" id="projen.javascript.IStyle.property.noDoneCallback"></a>
...
##### `noImplicitBoolean`<sup>Optional</sup> <a name="noImplicitBoolean" id="projen.javascript.IStyle.property.noImplicitBoolean"></a>
...
##### `noInferrableTypes`<sup>Optional</sup> <a name="noInferrableTypes" id="projen.javascript.IStyle.property.noInferrableTypes"></a>
...
##### `noNamespace`<sup>Optional</sup> <a name="noNamespace" id="projen.javascript.IStyle.property.noNamespace"></a>
...
##### `noNamespaceImport`<sup>Optional</sup> <a name="noNamespaceImport" id="projen.javascript.IStyle.property.noNamespaceImport"></a>
...
##### `noNegationElse`<sup>Optional</sup> <a name="noNegationElse" id="projen.javascript.IStyle.property.noNegationElse"></a>
...
##### `noNonNullAssertion`<sup>Optional</sup> <a name="noNonNullAssertion" id="projen.javascript.IStyle.property.noNonNullAssertion"></a>
...
##### `noParameterAssign`<sup>Optional</sup> <a name="noParameterAssign" id="projen.javascript.IStyle.property.noParameterAssign"></a>
...
##### `noParameterProperties`<sup>Optional</sup> <a name="noParameterProperties" id="projen.javascript.IStyle.property.noParameterProperties"></a>
...
##### `noRestrictedGlobals`<sup>Optional</sup> <a name="noRestrictedGlobals" id="projen.javascript.IStyle.property.noRestrictedGlobals"></a>

```typescript
public readonly noRestrictedGlobals: string | IRuleWithRestrictedGlobalsOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithRestrictedGlobalsOptions">IRuleWithRestrictedGlobalsOptions</a>

This rule allows you to specify global variable names that you don’t want to use in your application.

---

##### `noShoutyConstants`<sup>Optional</sup> <a name="noShoutyConstants" id="projen.javascript.IStyle.property.noShoutyConstants"></a>
...
##### `noUnusedTemplateLiteral`<sup>Optional</sup> <a name="noUnusedTemplateLiteral" id="projen.javascript.IStyle.property.noUnusedTemplateLiteral"></a>
...
##### `noUselessElse`<sup>Optional</sup> <a name="noUselessElse" id="projen.javascript.IStyle.property.noUselessElse"></a>
...
##### `noVar`<sup>Optional</sup> <a name="noVar" id="projen.javascript.IStyle.property.noVar"></a>
...
##### `noYodaExpression`<sup>Optional</sup> <a name="noYodaExpression" id="projen.javascript.IStyle.property.noYodaExpression"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.IStyle.property.recommended"></a>
...
##### `useAsConstAssertion`<sup>Optional</sup> <a name="useAsConstAssertion" id="projen.javascript.IStyle.property.useAsConstAssertion"></a>
...
##### `useBlockStatements`<sup>Optional</sup> <a name="useBlockStatements" id="projen.javascript.IStyle.property.useBlockStatements"></a>
...
##### `useCollapsedElseIf`<sup>Optional</sup> <a name="useCollapsedElseIf" id="projen.javascript.IStyle.property.useCollapsedElseIf"></a>
...
##### `useConsistentArrayType`<sup>Optional</sup> <a name="useConsistentArrayType" id="projen.javascript.IStyle.property.useConsistentArrayType"></a>

```typescript
public readonly useConsistentArrayType: string | IRuleWithConsistentArrayTypeOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithConsistentArrayTypeOptions">IRuleWithConsistentArrayTypeOptions</a>

Require consistently using either T\[] or Array\<T>.

---

##### `useConsistentBuiltinInstantiation`<sup>Optional</sup> <a name="useConsistentBuiltinInstantiation" id="projen.javascript.IStyle.property.useConsistentBuiltinInstantiation"></a>
...
##### `useConst`<sup>Optional</sup> <a name="useConst" id="projen.javascript.IStyle.property.useConst"></a>
...
##### `useDefaultParameterLast`<sup>Optional</sup> <a name="useDefaultParameterLast" id="projen.javascript.IStyle.property.useDefaultParameterLast"></a>
...
##### `useDefaultSwitchClause`<sup>Optional</sup> <a name="useDefaultSwitchClause" id="projen.javascript.IStyle.property.useDefaultSwitchClause"></a>
...
##### `useEnumInitializers`<sup>Optional</sup> <a name="useEnumInitializers" id="projen.javascript.IStyle.property.useEnumInitializers"></a>
...
##### `useExplicitLengthCheck`<sup>Optional</sup> <a name="useExplicitLengthCheck" id="projen.javascript.IStyle.property.useExplicitLengthCheck"></a>
...
##### `useExponentiationOperator`<sup>Optional</sup> <a name="useExponentiationOperator" id="projen.javascript.IStyle.property.useExponentiationOperator"></a>
...
##### `useExportType`<sup>Optional</sup> <a name="useExportType" id="projen.javascript.IStyle.property.useExportType"></a>
...
##### `useFilenamingConvention`<sup>Optional</sup> <a name="useFilenamingConvention" id="projen.javascript.IStyle.property.useFilenamingConvention"></a>

```typescript
public readonly useFilenamingConvention: string | IRuleWithFilenamingConventionOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithFilenamingConventionOptions">IRuleWithFilenamingConventionOptions</a>

Enforce naming conventions for JavaScript and TypeScript filenames.

---

##### `useForOf`<sup>Optional</sup> <a name="useForOf" id="projen.javascript.IStyle.property.useForOf"></a>
...
##### `useFragmentSyntax`<sup>Optional</sup> <a name="useFragmentSyntax" id="projen.javascript.IStyle.property.useFragmentSyntax"></a>
...
##### `useImportType`<sup>Optional</sup> <a name="useImportType" id="projen.javascript.IStyle.property.useImportType"></a>
...
##### `useLiteralEnumMembers`<sup>Optional</sup> <a name="useLiteralEnumMembers" id="projen.javascript.IStyle.property.useLiteralEnumMembers"></a>
...
##### `useNamingConvention`<sup>Optional</sup> <a name="useNamingConvention" id="projen.javascript.IStyle.property.useNamingConvention"></a>

```typescript
public readonly useNamingConvention: string | IRuleWithNamingConventionOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithNamingConventionOptions">IRuleWithNamingConventionOptions</a>

Enforce naming conventions for everything across a codebase.

---

##### `useNodeAssertStrict`<sup>Optional</sup> <a name="useNodeAssertStrict" id="projen.javascript.IStyle.property.useNodeAssertStrict"></a>
...
##### `useNodejsImportProtocol`<sup>Optional</sup> <a name="useNodejsImportProtocol" id="projen.javascript.IStyle.property.useNodejsImportProtocol"></a>
...
##### `useNumberNamespace`<sup>Optional</sup> <a name="useNumberNamespace" id="projen.javascript.IStyle.property.useNumberNamespace"></a>
...
##### `useNumericLiterals`<sup>Optional</sup> <a name="useNumericLiterals" id="projen.javascript.IStyle.property.useNumericLiterals"></a>
...
##### `useSelfClosingElements`<sup>Optional</sup> <a name="useSelfClosingElements" id="projen.javascript.IStyle.property.useSelfClosingElements"></a>
...
##### `useShorthandArrayType`<sup>Optional</sup> <a name="useShorthandArrayType" id="projen.javascript.IStyle.property.useShorthandArrayType"></a>
...
##### `useShorthandAssign`<sup>Optional</sup> <a name="useShorthandAssign" id="projen.javascript.IStyle.property.useShorthandAssign"></a>
...
##### `useShorthandFunctionType`<sup>Optional</sup> <a name="useShorthandFunctionType" id="projen.javascript.IStyle.property.useShorthandFunctionType"></a>
...
##### `useSingleCaseStatement`<sup>Optional</sup> <a name="useSingleCaseStatement" id="projen.javascript.IStyle.property.useSingleCaseStatement"></a>
...
##### `useSingleVarDeclarator`<sup>Optional</sup> <a name="useSingleVarDeclarator" id="projen.javascript.IStyle.property.useSingleVarDeclarator"></a>
...
##### `useTemplate`<sup>Optional</sup> <a name="useTemplate" id="projen.javascript.IStyle.property.useTemplate"></a>
...
##### `useThrowNewError`<sup>Optional</sup> <a name="useThrowNewError" id="projen.javascript.IStyle.property.useThrowNewError"></a>
...
##### `useThrowOnlyError`<sup>Optional</sup> <a name="useThrowOnlyError" id="projen.javascript.IStyle.property.useThrowOnlyError"></a>
...
##### `useWhile`<sup>Optional</sup> <a name="useWhile" id="projen.javascript.IStyle.property.useWhile"></a>
...
### ISuggestedExtensionMapping <a name="ISuggestedExtensionMapping" id="projen.javascript.ISuggestedExtensionMapping"></a>

- *Implemented By:* <a href="#projen.javascript.ISuggestedExtensionMapping">ISuggestedExtensionMapping</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ISuggestedExtensionMapping.property.component">component</a></code> | <code>string</code> | Extension that should be used for component file imports. |
| <code><a href="#projen.javascript.ISuggestedExtensionMapping.property.module">module</a></code> | <code>string</code> | Extension that should be used for module imports. |

---

##### `component`<sup>Optional</sup> <a name="component" id="projen.javascript.ISuggestedExtensionMapping.property.component"></a>
...
##### `module`<sup>Optional</sup> <a name="module" id="projen.javascript.ISuggestedExtensionMapping.property.module"></a>
...
### ISuspicious <a name="ISuspicious" id="projen.javascript.ISuspicious"></a>

- *Implemented By:* <a href="#projen.javascript.ISuspicious">ISuspicious</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.ISuspicious.property.all">all</a></code> | <code>boolean</code> | It enables ALL rules for this group. |
| <code><a href="#projen.javascript.ISuspicious.property.noApproximativeNumericConstant">noApproximativeNumericConstant</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use standard constants instead of approximated literals. |
| <code><a href="#projen.javascript.ISuspicious.property.noArrayIndexKey">noArrayIndexKey</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Discourage the usage of Array index in keys. |
| <code><a href="#projen.javascript.ISuspicious.property.noAssignInExpressions">noAssignInExpressions</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow assignments in expressions. |
| <code><a href="#projen.javascript.ISuspicious.property.noAsyncPromiseExecutor">noAsyncPromiseExecutor</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallows using an async function as a Promise executor. |
| <code><a href="#projen.javascript.ISuspicious.property.noCatchAssign">noCatchAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow reassigning exceptions in catch clauses. |
| <code><a href="#projen.javascript.ISuspicious.property.noClassAssign">noClassAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow reassigning class members. |
| <code><a href="#projen.javascript.ISuspicious.property.noCommentText">noCommentText</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prevent comments from being inserted as text nodes. |
| <code><a href="#projen.javascript.ISuspicious.property.noCompareNegZero">noCompareNegZero</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow comparing against -0. |
| <code><a href="#projen.javascript.ISuspicious.property.noConfusingLabels">noConfusingLabels</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow labeled statements that are not loops. |
| <code><a href="#projen.javascript.ISuspicious.property.noConfusingVoidType">noConfusingVoidType</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow void type outside of generic or return types. |
| <code><a href="#projen.javascript.ISuspicious.property.noConsole">noConsole</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoConsoleOptions">IRuleWithNoConsoleOptions</a></code> | Disallow the use of console. |
| <code><a href="#projen.javascript.ISuspicious.property.noConsoleLog">noConsoleLog</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of console.log. |
| <code><a href="#projen.javascript.ISuspicious.property.noConstEnum">noConstEnum</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow TypeScript const enum. |
| <code><a href="#projen.javascript.ISuspicious.property.noControlCharactersInRegex">noControlCharactersInRegex</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevents from having control characters and some escape sequences that match control characters in regular expressions. |
| <code><a href="#projen.javascript.ISuspicious.property.noDebugger">noDebugger</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the use of debugger. |
| <code><a href="#projen.javascript.ISuspicious.property.noDoubleEquals">noDoubleEquals</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoDoubleEqualsOptions">IRuleWithNoDoubleEqualsOptions</a></code> | Require the use of === and !==. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateAtImportRules">noDuplicateAtImportRules</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateCase">noDuplicateCase</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate case labels. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateClassMembers">noDuplicateClassMembers</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate class members. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateFontNames">noDuplicateFontNames</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate names within font families. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateJsxProps">noDuplicateJsxProps</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Prevents JSX properties to be assigned multiple times. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateObjectKeys">noDuplicateObjectKeys</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow two keys with the same name inside objects. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateParameters">noDuplicateParameters</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate function parameter name. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateSelectorsKeyframeBlock">noDuplicateSelectorsKeyframeBlock</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow duplicate selectors within keyframe blocks. |
| <code><a href="#projen.javascript.ISuspicious.property.noDuplicateTestHooks">noDuplicateTestHooks</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | A describe block should not contain duplicate hooks. |
| <code><a href="#projen.javascript.ISuspicious.property.noEmptyBlock">noEmptyBlock</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow CSS empty blocks. |
| <code><a href="#projen.javascript.ISuspicious.property.noEmptyBlockStatements">noEmptyBlockStatements</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow empty block statements and static blocks. |
| <code><a href="#projen.javascript.ISuspicious.property.noEmptyInterface">noEmptyInterface</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow the declaration of empty interfaces. |
| <code><a href="#projen.javascript.ISuspicious.property.noEvolvingTypes">noEvolvingTypes</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow variables from evolving into any type through reassignments. |
| <code><a href="#projen.javascript.ISuspicious.property.noExplicitAny">noExplicitAny</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow the any type usage. |
| <code><a href="#projen.javascript.ISuspicious.property.noExportsInTest">noExportsInTest</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow using export or module.exports in files containing tests. |
| <code><a href="#projen.javascript.ISuspicious.property.noExtraNonNullAssertion">noExtraNonNullAssertion</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prevents the wrong usage of the non-null assertion operator (!) in TypeScript files. |
| <code><a href="#projen.javascript.ISuspicious.property.noFallthroughSwitchClause">noFallthroughSwitchClause</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow fallthrough of switch clauses. |
| <code><a href="#projen.javascript.ISuspicious.property.noFocusedTests">noFocusedTests</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow focused tests. |
| <code><a href="#projen.javascript.ISuspicious.property.noFunctionAssign">noFunctionAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow reassigning function declarations. |
| <code><a href="#projen.javascript.ISuspicious.property.noGlobalAssign">noGlobalAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow assignments to native objects and read-only global variables. |
| <code><a href="#projen.javascript.ISuspicious.property.noGlobalIsFinite">noGlobalIsFinite</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use Number.isFinite instead of global isFinite. |
| <code><a href="#projen.javascript.ISuspicious.property.noGlobalIsNan">noGlobalIsNan</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use Number.isNaN instead of global isNaN. |
| <code><a href="#projen.javascript.ISuspicious.property.noImplicitAnyLet">noImplicitAnyLet</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow use of implicit any type on variable declarations. |
| <code><a href="#projen.javascript.ISuspicious.property.noImportantInKeyframe">noImportantInKeyframe</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow invalid !important within keyframe declarations. |
| <code><a href="#projen.javascript.ISuspicious.property.noImportAssign">noImportAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow assigning to imported bindings. |
| <code><a href="#projen.javascript.ISuspicious.property.noLabelVar">noLabelVar</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow labels that share a name with a variable. |
| <code><a href="#projen.javascript.ISuspicious.property.noMisleadingCharacterClass">noMisleadingCharacterClass</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow characters made with multiple code points in character class syntax. |
| <code><a href="#projen.javascript.ISuspicious.property.noMisleadingInstantiator">noMisleadingInstantiator</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce proper usage of new and constructor. |
| <code><a href="#projen.javascript.ISuspicious.property.noMisplacedAssertion">noMisplacedAssertion</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Checks that the assertion function, for example expect, is placed inside an it() function call. |
| <code><a href="#projen.javascript.ISuspicious.property.noMisrefactoredShorthandAssign">noMisrefactoredShorthandAssign</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow shorthand assign when variable appears on both sides. |
| <code><a href="#projen.javascript.ISuspicious.property.noPrototypeBuiltins">noPrototypeBuiltins</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow direct use of Object.prototype builtins. |
| <code><a href="#projen.javascript.ISuspicious.property.noReactSpecificProps">noReactSpecificProps</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prevents React-specific JSX properties from being used. |
| <code><a href="#projen.javascript.ISuspicious.property.noRedeclare">noRedeclare</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow variable, function, class, and type redeclarations in the same scope. |
| <code><a href="#projen.javascript.ISuspicious.property.noRedundantUseStrict">noRedundantUseStrict</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Prevents from having redundant "use strict". |
| <code><a href="#projen.javascript.ISuspicious.property.noSelfCompare">noSelfCompare</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow comparisons where both sides are exactly the same. |
| <code><a href="#projen.javascript.ISuspicious.property.noShadowRestrictedNames">noShadowRestrictedNames</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow identifiers from shadowing restricted names. |
| <code><a href="#projen.javascript.ISuspicious.property.noShorthandPropertyOverrides">noShorthandPropertyOverrides</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow shorthand properties that override related longhand properties. |
| <code><a href="#projen.javascript.ISuspicious.property.noSkippedTests">noSkippedTests</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow disabled tests. |
| <code><a href="#projen.javascript.ISuspicious.property.noSparseArray">noSparseArray</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow sparse arrays. |
| <code><a href="#projen.javascript.ISuspicious.property.noSuspiciousSemicolonInJsx">noSuspiciousSemicolonInJsx</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | It detects possible "wrong" semicolons inside JSX elements. |
| <code><a href="#projen.javascript.ISuspicious.property.noThenProperty">noThenProperty</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow then property. |
| <code><a href="#projen.javascript.ISuspicious.property.noUnsafeDeclarationMerging">noUnsafeDeclarationMerging</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Disallow unsafe declaration merging between interfaces and classes. |
| <code><a href="#projen.javascript.ISuspicious.property.noUnsafeNegation">noUnsafeNegation</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Disallow using unsafe negation. |
| <code><a href="#projen.javascript.ISuspicious.property.recommended">recommended</a></code> | <code>boolean</code> | It enables the recommended rules for this group. |
| <code><a href="#projen.javascript.ISuspicious.property.useAwait">useAwait</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Ensure async functions utilize await. |
| <code><a href="#projen.javascript.ISuspicious.property.useDefaultSwitchClauseLast">useDefaultSwitchClauseLast</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce default clauses in switch statements to be last. |
| <code><a href="#projen.javascript.ISuspicious.property.useErrorMessage">useErrorMessage</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce passing a message value when creating a built-in error. |
| <code><a href="#projen.javascript.ISuspicious.property.useGetterReturn">useGetterReturn</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithNoOptions">IRuleWithNoOptions</a></code> | Enforce get methods to always return a value. |
| <code><a href="#projen.javascript.ISuspicious.property.useIsArray">useIsArray</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Use Array.isArray() instead of instanceof Array. |
| <code><a href="#projen.javascript.ISuspicious.property.useNamespaceKeyword">useNamespaceKeyword</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Require using the namespace keyword over the module keyword to declare TypeScript namespaces. |
| <code><a href="#projen.javascript.ISuspicious.property.useNumberToFixedDigitsArgument">useNumberToFixedDigitsArgument</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | Enforce using the digits argument with Number#toFixed(). |
| <code><a href="#projen.javascript.ISuspicious.property.useValidTypeof">useValidTypeof</a></code> | <code>string \| <a href="#projen.javascript.IRuleWithFixNoOptions">IRuleWithFixNoOptions</a></code> | This rule verifies the result of typeof $expr unary expressions is being compared to valid values, either string literals containing valid type names or other typeof expressions. |

---

##### `all`<sup>Optional</sup> <a name="all" id="projen.javascript.ISuspicious.property.all"></a>
...
##### `noApproximativeNumericConstant`<sup>Optional</sup> <a name="noApproximativeNumericConstant" id="projen.javascript.ISuspicious.property.noApproximativeNumericConstant"></a>
...
##### `noArrayIndexKey`<sup>Optional</sup> <a name="noArrayIndexKey" id="projen.javascript.ISuspicious.property.noArrayIndexKey"></a>
...
##### `noAssignInExpressions`<sup>Optional</sup> <a name="noAssignInExpressions" id="projen.javascript.ISuspicious.property.noAssignInExpressions"></a>
...
##### `noAsyncPromiseExecutor`<sup>Optional</sup> <a name="noAsyncPromiseExecutor" id="projen.javascript.ISuspicious.property.noAsyncPromiseExecutor"></a>
...
##### `noCatchAssign`<sup>Optional</sup> <a name="noCatchAssign" id="projen.javascript.ISuspicious.property.noCatchAssign"></a>
...
##### `noClassAssign`<sup>Optional</sup> <a name="noClassAssign" id="projen.javascript.ISuspicious.property.noClassAssign"></a>
...
##### `noCommentText`<sup>Optional</sup> <a name="noCommentText" id="projen.javascript.ISuspicious.property.noCommentText"></a>
...
##### `noCompareNegZero`<sup>Optional</sup> <a name="noCompareNegZero" id="projen.javascript.ISuspicious.property.noCompareNegZero"></a>
...
##### `noConfusingLabels`<sup>Optional</sup> <a name="noConfusingLabels" id="projen.javascript.ISuspicious.property.noConfusingLabels"></a>
...
##### `noConfusingVoidType`<sup>Optional</sup> <a name="noConfusingVoidType" id="projen.javascript.ISuspicious.property.noConfusingVoidType"></a>
...
##### `noConsole`<sup>Optional</sup> <a name="noConsole" id="projen.javascript.ISuspicious.property.noConsole"></a>

```typescript
public readonly noConsole: string | IRuleWithNoConsoleOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithNoConsoleOptions">IRuleWithNoConsoleOptions</a>

Disallow the use of console.

---

##### `noConsoleLog`<sup>Optional</sup> <a name="noConsoleLog" id="projen.javascript.ISuspicious.property.noConsoleLog"></a>
...
##### `noConstEnum`<sup>Optional</sup> <a name="noConstEnum" id="projen.javascript.ISuspicious.property.noConstEnum"></a>
...
##### `noControlCharactersInRegex`<sup>Optional</sup> <a name="noControlCharactersInRegex" id="projen.javascript.ISuspicious.property.noControlCharactersInRegex"></a>
...
##### `noDebugger`<sup>Optional</sup> <a name="noDebugger" id="projen.javascript.ISuspicious.property.noDebugger"></a>
...
##### `noDoubleEquals`<sup>Optional</sup> <a name="noDoubleEquals" id="projen.javascript.ISuspicious.property.noDoubleEquals"></a>

```typescript
public readonly noDoubleEquals: string | IRuleWithNoDoubleEqualsOptions;
```

- *Type:* string | <a href="#projen.javascript.IRuleWithNoDoubleEqualsOptions">IRuleWithNoDoubleEqualsOptions</a>

Require the use of === and !==.

---

##### `noDuplicateAtImportRules`<sup>Optional</sup> <a name="noDuplicateAtImportRules" id="projen.javascript.ISuspicious.property.noDuplicateAtImportRules"></a>
...
##### `noDuplicateCase`<sup>Optional</sup> <a name="noDuplicateCase" id="projen.javascript.ISuspicious.property.noDuplicateCase"></a>
...
##### `noDuplicateClassMembers`<sup>Optional</sup> <a name="noDuplicateClassMembers" id="projen.javascript.ISuspicious.property.noDuplicateClassMembers"></a>
...
##### `noDuplicateFontNames`<sup>Optional</sup> <a name="noDuplicateFontNames" id="projen.javascript.ISuspicious.property.noDuplicateFontNames"></a>
...
##### `noDuplicateJsxProps`<sup>Optional</sup> <a name="noDuplicateJsxProps" id="projen.javascript.ISuspicious.property.noDuplicateJsxProps"></a>
...
##### `noDuplicateObjectKeys`<sup>Optional</sup> <a name="noDuplicateObjectKeys" id="projen.javascript.ISuspicious.property.noDuplicateObjectKeys"></a>
...
##### `noDuplicateParameters`<sup>Optional</sup> <a name="noDuplicateParameters" id="projen.javascript.ISuspicious.property.noDuplicateParameters"></a>
...
##### `noDuplicateSelectorsKeyframeBlock`<sup>Optional</sup> <a name="noDuplicateSelectorsKeyframeBlock" id="projen.javascript.ISuspicious.property.noDuplicateSelectorsKeyframeBlock"></a>
...
##### `noDuplicateTestHooks`<sup>Optional</sup> <a name="noDuplicateTestHooks" id="projen.javascript.ISuspicious.property.noDuplicateTestHooks"></a>
...
##### `noEmptyBlock`<sup>Optional</sup> <a name="noEmptyBlock" id="projen.javascript.ISuspicious.property.noEmptyBlock"></a>
...
##### `noEmptyBlockStatements`<sup>Optional</sup> <a name="noEmptyBlockStatements" id="projen.javascript.ISuspicious.property.noEmptyBlockStatements"></a>
...
##### `noEmptyInterface`<sup>Optional</sup> <a name="noEmptyInterface" id="projen.javascript.ISuspicious.property.noEmptyInterface"></a>
...
##### `noEvolvingTypes`<sup>Optional</sup> <a name="noEvolvingTypes" id="projen.javascript.ISuspicious.property.noEvolvingTypes"></a>
...
##### `noExplicitAny`<sup>Optional</sup> <a name="noExplicitAny" id="projen.javascript.ISuspicious.property.noExplicitAny"></a>
...
##### `noExportsInTest`<sup>Optional</sup> <a name="noExportsInTest" id="projen.javascript.ISuspicious.property.noExportsInTest"></a>
...
##### `noExtraNonNullAssertion`<sup>Optional</sup> <a name="noExtraNonNullAssertion" id="projen.javascript.ISuspicious.property.noExtraNonNullAssertion"></a>
...
##### `noFallthroughSwitchClause`<sup>Optional</sup> <a name="noFallthroughSwitchClause" id="projen.javascript.ISuspicious.property.noFallthroughSwitchClause"></a>
...
##### `noFocusedTests`<sup>Optional</sup> <a name="noFocusedTests" id="projen.javascript.ISuspicious.property.noFocusedTests"></a>
...
##### `noFunctionAssign`<sup>Optional</sup> <a name="noFunctionAssign" id="projen.javascript.ISuspicious.property.noFunctionAssign"></a>
...
##### `noGlobalAssign`<sup>Optional</sup> <a name="noGlobalAssign" id="projen.javascript.ISuspicious.property.noGlobalAssign"></a>
...
##### `noGlobalIsFinite`<sup>Optional</sup> <a name="noGlobalIsFinite" id="projen.javascript.ISuspicious.property.noGlobalIsFinite"></a>
...
##### `noGlobalIsNan`<sup>Optional</sup> <a name="noGlobalIsNan" id="projen.javascript.ISuspicious.property.noGlobalIsNan"></a>
...
##### `noImplicitAnyLet`<sup>Optional</sup> <a name="noImplicitAnyLet" id="projen.javascript.ISuspicious.property.noImplicitAnyLet"></a>
...
##### `noImportantInKeyframe`<sup>Optional</sup> <a name="noImportantInKeyframe" id="projen.javascript.ISuspicious.property.noImportantInKeyframe"></a>
...
##### `noImportAssign`<sup>Optional</sup> <a name="noImportAssign" id="projen.javascript.ISuspicious.property.noImportAssign"></a>
...
##### `noLabelVar`<sup>Optional</sup> <a name="noLabelVar" id="projen.javascript.ISuspicious.property.noLabelVar"></a>
...
##### `noMisleadingCharacterClass`<sup>Optional</sup> <a name="noMisleadingCharacterClass" id="projen.javascript.ISuspicious.property.noMisleadingCharacterClass"></a>
...
##### `noMisleadingInstantiator`<sup>Optional</sup> <a name="noMisleadingInstantiator" id="projen.javascript.ISuspicious.property.noMisleadingInstantiator"></a>
...
##### `noMisplacedAssertion`<sup>Optional</sup> <a name="noMisplacedAssertion" id="projen.javascript.ISuspicious.property.noMisplacedAssertion"></a>
...
##### `noMisrefactoredShorthandAssign`<sup>Optional</sup> <a name="noMisrefactoredShorthandAssign" id="projen.javascript.ISuspicious.property.noMisrefactoredShorthandAssign"></a>
...
##### `noPrototypeBuiltins`<sup>Optional</sup> <a name="noPrototypeBuiltins" id="projen.javascript.ISuspicious.property.noPrototypeBuiltins"></a>
...
##### `noReactSpecificProps`<sup>Optional</sup> <a name="noReactSpecificProps" id="projen.javascript.ISuspicious.property.noReactSpecificProps"></a>
...
##### `noRedeclare`<sup>Optional</sup> <a name="noRedeclare" id="projen.javascript.ISuspicious.property.noRedeclare"></a>
...
##### `noRedundantUseStrict`<sup>Optional</sup> <a name="noRedundantUseStrict" id="projen.javascript.ISuspicious.property.noRedundantUseStrict"></a>
...
##### `noSelfCompare`<sup>Optional</sup> <a name="noSelfCompare" id="projen.javascript.ISuspicious.property.noSelfCompare"></a>
...
##### `noShadowRestrictedNames`<sup>Optional</sup> <a name="noShadowRestrictedNames" id="projen.javascript.ISuspicious.property.noShadowRestrictedNames"></a>
...
##### `noShorthandPropertyOverrides`<sup>Optional</sup> <a name="noShorthandPropertyOverrides" id="projen.javascript.ISuspicious.property.noShorthandPropertyOverrides"></a>
...
##### `noSkippedTests`<sup>Optional</sup> <a name="noSkippedTests" id="projen.javascript.ISuspicious.property.noSkippedTests"></a>
...
##### `noSparseArray`<sup>Optional</sup> <a name="noSparseArray" id="projen.javascript.ISuspicious.property.noSparseArray"></a>
...
##### `noSuspiciousSemicolonInJsx`<sup>Optional</sup> <a name="noSuspiciousSemicolonInJsx" id="projen.javascript.ISuspicious.property.noSuspiciousSemicolonInJsx"></a>
...
##### `noThenProperty`<sup>Optional</sup> <a name="noThenProperty" id="projen.javascript.ISuspicious.property.noThenProperty"></a>
...
##### `noUnsafeDeclarationMerging`<sup>Optional</sup> <a name="noUnsafeDeclarationMerging" id="projen.javascript.ISuspicious.property.noUnsafeDeclarationMerging"></a>
...
##### `noUnsafeNegation`<sup>Optional</sup> <a name="noUnsafeNegation" id="projen.javascript.ISuspicious.property.noUnsafeNegation"></a>
...
##### `recommended`<sup>Optional</sup> <a name="recommended" id="projen.javascript.ISuspicious.property.recommended"></a>
...
##### `useAwait`<sup>Optional</sup> <a name="useAwait" id="projen.javascript.ISuspicious.property.useAwait"></a>
...
##### `useDefaultSwitchClauseLast`<sup>Optional</sup> <a name="useDefaultSwitchClauseLast" id="projen.javascript.ISuspicious.property.useDefaultSwitchClauseLast"></a>
...
##### `useErrorMessage`<sup>Optional</sup> <a name="useErrorMessage" id="projen.javascript.ISuspicious.property.useErrorMessage"></a>
...
##### `useGetterReturn`<sup>Optional</sup> <a name="useGetterReturn" id="projen.javascript.ISuspicious.property.useGetterReturn"></a>
...
##### `useIsArray`<sup>Optional</sup> <a name="useIsArray" id="projen.javascript.ISuspicious.property.useIsArray"></a>
...
##### `useNamespaceKeyword`<sup>Optional</sup> <a name="useNamespaceKeyword" id="projen.javascript.ISuspicious.property.useNamespaceKeyword"></a>
...
##### `useNumberToFixedDigitsArgument`<sup>Optional</sup> <a name="useNumberToFixedDigitsArgument" id="projen.javascript.ISuspicious.property.useNumberToFixedDigitsArgument"></a>
...
##### `useValidTypeof`<sup>Optional</sup> <a name="useValidTypeof" id="projen.javascript.ISuspicious.property.useValidTypeof"></a>
...
### IUseComponentExportOnlyModulesOptions <a name="IUseComponentExportOnlyModulesOptions" id="projen.javascript.IUseComponentExportOnlyModulesOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IUseComponentExportOnlyModulesOptions">IUseComponentExportOnlyModulesOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IUseComponentExportOnlyModulesOptions.property.allowConstantExport">allowConstantExport</a></code> | <code>boolean</code> | Allows the export of constants. |
| <code><a href="#projen.javascript.IUseComponentExportOnlyModulesOptions.property.allowExportNames">allowExportNames</a></code> | <code>string[]</code> | A list of names that can be additionally exported from the module This option is for exports that do not hinder [React Fast Refresh](https://github.com/facebook/react/tree/main/packages/react-refresh), such as [`meta` in Remix](https://remix.run/docs/en/main/route/meta). |

---

##### `allowConstantExport`<sup>Optional</sup> <a name="allowConstantExport" id="projen.javascript.IUseComponentExportOnlyModulesOptions.property.allowConstantExport"></a>
...
##### `allowExportNames`<sup>Optional</sup> <a name="allowExportNames" id="projen.javascript.IUseComponentExportOnlyModulesOptions.property.allowExportNames"></a>
...
### IUseExhaustiveDependenciesOptions <a name="IUseExhaustiveDependenciesOptions" id="projen.javascript.IUseExhaustiveDependenciesOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IUseExhaustiveDependenciesOptions">IUseExhaustiveDependenciesOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IUseExhaustiveDependenciesOptions.property.hooks">hooks</a></code> | <code><a href="#projen.javascript.IHook">IHook</a>[]</code> | List of hooks of which the dependencies should be validated. |
| <code><a href="#projen.javascript.IUseExhaustiveDependenciesOptions.property.reportMissingDependenciesArray">reportMissingDependenciesArray</a></code> | <code>boolean</code> | Whether to report an error when a hook has no dependencies array. |
| <code><a href="#projen.javascript.IUseExhaustiveDependenciesOptions.property.reportUnnecessaryDependencies">reportUnnecessaryDependencies</a></code> | <code>boolean</code> | Whether to report an error when a dependency is listed in the dependencies array but isn't used. |

---

##### `hooks`<sup>Optional</sup> <a name="hooks" id="projen.javascript.IUseExhaustiveDependenciesOptions.property.hooks"></a>

```typescript
public readonly hooks: IHook[];
```

- *Type:* <a href="#projen.javascript.IHook">IHook</a>[]

List of hooks of which the dependencies should be validated.

---

##### `reportMissingDependenciesArray`<sup>Optional</sup> <a name="reportMissingDependenciesArray" id="projen.javascript.IUseExhaustiveDependenciesOptions.property.reportMissingDependenciesArray"></a>
...
##### `reportUnnecessaryDependencies`<sup>Optional</sup> <a name="reportUnnecessaryDependencies" id="projen.javascript.IUseExhaustiveDependenciesOptions.property.reportUnnecessaryDependencies"></a>
...
### IUseImportExtensionsOptions <a name="IUseImportExtensionsOptions" id="projen.javascript.IUseImportExtensionsOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IUseImportExtensionsOptions">IUseImportExtensionsOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IUseImportExtensionsOptions.property.suggestedExtensions">suggestedExtensions</a></code> | <code>{[ key: string ]: <a href="#projen.javascript.ISuggestedExtensionMapping">ISuggestedExtensionMapping</a>}</code> | A map of custom import extension mappings, where the key is the inspected file extension, and the value is a pair of `module` extension and `component` import extension. |

---

##### `suggestedExtensions`<sup>Optional</sup> <a name="suggestedExtensions" id="projen.javascript.IUseImportExtensionsOptions.property.suggestedExtensions"></a>

```typescript
public readonly suggestedExtensions: {[ key: string ]: ISuggestedExtensionMapping};
```

- *Type:* {[ key: string ]: <a href="#projen.javascript.ISuggestedExtensionMapping">ISuggestedExtensionMapping</a>}
...
### IUseValidAutocompleteOptions <a name="IUseValidAutocompleteOptions" id="projen.javascript.IUseValidAutocompleteOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IUseValidAutocompleteOptions">IUseValidAutocompleteOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IUseValidAutocompleteOptions.property.inputComponents">inputComponents</a></code> | <code>string[]</code> | `input` like custom components that should be checked. |

---

##### `inputComponents`<sup>Optional</sup> <a name="inputComponents" id="projen.javascript.IUseValidAutocompleteOptions.property.inputComponents"></a>
...
### IUtilityClassSortingOptions <a name="IUtilityClassSortingOptions" id="projen.javascript.IUtilityClassSortingOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IUtilityClassSortingOptions">IUtilityClassSortingOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IUtilityClassSortingOptions.property.attributes">attributes</a></code> | <code>string[]</code> | Additional attributes that will be sorted. |
| <code><a href="#projen.javascript.IUtilityClassSortingOptions.property.functions">functions</a></code> | <code>string[]</code> | Names of the functions or tagged templates that will be sorted. |

---

##### `attributes`<sup>Optional</sup> <a name="attributes" id="projen.javascript.IUtilityClassSortingOptions.property.attributes"></a>
...
##### `functions`<sup>Optional</sup> <a name="functions" id="projen.javascript.IUtilityClassSortingOptions.property.functions"></a>
...
### IValidAriaRoleOptions <a name="IValidAriaRoleOptions" id="projen.javascript.IValidAriaRoleOptions"></a>

- *Implemented By:* <a href="#projen.javascript.IValidAriaRoleOptions">IValidAriaRoleOptions</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IValidAriaRoleOptions.property.allowInvalidRoles">allowInvalidRoles</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#projen.javascript.IValidAriaRoleOptions.property.ignoreNonDom">ignoreNonDom</a></code> | <code>boolean</code> | *No description.* |

---

##### `allowInvalidRoles`<sup>Optional</sup> <a name="allowInvalidRoles" id="projen.javascript.IValidAriaRoleOptions.property.allowInvalidRoles"></a>
...
##### `ignoreNonDom`<sup>Optional</sup> <a name="ignoreNonDom" id="projen.javascript.IValidAriaRoleOptions.property.ignoreNonDom"></a>
...
### IVcsConfiguration <a name="IVcsConfiguration" id="projen.javascript.IVcsConfiguration"></a>

- *Implemented By:* <a href="#projen.javascript.IVcsConfiguration">IVcsConfiguration</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.javascript.IVcsConfiguration.property.clientKind">clientKind</a></code> | <code>string</code> | The kind of client. |
| <code><a href="#projen.javascript.IVcsConfiguration.property.defaultBranch">defaultBranch</a></code> | <code>string</code> | The main branch of the project. |
| <code><a href="#projen.javascript.IVcsConfiguration.property.enabled">enabled</a></code> | <code>boolean</code> | Whether Biome should integrate itself with the VCS client. |
| <code><a href="#projen.javascript.IVcsConfiguration.property.root">root</a></code> | <code>string</code> | The folder where Biome should check for VCS files. |
| <code><a href="#projen.javascript.IVcsConfiguration.property.useIgnoreFile">useIgnoreFile</a></code> | <code>boolean</code> | Whether Biome should use the VCS ignore file. |

---

##### `clientKind`<sup>Optional</sup> <a name="clientKind" id="projen.javascript.IVcsConfiguration.property.clientKind"></a>
...
##### `defaultBranch`<sup>Optional</sup> <a name="defaultBranch" id="projen.javascript.IVcsConfiguration.property.defaultBranch"></a>
...
##### `enabled`<sup>Optional</sup> <a name="enabled" id="projen.javascript.IVcsConfiguration.property.enabled"></a>
...
##### `root`<sup>Optional</sup> <a name="root" id="projen.javascript.IVcsConfiguration.property.root"></a>
...
##### `useIgnoreFile`<sup>Optional</sup> <a name="useIgnoreFile" id="projen.javascript.IVcsConfiguration.property.useIgnoreFile"></a>
