...
| <code><a href="#projen.javascript.NodeProjectOptions.property.projenrcYaml">projenrcYaml</a></code> | <code>boolean</code> | Generate (once) .projenrc.yaml (in YAML). Set to `false` in order to disable .projenrc.yaml generation. |
| <code><a href="#projen.javascript.NodeProjectOptions.property.projenrcYamlOptions">projenrcYamlOptions</a></code> | <code>projen.ProjenrcYamlOptions</code> | Options for .projenrc.yaml. |
...
##### `projenrcYaml`<sup>Optional</sup> <a name="projenrcYaml" id="projen.javascript.NodeProjectOptions.property.projenrcYaml"></a>
...
##### `projenrcYamlOptions`<sup>Optional</sup> <a name="projenrcYamlOptions" id="projen.javascript.NodeProjectOptions.property.projenrcYamlOptions"></a>
