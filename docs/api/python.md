...
| <code><a href="#projen.python.PythonProject.property.repoRelativeDirectory">repoRelativeDirectory</a></code> | <code>string</code> | The project directory relative to the repository project. |
...
##### `repoRelativeDirectory`<sup>Required</sup> <a name="repoRelativeDirectory" id="projen.python.PythonProject.property.repoRelativeDirectory"></a>
