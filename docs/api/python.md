...
##### `with` <a name="with" id="projen.python.Pip.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.Pip.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.Poetry.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.Poetry.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.PoetryPyproject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.PoetryPyproject.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.Projenrc.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.Projenrc.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.PyprojectTomlFile.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.PyprojectTomlFile.with.parameter.mixins"></a>
...
##### `diff` <a name="diff" id="projen.python.PyprojectTomlFile.diff"></a>
...
###### `colorize`<sup>Optional</sup> <a name="colorize" id="projen.python.PyprojectTomlFile.diff.parameter.colorize"></a>
...
###### `contextLines`<sup>Optional</sup> <a name="contextLines" id="projen.python.PyprojectTomlFile.diff.parameter.contextLines"></a>
...
##### `with` <a name="with" id="projen.python.Pytest.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.Pytest.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.PytestSample.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.PytestSample.with.parameter.mixins"></a>
...
| <code><a href="#projen.python.PythonProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="projen.python.PythonProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.PythonProject.with.parameter.mixins"></a>
...
| <code><a href="#projen.python.PythonProject.property.envManager">envManager</a></code> | <code><a href="#projen.python.IPythonEnv">IPythonEnv</a></code> | API for managing the Python runtime environment. |
...
##### `with` <a name="with" id="projen.python.PythonSample.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.PythonSample.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.RequirementsFile.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.RequirementsFile.with.parameter.mixins"></a>
...
##### `diff` <a name="diff" id="projen.python.RequirementsFile.diff"></a>
...
###### `colorize`<sup>Optional</sup> <a name="colorize" id="projen.python.RequirementsFile.diff.parameter.colorize"></a>
...
###### `contextLines`<sup>Optional</sup> <a name="contextLines" id="projen.python.RequirementsFile.diff.parameter.contextLines"></a>
...
##### `with` <a name="with" id="projen.python.SetupPy.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.SetupPy.with.parameter.mixins"></a>
...
##### `diff` <a name="diff" id="projen.python.SetupPy.diff"></a>
...
###### `colorize`<sup>Optional</sup> <a name="colorize" id="projen.python.SetupPy.diff.parameter.colorize"></a>
...
###### `contextLines`<sup>Optional</sup> <a name="contextLines" id="projen.python.SetupPy.diff.parameter.contextLines"></a>
...
##### `with` <a name="with" id="projen.python.Setuptools.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.Setuptools.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.Uv.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.Uv.with.parameter.mixins"></a>
...
##### `with` <a name="with" id="projen.python.Venv.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.python.Venv.with.parameter.mixins"></a>
...
### BuildSystem <a name="BuildSystem" id="projen.python.BuildSystem"></a>

Declares any Python level dependencies that must be installed in order to run the project’s build system successfully.

#### Initializer <a name="Initializer" id="projen.python.BuildSystem.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.python.BuildSystem.property.requires">requires</a></code> | <code>string[]</code> | List of strings following the version specifier specification, representing dependencies required to execute the build system. |
| <code><a href="#projen.python.BuildSystem.property.backendPath">backendPath</a></code> | <code>string[]</code> | list of directories to prepend to `sys.path` when loading the build backend, relative to project root. |
| <code><a href="#projen.python.BuildSystem.property.buildBackend">buildBackend</a></code> | <code>string</code> | String is formatted following the same `module:object` syntax as a `setuptools` entry point. |

---

##### `requires`<sup>Required</sup> <a name="requires" id="projen.python.BuildSystem.property.requires"></a>
...
##### `backendPath`<sup>Optional</sup> <a name="backendPath" id="projen.python.BuildSystem.property.backendPath"></a>
...
##### `buildBackend`<sup>Optional</sup> <a name="buildBackend" id="projen.python.BuildSystem.property.buildBackend"></a>
...
### ProjectAuthor <a name="ProjectAuthor" id="projen.python.ProjectAuthor"></a>

#### Initializer <a name="Initializer" id="projen.python.ProjectAuthor.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.python.ProjectAuthor.property.email">email</a></code> | <code>string</code> | *No description.* |
| <code><a href="#projen.python.ProjectAuthor.property.name">name</a></code> | <code>string</code> | *No description.* |

---

##### `email`<sup>Optional</sup> <a name="email" id="projen.python.ProjectAuthor.property.email"></a>
...
##### `name`<sup>Optional</sup> <a name="name" id="projen.python.ProjectAuthor.property.name"></a>
...
| <code><a href="#projen.python.PythonProjectOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.python.PythonProjectOptions.property.projenrcYaml">projenrcYaml</a></code> | <code>boolean</code> | Generate (once) .projenrc.yaml (in YAML). Set to `false` in order to disable .projenrc.yaml generation. |
| <code><a href="#projen.python.PythonProjectOptions.property.projenrcYamlOptions">projenrcYamlOptions</a></code> | <code>projen.ProjenrcYamlOptions</code> | Options for .projenrc.yaml. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.python.PythonProjectOptions.property.projectTree"></a>
...
##### `projenrcYaml`<sup>Optional</sup> <a name="projenrcYaml" id="projen.python.PythonProjectOptions.property.projenrcYaml"></a>
...
##### `projenrcYamlOptions`<sup>Optional</sup> <a name="projenrcYamlOptions" id="projen.python.PythonProjectOptions.property.projenrcYamlOptions"></a>
...
##### `buildSystem`<sup>Optional</sup> <a name="buildSystem" id="projen.python.UvOptions.property.buildSystem"></a>
