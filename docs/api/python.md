...
##### `convertEnvToOptions` <a name="convertEnvToOptions" id="projen.python.PythonProject.convertEnvToOptions"></a>

```typescript
import { python } from 'projen'

python.PythonProject.convertEnvToOptions(env: {[ key: string ]: string})
```

###### `env`<sup>Required</sup> <a name="env" id="projen.python.PythonProject.convertEnvToOptions.parameter.env"></a>

- *Type:* {[ key: string ]: string}

---

##### `fromEnv` <a name="fromEnv" id="projen.python.PythonProject.fromEnv"></a>

```typescript
import { python } from 'projen'

python.PythonProject.fromEnv(filePath?: string, projectOptions?: any)
```
...
###### `filePath`<sup>Optional</sup> <a name="filePath" id="projen.python.PythonProject.fromEnv.parameter.filePath"></a>

- *Type:* string

---

###### `projectOptions`<sup>Optional</sup> <a name="projectOptions" id="projen.python.PythonProject.fromEnv.parameter.projectOptions"></a>
...
| <code><a href="#projen.python.PythonProject.property.isFromEnv">isFromEnv</a></code> | <code>boolean</code> | Whether the project is being initialized from environment variables. |
...
| <code><a href="#projen.python.PythonProject.property.fromEnvOptions">fromEnvOptions</a></code> | <code>{[ key: string ]: any}</code> | Options set when the project is initialized from environment variables. |
...
##### `isFromEnv`<sup>Required</sup> <a name="isFromEnv" id="projen.python.PythonProject.property.isFromEnv"></a>
...
##### `fromEnvOptions`<sup>Optional</sup> <a name="fromEnvOptions" id="projen.python.PythonProject.property.fromEnvOptions"></a>
...
| <code><a href="#projen.python.PythonProjectOptions.property.isFromEnv">isFromEnv</a></code> | <code>boolean</code> | Whether the project is being initialized from environment variables. |
...
##### `fromEnvOptions`<sup>Optional</sup> <a name="fromEnvOptions" id="projen.python.PythonProjectOptions.property.fromEnvOptions"></a>
...
##### `isFromEnv`<sup>Optional</sup> <a name="isFromEnv" id="projen.python.PythonProjectOptions.property.isFromEnv"></a>
