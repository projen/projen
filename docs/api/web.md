...
| <code><a href="#projen.web.NextComponent.with">with</a></code> | Applies one or more mixins to this construct. |
| <code><a href="#projen.web.NextComponent.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#projen.web.NextComponent.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `with` <a name="with" id="projen.web.NextComponent.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.web.NextComponent.with.parameter.mixins"></a>
...
##### `postProjectCreation` <a name="postProjectCreation" id="projen.web.NextComponent.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="projen.web.NextComponent.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="projen.web.NextComponent.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="projen.web.NextComponent.projectCreation.parameter.initProject"></a>
...
| <code><a href="#projen.web.NextJsProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="projen.web.NextJsProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.web.NextJsProject.with.parameter.mixins"></a>
...
| <code><a href="#projen.web.NextJsProject.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#projen.web.NextJsProject.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.NextJsProject.property.biome"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.NextJsProject.property.testRunner"></a>
...
| <code><a href="#projen.web.NextJsTypeScriptProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="projen.web.NextJsTypeScriptProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.web.NextJsTypeScriptProject.with.parameter.mixins"></a>
...
| <code><a href="#projen.web.NextJsTypeScriptProject.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#projen.web.NextJsTypeScriptProject.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.NextJsTypeScriptProject.property.biome"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.NextJsTypeScriptProject.property.testRunner"></a>
...
| <code><a href="#projen.web.ReactComponent.with">with</a></code> | Applies one or more mixins to this construct. |
| <code><a href="#projen.web.ReactComponent.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#projen.web.ReactComponent.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `with` <a name="with" id="projen.web.ReactComponent.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.web.ReactComponent.with.parameter.mixins"></a>
...
##### `postProjectCreation` <a name="postProjectCreation" id="projen.web.ReactComponent.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="projen.web.ReactComponent.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="projen.web.ReactComponent.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="projen.web.ReactComponent.projectCreation.parameter.initProject"></a>
...
| <code><a href="#projen.web.ReactProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="projen.web.ReactProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.web.ReactProject.with.parameter.mixins"></a>
...
| <code><a href="#projen.web.ReactProject.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#projen.web.ReactProject.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.ReactProject.property.biome"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.ReactProject.property.testRunner"></a>
...
| <code><a href="#projen.web.ReactTypeScriptProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="projen.web.ReactTypeScriptProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.web.ReactTypeScriptProject.with.parameter.mixins"></a>
...
| <code><a href="#projen.web.ReactTypeScriptProject.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#projen.web.ReactTypeScriptProject.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.ReactTypeScriptProject.property.biome"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.ReactTypeScriptProject.property.testRunner"></a>
...
| <code><a href="#projen.web.NextJsProjectOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.devEngines">devEngines</a></code> | <code>projen.javascript.DevEngines</code> | Configure the `devEngines` field in `package.json`. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#projen.web.NextJsProjectOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.bumpPackage">bumpPackage</a></code> | <code>string</code> | The `commit-and-tag-version` compatible package used to bump the package version, as a dependency string. |
| <code><a href="#projen.web.NextJsProjectOptions.property.githubReleaseLatest">githubReleaseLatest</a></code> | <code>boolean</code> | Whether GitHub should explicitly mark the release from the default branch as the latest release. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#projen.web.NextJsProjectOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#projen.web.NextJsProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#projen.web.NextJsProjectOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#projen.web.NextJsProjectOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#projen.web.NextJsProjectOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
| <code><a href="#projen.web.NextJsProjectOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.web.NextJsProjectOptions.property.projectTree"></a>
...
##### `addPackageManagerToDevEngines`<sup>Optional</sup> <a name="addPackageManagerToDevEngines" id="projen.web.NextJsProjectOptions.property.addPackageManagerToDevEngines"></a>
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="projen.web.NextJsProjectOptions.property.allowScripts"></a>
...
##### `deleteOrphanedLockFiles`<sup>Optional</sup> <a name="deleteOrphanedLockFiles" id="projen.web.NextJsProjectOptions.property.deleteOrphanedLockFiles"></a>
...
##### `devEngines`<sup>Optional</sup> <a name="devEngines" id="projen.web.NextJsProjectOptions.property.devEngines"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="projen.web.NextJsProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="projen.web.NextJsProjectOptions.property.bumpPackage"></a>
...
##### `githubReleaseLatest`<sup>Optional</sup> <a name="githubReleaseLatest" id="projen.web.NextJsProjectOptions.property.githubReleaseLatest"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="projen.web.NextJsProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="projen.web.NextJsProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="projen.web.NextJsProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="projen.web.NextJsProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="projen.web.NextJsProjectOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.NextJsProjectOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="projen.web.NextJsProjectOptions.property.biomeOptions"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="projen.web.NextJsProjectOptions.property.defaultReleaseBranch"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.NextJsProjectOptions.property.testRunner"></a>
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.devEngines">devEngines</a></code> | <code>projen.javascript.DevEngines</code> | Configure the `devEngines` field in `package.json`. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.bumpPackage">bumpPackage</a></code> | <code>string</code> | The `commit-and-tag-version` compatible package used to bump the package version, as a dependency string. |
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.githubReleaseLatest">githubReleaseLatest</a></code> | <code>boolean</code> | Whether GitHub should explicitly mark the release from the default branch as the latest release. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
| <code><a href="#projen.web.NextJsTypeScriptProjectOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.web.NextJsTypeScriptProjectOptions.property.projectTree"></a>
...
##### `addPackageManagerToDevEngines`<sup>Optional</sup> <a name="addPackageManagerToDevEngines" id="projen.web.NextJsTypeScriptProjectOptions.property.addPackageManagerToDevEngines"></a>
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="projen.web.NextJsTypeScriptProjectOptions.property.allowScripts"></a>
...
##### `deleteOrphanedLockFiles`<sup>Optional</sup> <a name="deleteOrphanedLockFiles" id="projen.web.NextJsTypeScriptProjectOptions.property.deleteOrphanedLockFiles"></a>
...
##### `devEngines`<sup>Optional</sup> <a name="devEngines" id="projen.web.NextJsTypeScriptProjectOptions.property.devEngines"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="projen.web.NextJsTypeScriptProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="projen.web.NextJsTypeScriptProjectOptions.property.bumpPackage"></a>
...
##### `githubReleaseLatest`<sup>Optional</sup> <a name="githubReleaseLatest" id="projen.web.NextJsTypeScriptProjectOptions.property.githubReleaseLatest"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="projen.web.NextJsTypeScriptProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="projen.web.NextJsTypeScriptProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="projen.web.NextJsTypeScriptProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="projen.web.NextJsTypeScriptProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="projen.web.NextJsTypeScriptProjectOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.NextJsTypeScriptProjectOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="projen.web.NextJsTypeScriptProjectOptions.property.biomeOptions"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="projen.web.NextJsTypeScriptProjectOptions.property.defaultReleaseBranch"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.NextJsTypeScriptProjectOptions.property.testRunner"></a>
...
| <code><a href="#projen.web.ReactProjectOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.devEngines">devEngines</a></code> | <code>projen.javascript.DevEngines</code> | Configure the `devEngines` field in `package.json`. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#projen.web.ReactProjectOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.bumpPackage">bumpPackage</a></code> | <code>string</code> | The `commit-and-tag-version` compatible package used to bump the package version, as a dependency string. |
| <code><a href="#projen.web.ReactProjectOptions.property.githubReleaseLatest">githubReleaseLatest</a></code> | <code>boolean</code> | Whether GitHub should explicitly mark the release from the default branch as the latest release. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#projen.web.ReactProjectOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#projen.web.ReactProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#projen.web.ReactProjectOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#projen.web.ReactProjectOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#projen.web.ReactProjectOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
| <code><a href="#projen.web.ReactProjectOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.web.ReactProjectOptions.property.projectTree"></a>
...
##### `addPackageManagerToDevEngines`<sup>Optional</sup> <a name="addPackageManagerToDevEngines" id="projen.web.ReactProjectOptions.property.addPackageManagerToDevEngines"></a>
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="projen.web.ReactProjectOptions.property.allowScripts"></a>
...
##### `deleteOrphanedLockFiles`<sup>Optional</sup> <a name="deleteOrphanedLockFiles" id="projen.web.ReactProjectOptions.property.deleteOrphanedLockFiles"></a>
...
##### `devEngines`<sup>Optional</sup> <a name="devEngines" id="projen.web.ReactProjectOptions.property.devEngines"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="projen.web.ReactProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="projen.web.ReactProjectOptions.property.bumpPackage"></a>
...
##### `githubReleaseLatest`<sup>Optional</sup> <a name="githubReleaseLatest" id="projen.web.ReactProjectOptions.property.githubReleaseLatest"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="projen.web.ReactProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="projen.web.ReactProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="projen.web.ReactProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="projen.web.ReactProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="projen.web.ReactProjectOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.ReactProjectOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="projen.web.ReactProjectOptions.property.biomeOptions"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="projen.web.ReactProjectOptions.property.defaultReleaseBranch"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.ReactProjectOptions.property.testRunner"></a>
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.devEngines">devEngines</a></code> | <code>projen.javascript.DevEngines</code> | Configure the `devEngines` field in `package.json`. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.bumpPackage">bumpPackage</a></code> | <code>string</code> | The `commit-and-tag-version` compatible package used to bump the package version, as a dependency string. |
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.githubReleaseLatest">githubReleaseLatest</a></code> | <code>boolean</code> | Whether GitHub should explicitly mark the release from the default branch as the latest release. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.testRunner">testRunner</a></code> | <code>projen.javascript.JavaScriptTestRunner</code> | The test runner used to execute unit tests. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
| <code><a href="#projen.web.ReactTypeScriptProjectOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.web.ReactTypeScriptProjectOptions.property.projectTree"></a>
...
##### `addPackageManagerToDevEngines`<sup>Optional</sup> <a name="addPackageManagerToDevEngines" id="projen.web.ReactTypeScriptProjectOptions.property.addPackageManagerToDevEngines"></a>
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="projen.web.ReactTypeScriptProjectOptions.property.allowScripts"></a>
...
##### `deleteOrphanedLockFiles`<sup>Optional</sup> <a name="deleteOrphanedLockFiles" id="projen.web.ReactTypeScriptProjectOptions.property.deleteOrphanedLockFiles"></a>
...
##### `devEngines`<sup>Optional</sup> <a name="devEngines" id="projen.web.ReactTypeScriptProjectOptions.property.devEngines"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="projen.web.ReactTypeScriptProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="projen.web.ReactTypeScriptProjectOptions.property.bumpPackage"></a>
...
##### `githubReleaseLatest`<sup>Optional</sup> <a name="githubReleaseLatest" id="projen.web.ReactTypeScriptProjectOptions.property.githubReleaseLatest"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="projen.web.ReactTypeScriptProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="projen.web.ReactTypeScriptProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="projen.web.ReactTypeScriptProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="projen.web.ReactTypeScriptProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="projen.web.ReactTypeScriptProjectOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.web.ReactTypeScriptProjectOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="projen.web.ReactTypeScriptProjectOptions.property.biomeOptions"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="projen.web.ReactTypeScriptProjectOptions.property.defaultReleaseBranch"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.web.ReactTypeScriptProjectOptions.property.testRunner"></a>
