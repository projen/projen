...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.packageType">packageType</a></code> | <code>projen.javascript.NodePackageType</code> | Package's type (NodePackageType.ESM or NodePackageType.CJS). |
...
##### `packageType`<sup>Optional</sup> <a name="packageType" id="projen.cdktf.ConstructLibraryCdktfOptions.property.packageType"></a>
