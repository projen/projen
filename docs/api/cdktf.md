...
| <code><a href="#projen.cdktf.ConstructLibraryCdktf.with">with</a></code> | Applies one or more mixins to this construct. |
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.cdktf.ConstructLibraryCdktf.with.parameter.mixins"></a>
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktf.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktf.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner used for executing TypeScript files. |
...
##### ~~`testRunner`~~<sup>Optional</sup> <a name="testRunner" id="projen.cdktf.ConstructLibraryCdktf.property.testRunner"></a>
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.devEngines">devEngines</a></code> | <code>projen.javascript.DevEngines</code> | Configure the `devEngines` field in `package.json`. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.githubReleaseLatest">githubReleaseLatest</a></code> | <code>boolean</code> | Whether GitHub should explicitly mark the release from the default branch as the latest release. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner to use for executing TypeScript files. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.validateTsconfig">validateTsconfig</a></code> | <code>projen.cdk.ValidateTsconfig</code> | Level of tsconfig validation jsii should perform on the user-provided tsconfig. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="projen.cdktf.ConstructLibraryCdktfOptions.property.projectTree"></a>
...
##### `addPackageManagerToDevEngines`<sup>Optional</sup> <a name="addPackageManagerToDevEngines" id="projen.cdktf.ConstructLibraryCdktfOptions.property.addPackageManagerToDevEngines"></a>
...
##### `bunVersion`<sup>Optional</sup> <a name="bunVersion" id="projen.cdktf.ConstructLibraryCdktfOptions.property.bunVersion"></a>
...
##### `deleteOrphanedLockFiles`<sup>Optional</sup> <a name="deleteOrphanedLockFiles" id="projen.cdktf.ConstructLibraryCdktfOptions.property.deleteOrphanedLockFiles"></a>
...
##### `devEngines`<sup>Optional</sup> <a name="devEngines" id="projen.cdktf.ConstructLibraryCdktfOptions.property.devEngines"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="projen.cdktf.ConstructLibraryCdktfOptions.property.bumpPackage"></a>
...
##### `githubReleaseLatest`<sup>Optional</sup> <a name="githubReleaseLatest" id="projen.cdktf.ConstructLibraryCdktfOptions.property.githubReleaseLatest"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="projen.cdktf.ConstructLibraryCdktfOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="projen.cdktf.ConstructLibraryCdktfOptions.property.releaseEnvironment"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="projen.cdktf.ConstructLibraryCdktfOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="projen.cdktf.ConstructLibraryCdktfOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="projen.cdktf.ConstructLibraryCdktfOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="projen.cdktf.ConstructLibraryCdktfOptions.property.biomeOptions"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="projen.cdktf.ConstructLibraryCdktfOptions.property.defaultReleaseBranch"></a>
...
##### `testRunner`<sup>Optional</sup> <a name="testRunner" id="projen.cdktf.ConstructLibraryCdktfOptions.property.testRunner"></a>
...
##### `runner`<sup>Optional</sup> <a name="runner" id="projen.cdktf.ConstructLibraryCdktfOptions.property.runner"></a>
...
##### `validateTsconfig`<sup>Optional</sup> <a name="validateTsconfig" id="projen.cdktf.ConstructLibraryCdktfOptions.property.validateTsconfig"></a>
