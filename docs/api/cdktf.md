...
| <code><a href="#projen.cdktf.ConstructLibraryCdktf.convertEnvToOptions">convertEnvToOptions</a></code> | *No description.* |
| <code><a href="#projen.cdktf.ConstructLibraryCdktf.fromEnv">fromEnv</a></code> | Initializes project from a .env file or PROJEN_* environment variables. This can be used by project types and other components to configure their options without user input or other environment variables. PROJEN_ env variables wtill override the .env file. |
...
##### `convertEnvToOptions` <a name="convertEnvToOptions" id="projen.cdktf.ConstructLibraryCdktf.convertEnvToOptions"></a>

```typescript
import { cdktf } from 'projen'

cdktf.ConstructLibraryCdktf.convertEnvToOptions(env: {[ key: string ]: string})
```

###### `env`<sup>Required</sup> <a name="env" id="projen.cdktf.ConstructLibraryCdktf.convertEnvToOptions.parameter.env"></a>

- *Type:* {[ key: string ]: string}

---

##### `fromEnv` <a name="fromEnv" id="projen.cdktf.ConstructLibraryCdktf.fromEnv"></a>

```typescript
import { cdktf } from 'projen'

cdktf.ConstructLibraryCdktf.fromEnv(filePath?: string, projectOptions?: any)
```
...
###### `filePath`<sup>Optional</sup> <a name="filePath" id="projen.cdktf.ConstructLibraryCdktf.fromEnv.parameter.filePath"></a>

- *Type:* string

---

###### `projectOptions`<sup>Optional</sup> <a name="projectOptions" id="projen.cdktf.ConstructLibraryCdktf.fromEnv.parameter.projectOptions"></a>
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktf.property.isFromEnv">isFromEnv</a></code> | <code>boolean</code> | Whether the project is being initialized from environment variables. |
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktf.property.fromEnvOptions">fromEnvOptions</a></code> | <code>{[ key: string ]: any}</code> | Options set when the project is initialized from environment variables. |
...
##### `isFromEnv`<sup>Required</sup> <a name="isFromEnv" id="projen.cdktf.ConstructLibraryCdktf.property.isFromEnv"></a>
...
##### `fromEnvOptions`<sup>Optional</sup> <a name="fromEnvOptions" id="projen.cdktf.ConstructLibraryCdktf.property.fromEnvOptions"></a>
...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.isFromEnv">isFromEnv</a></code> | <code>boolean</code> | Whether the project is being initialized from environment variables. |
...
##### `fromEnvOptions`<sup>Optional</sup> <a name="fromEnvOptions" id="projen.cdktf.ConstructLibraryCdktfOptions.property.fromEnvOptions"></a>
...
##### `isFromEnv`<sup>Optional</sup> <a name="isFromEnv" id="projen.cdktf.ConstructLibraryCdktfOptions.property.isFromEnv"></a>
