...
| <code><a href="#projen.cdktf.ConstructLibraryCdktfOptions.property.packageType">packageType</a></code> | <code>projen.javascript.NodePackageType</code> | Package's type (module or commonjs). |
