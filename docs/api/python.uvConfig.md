...
| <code><a href="#projen.python.uvConfig.Index.property.ignoreErrorCodes">ignoreErrorCodes</a></code> | <code>number[]</code> | Status codes that uv should ignore when deciding whether to continue resolution after a request to this index fails. |
...
| <code><a href="#projen.python.uvConfig.PipOptions.property.excludeNewer">excludeNewer</a></code> | <code>projen.python.uvConfig.ExcludeNewerOverride</code> | Limit candidate packages to those that were uploaded prior to a given point in time. |
...
| <code><a href="#projen.python.uvConfig.UvConfiguration.property.excludeDependencies">excludeDependencies</a></code> | <code>any[]</code> | Dependencies to exclude when resolving the project's dependencies. |
| <code><a href="#projen.python.uvConfig.UvConfiguration.property.excludeNewer">excludeNewer</a></code> | <code>projen.python.uvConfig.ExcludeNewerOverride</code> | Limit candidate packages to those that were uploaded prior to the given date. |
...
| <code><a href="#projen.python.uvConfig.UvConfiguration.property.overrideDependencies">overrideDependencies</a></code> | <code>any[]</code> | Overrides to apply when resolving the project's dependencies. |
...
| <code><a href="#projen.python.uvConfig.UvConfiguration.property.preview">preview</a></code> | <code>boolean</code> | Whether to enable all experimental, preview features. |
| <code><a href="#projen.python.uvConfig.UvConfiguration.property.previewFeatures">previewFeatures</a></code> | <code>any</code> | Whether to enable specific or all experimental preview features. |
...
```typescript
public readonly excludeDependencies: any[];
```
...
```typescript
public readonly overrideDependencies: any[];
```
...
##### `previewFeatures`<sup>Optional</sup> <a name="previewFeatures" id="projen.python.uvConfig.UvConfiguration.property.previewFeatures"></a>

```typescript
public readonly previewFeatures: any;
```
...
| <code><a href="#projen.python.uvConfig.TargetTriple.WASM32_HYPHEN_PYODIDE2025">WASM32_HYPHEN_PYODIDE2025</a></code> | A wasm32 target using the Pyodide 2025 platform. |
...
##### `WASM32_HYPHEN_PYODIDE2025` <a name="WASM32_HYPHEN_PYODIDE2025" id="projen.python.uvConfig.TargetTriple.WASM32_HYPHEN_PYODIDE2025"></a>
...
| <code><a href="#projen.python.uvConfig.TorchMode.CU132">CU132</a></code> | Use the PyTorch index for CUDA 13.2. (cu132). |
...
##### `CU132` <a name="CU132" id="projen.python.uvConfig.TorchMode.CU132"></a>
