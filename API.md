...
[aws_lambda.AutoDiscover](#projen-aws-lambda-autodiscover)|Automatically creates a `LambdaFunction` for all `.lambda.ts` files under the source directory of the project.
[aws_lambda.Function](#projen-aws-lambda-function)|Generates a pre-bundled AWS Lambda function construct from handler code.
[aws_lambda.Runtime](#projen-aws-lambda-runtime)|The runtime for the AWS Lambda function.
...
[aws_lambda.AutoDiscoverOptions](#projen-aws-lambda-autodiscoveroptions)|Options for `AutoDiscover`.
[aws_lambda.FunctionCommonOptions](#projen-aws-lambda-functioncommonoptions)|Common options for `Function`.
[aws_lambda.FunctionOptions](#projen-aws-lambda-functionoptions)|Options for `Function`.
...
* **options** (<code>[AwsCdkConstructLibraryOptions](#projen-awscdkconstructlibraryoptions)</code>)  *No description*
  ...
  * **lambdaOptions** (<code>[aws_lambda.FunctionCommonOptions](#projen-aws-lambda-functioncommonoptions)</code>)  Common options for all AWS Lambda functions. __*Default*__: default options
...
```ts
new aws_lambda.AutoDiscover(project: Project, options: AutoDiscoverOptions)
```

* **project** (<code>[Project](#projen-project)</code>)  *No description*
* **options** (<code>[aws_lambda.AutoDiscoverOptions](#projen-aws-lambda-autodiscoveroptions)</code>)  *No description*
  ...
  * **runtime** (<code>[aws_lambda.Runtime](#projen-aws-lambda-runtime)</code>)  The node.js version to target. __*Default*__: Runtime.NODEJS_14_X
...
#### preSynthesize()🔹 <a id="projen-aws-lambda-autodiscover-presynthesize"></a>
...
## class Function 🔹 <a id="projen-aws-lambda-function"></a>
...
```ts
new aws_lambda.Function(project: Project, options: FunctionOptions)
```

* **project** (<code>[Project](#projen-project)</code>)  The project to use.
* **options** (<code>[aws_lambda.FunctionOptions](#projen-aws-lambda-functionoptions)</code>)  Options.
  * **externals** (<code>Array<string></code>)  Names of modules which should not be included in the bundle. __*Default*__: by default, the "aws-sdk" module will be excluded from the bundle. Note that if you use this option you will need to add "aws-sdk" explicitly.
  * **runtime** (<code>[aws_lambda.Runtime](#projen-aws-lambda-runtime)</code>)  The node.js version to target. __*Default*__: Runtime.NODEJS_14_X
...
## class Runtime 🔹 <a id="projen-aws-lambda-runtime"></a>
...
*static* **NODEJS_10_X**🔹 | <code>[aws_lambda.Runtime](#projen-aws-lambda-runtime)</code> | Node.js 10.x.
*static* **NODEJS_12_X**🔹 | <code>[aws_lambda.Runtime](#projen-aws-lambda-runtime)</code> | Node.js 12.x.
*static* **NODEJS_14_X**🔹 | <code>[aws_lambda.Runtime](#projen-aws-lambda-runtime)</code> | Node.js 14.x.
...
**lambdaOptions**?🔹 | <code>[aws_lambda.FunctionCommonOptions](#projen-aws-lambda-functioncommonoptions)</code> | Common options for all AWS Lambda functions.<br/>__*Default*__: default options
...
**lambdaOptions**?⚠️ | <code>[aws_lambda.FunctionCommonOptions](#projen-aws-lambda-functioncommonoptions)</code> | Common options for all AWS Lambda functions.<br/>__*Default*__: default options
...
## struct AutoDiscoverOptions 🔹 <a id="projen-aws-lambda-autodiscoveroptions"></a>
...
**runtime**?🔹 | <code>[aws_lambda.Runtime](#projen-aws-lambda-runtime)</code> | The node.js version to target.<br/>__*Default*__: Runtime.NODEJS_14_X



## struct FunctionCommonOptions 🔹 <a id="projen-aws-lambda-functioncommonoptions"></a>


Common options for `Function`.
...
## struct FunctionOptions 🔹 <a id="projen-aws-lambda-functionoptions"></a>
