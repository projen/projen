...
* **options** (<code>[JsiiReleaseMaven](#projen-jsiireleasemaven)</code>)  Options.
  * **mavenEndpoint** (<code>string</code>)  URL of Nexus repository. __*Default*__: not set
...
**mavenEndpoint**?🔹 | <code>string</code> | URL of Nexus repository.<br/>__*Default*__: not set
