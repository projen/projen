...
* **options** (<code>[AwsCdkConstructLibraryOptions](#projen-awscdkconstructlibraryoptions)</code>)  *No description*
  ...
  * **issueOnFailure** (<code>boolean</code>)  Create a github issue on every failed publishing task. __*Default*__: false
...
* **options** (<code>[release.PublisherOptions](#projen-release-publisheroptions)</code>)  *No description*
  ...
  * **issueOnFailure** (<code>boolean</code>)  Create an issue when a publish task fails. __*Default*__: false
...
**issueOnFailure**?🔹 | <code>boolean</code> | Create a github issue on every failed publishing task.<br/>__*Default*__: false
...
**issueOnFailure**?⚠️ | <code>boolean</code> | Create a github issue on every failed publishing task.<br/>__*Default*__: false
...
**issueOnFailure**?🔹 | <code>boolean</code> | Create an issue when a publish task fails.<br/>__*Default*__: false
